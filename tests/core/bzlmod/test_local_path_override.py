...
@buck_test(data_dir="test_local_path_override_data")
...
async def test_local_module_has_module_bazel(buck: Buck) -> None:
    ...
    # Use audit cell to check that local_lib cell is visible
    result = await buck.audit("cell")
