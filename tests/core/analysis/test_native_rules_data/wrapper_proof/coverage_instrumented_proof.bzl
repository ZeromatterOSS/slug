...
# the bundled `_slug_coverage_instrumented` in
# `@slug_builtins//:exports.bzl` now serves the call by reading the
# slug-internal `slug_collect_code_coverage()` global registered in
...
# because there's no clean way to invoke `slug build` from a fixture
