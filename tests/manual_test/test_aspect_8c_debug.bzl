...
print("DEBUG: Loading test_aspect_8c.bzl")
...
print("DEBUG: Defining collect_aspect")
...
print("DEBUG: collect_aspect created:", collect_aspect)
...
print("DEBUG: test_rule created with aspects:", test_rule)
