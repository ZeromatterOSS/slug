...
3. **Spawn parallel sub-agent tasks for comprehensive research:**
   ...
   **For local tasks (if relevant):**
   - Read the task file directly from `agent/tasks/active/TASK-XXXX.md`
   - Search `agent/tasks/active/` for related tasks or historical context
...
5. **Gather metadata for the research document:**
   ...
   - Filename: `thoughts/shared/research/YYYY-MM-DD-TASK-XXXX-description.md`
     ...
     - Examples:
       ...
       - Without task: `2026-01-21-authentication-flow.md`
