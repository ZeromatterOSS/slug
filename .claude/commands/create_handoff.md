...
Use the following information to understand how to create your document:
    - create your file under `thoughts/shared/handoffs/TASK-XXXX/YYYY-MM-DD_HH-MM-SS_TASK-ZZZZ_description.md`, where:
        - YYYY-MM-DD is today's date
        - HH-MM-SS is the hours, minutes and seconds based on the current time, in 24-hour format (i.e. use `13:00` for `1:00 pm`)
        - TASK-XXXX is the task number (replace with `general` if no task)
        - TASK-ZZZZ is the task number (omit if no task)
        - description is a brief kebab-case description
    - Run the `scripts/spec_metadata.sh` script to generate all relevant metadata
    - Examples:
        - With task: `2026-01-21_13-55-22_TASK-0001_create-context-compaction.md`
        - Without task: `2026-01-21_13-55-22_create-context-compaction.md`
...
# Handoff: TASK-XXXX {very concise description}
...
```bash
/resume_handoff thoughts/shared/handoffs/TASK-0001/2026-01-21_13-44-55_TASK-0001_create-context-compaction.md
```
</example_response>
