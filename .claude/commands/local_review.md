...
2. **Extract task information**:
   - Look for task numbers in the branch name (e.g., `task-0001`, `TASK-0001`)
   - Use this to create a short worktree directory name
   - If no task found, use a sanitized version of the branch name
...
```
/local_review samdickson22:sam/task-0001-hotkey-for-yolo-mode
```

This will:
- Add 'samdickson22' as a remote
- Create worktree at `~/wt/humanlayer/task-0001`
