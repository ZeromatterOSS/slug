# Kuro Rule Basics - Interactive Tutorial Skill

## Overview

This skill provides an interactive, step-by-step tutorial for learning Kuro
...
- **references/** - Additional documentation
  - **advanced_patterns.md** - Advanced Kuro patterns
...
```
User: "Continue the Kuro tutorial"
...
- Help debug together
- Explain what Kuro is telling us
...
1. Explore Kuro's prelude for real production rules
