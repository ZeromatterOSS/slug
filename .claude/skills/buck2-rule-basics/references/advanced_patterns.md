# Advanced Kuro Rule Patterns

Common patterns and best practices for writing production-ready Kuro rules.
...
Kuro's optimized data structure for propagating information up dependency
trees.
...
- **Use manual collection:** Only for simple cases or when learning Kuro basics

For complete details, see the Kuro documentation on transitive sets
(https://kuro.build/docs/rule_authors/transitive_sets/).
...
# kuro build //:app              # Main executable
# kuro build //:app[debug]       # Debug symbols
# kuro build //:app[compdb]      # Compilation database
```
...
These patterns form the building blocks of production Kuro rules. Combine them
