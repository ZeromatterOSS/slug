...
# This script builds slug locally from source and then runs it.
#
# It uses the installed slug to build the slug bundle target, then executes
# the freshly built binary with any additional arguments passed to this script.
# This is useful for testing local changes to slug without a full installation.
#
# Example:
#   ./slug.py build //my:target
...
def parse_arguments() -> Tuple[argparse.Namespace, List[str]]:
    parser = argparse.ArgumentParser(
        ...
        description="Builds slug locally and then runs it.",
...
def build_command(
    ...
    cmd = [
        "slug",
        "run",
        # @oss-disable[end= ]: "fbcode//slug:slug_bundle",
        "//:slug_bundle", # @oss-enable
    ]
