...
pub(crate) fn codegen(parsed: Parsed) -> syn::Result<TokenStream> {
    ...
    let result = quote! {
        ...
        mod #mod_name {
            ...
            use ::kuro_query::__derive_refs::ref_cast::RefCast;
            use ::kuro_query::__derive_refs::kuro_query_parser::{BinaryOp, SpannedExpr};
            use ::kuro_query::__derive_refs::indexmap::indexmap;
            use ::kuro_query::__derive_refs::async_trait::async_trait;

            use super::*;
            use ::kuro_query::query::{
