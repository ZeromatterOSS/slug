...
//! Project-agnostic filesystem utilities for Slug.
//!
//! This crate contains filesystem types and utilities that have no knowledge
//! of Slug projects, cells, or build artifacts. It provides:
...
//!
//! For project-aware filesystem functionality, see the `slug_core::fs` module.
