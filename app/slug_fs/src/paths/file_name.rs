...
fn verify_file_name(file_name: &str) -> slug_error::Result<()> {
...
impl FileName {
    ...
    /// ```
    #[inline]
    pub fn new<S: ?Sized + AsRef<str>>(s: &S) -> slug_error::Result<&Self> {
        verify_file_name(s.as_ref())?;
        Ok(Self::unchecked_new(s.as_ref()))
    }

    pub fn from_os_string(file_name: &OsString) -> slug_error::Result<&FileName> {
...
impl<'a> TryFrom<&'a str> for &'a FileName {
    ...
    #[inline]
    fn try_from(value: &'a str) -> slug_error::Result<&'a FileName> {
        FileName::new(value)
    }
}
...
impl TryFrom<String> for FileNameBuf {
    ...
    #[inline]
    fn try_from(value: String) -> slug_error::Result<FileNameBuf> {
...
impl TryFrom<CompactString> for FileNameBuf {
    ...
    #[inline]
    fn try_from(value: CompactString) -> slug_error::Result<FileNameBuf> {
        verify_file_name(value.as_str())?;
