...
impl ForwardRelativePath {
    ...
    #[inline]
    pub fn new<S: ?Sized + AsRef<Path>>(s: &S) -> slug_error::Result<&ForwardRelativePath> {
    ...
    pub fn new_trim_trailing_slashes<S: ?Sized + AsRef<Path>>(
        path: &S,
    ) -> slug_error::Result<&ForwardRelativePath> {
    ...
    pub fn join_normalized<P: AsRef<RelativePath>>(
        &self,
        path: P,
    ) -> slug_error::Result<ForwardRelativePathBuf> {
...
impl ForwardRelativePathBuf {
    #[inline]
    pub fn new(s: String) -> slug_error::Result<ForwardRelativePathBuf> {
...
impl<'a> TryFrom<&'a str> for &'a ForwardRelativePath {
    ...
    /// ```
    #[inline]
    fn try_from(s: &'a str) -> slug_error::Result<&'a ForwardRelativePath> {
...
impl<'a> TryFrom<&'a Path> for &'a ForwardRelativePath {
    ...
    /// # slug_error::Ok(())
    /// ```
    fn try_from(s: &'a Path) -> slug_error::Result<&'a ForwardRelativePath> {
        let s = s
            .as_os_str()
            .to_str()
...
impl<'a> TryFrom<&'a RelativePath> for &'a ForwardRelativePath {
    ...
    /// ```
    #[inline]
    fn try_from(p: &'a RelativePath) -> slug_error::Result<&'a ForwardRelativePath> {
...
impl TryFrom<String> for ForwardRelativePathBuf {
    ...
    /// ```
    #[inline]
    fn try_from(s: String) -> slug_error::Result<ForwardRelativePathBuf> {
        ForwardRelativePathVerifier::verify_str(&s)?;
        Ok(ForwardRelativePathBuf(s))
    }
}
...
impl TryFrom<PathBuf> for ForwardRelativePathBuf {
    ...
    /// # slug_error::Ok(())
    /// ```
    fn try_from(p: PathBuf) -> slug_error::Result<ForwardRelativePathBuf> {
...
impl TryFrom<RelativePathBuf> for ForwardRelativePathBuf {
    ...
    /// ```
    #[inline]
    fn try_from(p: RelativePathBuf) -> slug_error::Result<ForwardRelativePathBuf> {
...
impl ForwardRelativePathVerifier {
    fn verify_str(rel_path: &str) -> slug_error::Result<()> {
        #[cold]
        #[inline(never)]
        fn err(rel_path: &str) -> slug_error::Error {
...
mod tests {
    ...
    #[test]
    fn forward_path_is_comparable() -> slug_error::Result<()> {
    ...
    #[test]
    fn path_buf_is_clonable() -> slug_error::Result<()> {
    ...
    #[test]
    fn relative_path_display_is_readable() -> slug_error::Result<()> {
