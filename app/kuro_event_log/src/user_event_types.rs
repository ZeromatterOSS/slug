...
use kuro_data::StarlarkUserEvent;
use kuro_event_observer::display::TargetDisplayOptions;
use kuro_event_observer::display::display_action_owner;
...
) -> kuro_error::Result<Option<UserEvent>> {
    match stream_value {
...
pub(crate) fn try_get_user_event(buck_event: &BuckEvent) -> kuro_error::Result<Option<UserEvent>> {
        ...
        .ok_or_else(|| SerializeUserEventError::MissingData("BuckEvent".to_owned()))?
    {
        kuro_data::buck_event::Data::Instant(instant) => {
            ...
            {
                kuro_data::instant_event::Data::StarlarkUserEvent(event) => Ok(Some(UserEvent {
        ...
        kuro_data::buck_event::Data::SpanEnd(span_end_event) => {
            ...
            {
                kuro_data::span_end_event::Data::ActionExecution(action_execution) => {
                ...
                kuro_data::span_end_event::Data::BxlEnsureArtifacts(_) => {
...
mod tests {
    ...
    use kuro_data::StarlarkUserEvent;
    use kuro_data::StarlarkUserMetadataDictValue;
    use kuro_data::StarlarkUserMetadataListValue;
    use kuro_data::StarlarkUserMetadataValue;
    use kuro_data::starlark_user_metadata_value::Value;
    use maplit::hashmap;
