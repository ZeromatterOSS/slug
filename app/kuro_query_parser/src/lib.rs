...
pub fn parse_expr(input: &str) -> kuro_error::Result<SpannedExpr<'_>> {
...
mod tests {
    ...
    #[test]
    fn test_expr() -> kuro_error::Result<()> {
        run_tests(
            expr,
            &[
                "f",
    ...
    #[test]
    fn test_function() -> kuro_error::Result<()> {
        run_tests(
            expr_function,
    ...
    #[test]
    fn test_word() -> kuro_error::Result<()> {
        run_tests(
            expr_word,
            &[
                "@cell//package:target",
    ...
    #[test]
    fn test_integer() -> kuro_error::Result<()> {
        run_tests(expr_int, &["0", "1234"], &["w123", ".1", ""], &["0123"]);
        Ok(())
    }

    #[test]
    fn test_trailing_infix() -> kuro_error::Result<()> {
        run_tests(
            trailing_infix,
            &[
                " + b",
