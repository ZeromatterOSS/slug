...
mod tests {
    ...
    fn test_truncate_span_in_middle() {
        let error = "rdeps(set(fbcode//kuro/... fbsource//xplat/kuro/..., fbsource//fbobjc/kuro/...), fbcode//kuro/cli:kuro)";
        let span = Spanned {
        ...
        assert_eq!(
            ...
            [
                "",
                "    rdeps(set(fbcode//kuro/... fbsourc<<omitted>>/kuro/...), fbcode//kuro/cli:kuro)",
                "    ^-----------------------------------------------------------------------------^",
                "",
            ]
        );
