...
use slug_interpreter_for_build::interpreter::globals::register_analysis_natives;
use slug_interpreter_for_build::interpreter::globals::register_bxl_natives;
use slug_interpreter_for_build::interpreter::globals::register_load_natives;
use slug_interpreter_for_build::interpreter::globals::starlark_library_extensions_for_slug;
...
pub(crate) async fn docs_starlark_builtins(
    ...
    let starlark = Globals::extended_by(starlark_library_extensions_for_slug()).documentation();
