...
impl<'a> ArtifactValueBuilder<'a> {
    ...
    ) -> kuro_error::Result<ActionDirectoryEntry<ActionSharedDirectory>> {
    ...
    /// being built.
    pub fn build(&self, output: &ProjectRelativePath) -> kuro_error::Result<ArtifactValue> {
...
mod tests {
    ...
    #[test]
    fn copy_relativized_symlink() -> kuro_error::Result<()> {
        // /
        // |-d1/
        // | |-d2/
        // | | |-d3/
