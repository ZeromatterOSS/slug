...
impl ExecutorPreference {
    pub fn and(self, other: Self) -> kuro_error::Result<Self> {
...
impl CommandExecutionPaths {
    pub fn new(
        ...
        let input_files_bytes = if kuro_core::faster_directories::is_enabled() {
...
pub struct CommandExecutionRequest {
    ...
    /// What environment variables to inherit from the Kuro daemon.
...
impl CommandExecutionOutputRef<'_> {
    ...
    ) -> kuro_error::Result<ResolvedCommandExecutionOutput> {
        match self {
            Self::BuildArtifact {
                path,
                output_type,
