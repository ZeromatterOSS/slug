...
use kuro_directory::directory::builder_lazy::DirectoryBuilderLike;
use kuro_directory::directory::builder_lazy::LazyDirectoryBuilder;
...
use kuro_directory::directory::directory_ref::FingerprintedDirectoryRef;
use kuro_directory::directory::directory_selector::DirectorySelector;
use kuro_directory::directory::entry::DirectoryEntry;
use kuro_directory::directory::find::DirectoryFindError;
...
use kuro_directory::directory::shared_directory::SharedDirectory;
...
pub fn new_symlink<T: AsRef<Path>>(target: T) -> kuro_error::Result<ActionDirectoryMember> {
...
pub fn extract_artifact_value(
    ...
    digest_config: DigestConfig,
) -> kuro_error::Result<Option<ArtifactValue>> {
...
mod tests {
    ...
    #[test]
    fn directory_relativized() -> kuro_error::Result<()> {
    ...
    fn build_test_dir() -> kuro_error::Result<ActionDirectoryBuilder> {
        let digest_config = DigestConfig::testing_default();
    ...
    #[test]
    fn test_extract_no_deps() -> kuro_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    #[test]
    fn test_extract_has_deps_dir() -> kuro_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    #[test]
    fn test_extract_has_deps_leaf() -> kuro_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    #[test]
    fn test_extract_cycle() -> kuro_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    #[test]
    fn test_extract_symlink_chain() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_re_tree_roundtrip() -> kuro_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    ///
    /// ```sh
    /// kuro run fbcode//remote_execution/rust/recli:recli -- \
    ...
    /// ```
    #[test]
    fn test_re_tree_compatibility() -> kuro_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    fn test_unnormalized_symlinks() -> kuro_error::Result<()> {
        if !cfg!(windows) {
            return Ok(());
        }
    ...
    #[test]
    fn test_rename_and_serialize() -> kuro_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
