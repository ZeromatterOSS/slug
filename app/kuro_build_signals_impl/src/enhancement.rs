...
pub(crate) struct CriticalPathProtoEnhancer {
    ...
    entries: Vec<kuro_data::CriticalPathEntry2>,
}
...
impl CriticalPathProtoEnhancer {
    ...
    pub(crate) fn add_entry(&mut self, entry: DetailedCriticalPathEntry) -> kuro_error::Result<()> {
            ...
            .is_zero()
        {
            self.add_simple_entry(
                None,
                kuro_data::critical_path_entry2::Entry::Waiting(
                    kuro_data::critical_path_entry2::Waiting {
    ...
    pub(crate) fn add_simple_entry(
        ...
        entry: kuro_data::critical_path_entry2::Entry,
        time_span: TimeSpan,
        is_critical: bool,
    ) -> kuro_error::Result<()> {
    ...
    pub(crate) fn into_entries(self) -> Vec<kuro_data::CriticalPathEntry2> {
        self.entries
    }
    ...
    fn add_entry_impl(
        ...
        waiting_category: Option<&str>,
        time_span: TimeSpan,
        entry: kuro_data::CriticalPathEntry2,
    ) -> kuro_error::Result<()> {
    ...
    ) -> kuro_error::Result<kuro_data::CriticalPathEntry2> {
        let duration_proto: prost_types::Duration = duration.try_into()?;
        Ok(kuro_data::CriticalPathEntry2 {
            span_ids: Vec::new(),
