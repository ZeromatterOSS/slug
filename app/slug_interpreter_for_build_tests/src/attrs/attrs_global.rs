...
#[test]
fn test_attr_display() -> slug_error::Result<()> {
...
#[test]
fn test_attr_string() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(
        r#"
def test():
...
#[test]
fn test_attr_int() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(
        r#"
def test():
...
#[test]
fn test_attr_bool() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(
        r#"
def test():
...
#[test]
fn test_attr_label() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(
        r#"
def test():
...
#[test]
fn test_attr_label_list() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(
        r#"
def test():
...
#[test]
fn test_attr_string_list() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(
        r#"
def test():
...
#[test]
fn test_attr_int_list() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(
        r#"
def test():
...
#[test]
fn test_attr_string_dict() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
...
#[test]
fn test_attr_string_list_dict() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(
        r#"
def test():
...
#[test]
fn test_attr_output() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(
        r#"
def test():
...
#[test]
fn test_attr_output_list() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(
        r#"
def test():
