...
use slug_interpreter_for_build::attrs::coerce::ctx::BuildAttrCoercionContext;
...
use slug_node::attrs::hacks::value_to_string;
...
#[test]
fn test_attr_module_registered() -> slug_error::Result<()> {
...
#[test]
fn attr_string_works() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn attr_int_works() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn attr_bool_works() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn attr_label_works() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn attr_label_list_works() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn attr_label_list_allow_files_accepts_directory_sources() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
...
#[test]
fn attr_string_list_works() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn attr_int_list_works() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn attr_string_dict_works() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn attr_string_list_dict_works() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn attr_output_works() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn attr_output_list_works() -> slug_error::Result<()> {
    let mut tester = Tester::new().unwrap();
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn attr_coercer_coerces() -> slug_error::Result<()> {
    Heap::temp(|heap| {
...
#[test]
fn coercing_src_to_path_works() -> slug_error::Result<()> {
