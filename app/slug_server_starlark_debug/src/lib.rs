...
//! Provides the (daemon-side) support for slug's starlark debugging.
//!
//! Components of the debugger:
//!
//! [BuckStarlarkDebuggerServer] is the main way that the core of slug integrates
...
//! will be created for each slug command and put in the dice per-transaction data. Code
...
//! helper [slug_interpreter::factory::StarlarkEvaluatorProvider]).
//!
...
use slug_interpreter::starlark_debug::StarlarkDebuggerHandle;
use tokio::sync::mpsc;
