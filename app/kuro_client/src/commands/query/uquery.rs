...
Run `kuro docs uquery` or
",
        if_else_opensource!(
            "https://kuro.build/docs/users/query/uquery/",
            "https://www.internalfb.com/intern/staticdocs/kuro/docs/users/query/uquery/",
        ),
        r#"
...
`kuro uquery //java/com/example/app:amazing --output-all-attributes

List the deps of a target (special characters in a target will require quotes):
`kuro uquery 'deps("//java/com/example/app:amazing+more")'`
