...
Run `kuro docs aquery` or
"#,
        if_else_opensource!(
            "https://kuro.build/docs/users/query/aquery/",
            "https://www.internalfb.com/intern/staticdocs/kuro/docs/users/query/aquery/",
        ),
        r#"
...
`kuro aquery //java/com/example/app:amazing`

List all the commands for run actions for building a target

`kuro aquery 'kind(run, deps("//java/com/example/app:amazing+more"))' --output-attribute=cmd`
