...
use slug_util::arc_str::ThinArcS;
...
impl<'v> DeclaredArtifact<'v> {
    ...
    pub fn ensure_bound(self) -> slug_error::Result<BoundBuildArtifact> {
        let borrow = self.artifact().borrow();
...
impl<'v> OutputArtifact<'v> {
    ...
    pub fn bind(&self, key: ActionKey) -> slug_error::Result<BoundBuildArtifact> {
    ...
    pub fn ensure_output_type(&self, output_type: OutputType) -> slug_error::Result<()> {
...
impl UnboundArtifact {
    fn bind(self, key: ActionKey) -> slug_error::Result<BuildArtifact> {
...
mod tests {
    ...
    #[test]
    fn artifact_binding() -> slug_error::Result<()> {
        Heap::temp(|heap| {
    ...
    #[test]
    fn resolve_artifact() -> slug_error::Result<()> {
    ...
    #[test]
    fn writes_files() -> slug_error::Result<()> {
