...
fn main() -> io::Result<()> {
    ...
    let includes = if let Ok(path) = env::var("BUCK_PROTO_SRCS") {
        ...
        vec![
            ".".to_owned(),
            "../kuro_data".to_owned(),
            "../kuro_subscription_proto".to_owned(),
    ...
    unsafe { builder.setup_protoc() }
        ...
        .field_attribute("timeout", "#[serde(rename = \"timeout_us\", with = \"kuro_data::serialize_duration_as_micros\")]")
        .field_attribute("uptime", "#[serde(rename = \"uptime_us\", with = \"kuro_data::serialize_duration_as_micros\")]")
        .field_attribute("delay", "#[serde(rename = \"delay_us\", with = \"kuro_data::serialize_duration_as_micros\")]")
        .field_attribute("ProfileResponse.elapsed", "#[serde(rename = \"elapsed_us\", with = \"kuro_data::serialize_duration_as_micros\")]")
        ...
        .extern_path(".buck.subscription", "::kuro_subscription_proto")
