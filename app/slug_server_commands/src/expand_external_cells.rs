...
use slug_common::external_cells::EXTERNAL_CELLS_IMPL;
...
impl ServerCommandTemplate for ExpandExternalCellsServerCommand {
    type StartEvent = slug_data::ExpandExternalCellsCommandStart;
    type EndEvent = slug_data::ExpandExternalCellsCommandEnd;
    type Response = slug_cli_proto::new_generic::ExpandExternalCellsResponse;
