...
use slug_node::nodes::eval_result::is_generated_target;
...
impl ServerCommandTemplate for CompleteServerCommand {
    type StartEvent = slug_data::CompleteCommandStart;
    type EndEvent = slug_data::CompleteCommandEnd;
    type Response = slug_cli_proto::new_generic::CompleteResponse;
