...
impl Key for GraphPropertiesKey {
    type Value = kuro_error::Result<MaybeCompatible<GraphPropertiesValues>>;
...
impl<T: StrongHash> VersionedSketcher<T> {
    ...
    pub(crate) fn merge(&mut self, other: &MergeableGraphSketch<T>) -> kuro_error::Result<()> {
...
pub async fn get_configured_graph_properties(
    ...
    configured_graph_sketch: bool,
    per_configuration_sketch: bool,
) -> kuro_error::Result<MaybeCompatible<GraphPropertiesValues>> {
