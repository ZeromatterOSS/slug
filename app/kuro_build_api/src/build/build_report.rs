...
use kuro_core::pattern::pattern::TargetLabelWithModifiers;
...
use kuro_error::UniqueRootId;
use kuro_error::classify::ErrorLike;
use kuro_error::classify::Tier;
...
pub struct BuildReportCollector<'a> {
    ...
    error_cause_cache: HashMap<kuro_error::UniqueRootId, usize>,
...
#[derive(kuro_error::Error)]
#[error(transparent)]
#[kuro(tag = BuildReport)]
pub struct BuildReportGenerationError(kuro_error::Error);

impl From<kuro_error::Error> for BuildReportGenerationError {
...
impl<'a> BuildReportCollector<'a> {
    ...
    fn assemble_build_report(
        ...
        // Determine error category using existing Kuro error classification
        ...
        Ok(BuildReport {
            ...
            // Setting this to false since we don't currently truncate kuro's build report.
            truncated: false,
    ...
    ) -> kuro_error::Result<BuildReportEntry> {
    ...
    fn collect_results_for_configured<'b>(
        ...
        metrics: &mut HashMap<&'b ConfiguredProvidersLabel, Arc<TargetBuildMetrics>>,
        all_error_reports: &mut Vec<ErrorReport>,
    ) -> kuro_error::Result<ConfiguredBuildReportEntry> {
    ...
    fn collect_per_configuration_data(
        &mut self,
    ) -> kuro_error::Result<Option<HashMap<String, PerConfigurationEntry>>> {
        ...
        let per_configuration_data = total_per_configuration_sketcher
            ...
            .collect::<kuro_error::Result<HashMap<String, PerConfigurationEntry>>>()?;
...
) -> Result<Option<String>, kuro_error::Error> {
