...
impl ToProtoMessage for DetailedAggregatedMetrics {
    type Message = kuro_data::DetailedAggregatedMetrics;

    fn as_proto(&self) -> Self::Message {
        kuro_data::DetailedAggregatedMetrics {
...
impl ToProtoMessage for AggregatedBuildMetrics {
    type Message = kuro_data::AggregatedBuildMetrics;

    fn as_proto(&self) -> Self::Message {
        kuro_data::AggregatedBuildMetrics {
...
impl ToProtoMessage for TopLevelTargetAggregatedData {
    type Message = kuro_data::TopLevelTargetMetrics;

    fn as_proto(&self) -> Self::Message {
        kuro_data::TopLevelTargetMetrics {
...
impl AggregatedBuildMetrics {
    fn aggregate_execution(&mut self, factor: f64, ev: &ActionExecutionMetrics, when: BuiltWhen) {
        ...
        if let BuiltWhen::ThisBuild = when {
            ...
            match ev.execution_kind {
                kuro_data::ActionExecutionKind::Local
                ...
                kuro_data::ActionExecutionKind::Remote
                | kuro_data::ActionExecutionKind::RemoteWorker => {
                    self.remote_execution_time_ms += factor * (ev.execution_time_ms as f64);
                    self.remote_executions += factor;
                }
                kuro_data::ActionExecutionKind::ActionCache
                | kuro_data::ActionExecutionKind::RemoteDepFileCache => {
                    self.remote_cache_hits += factor;
                }
                kuro_data::ActionExecutionKind::NotSet
                | kuro_data::ActionExecutionKind::Simple
                | kuro_data::ActionExecutionKind::Deferred
                | kuro_data::ActionExecutionKind::LocalDepFile
...
impl ToProtoMessage for AllTargetsAggregatedData {
    type Message = kuro_data::AllTargetsBuildMetrics;

    fn as_proto(&self) -> Self::Message {
        kuro_data::AllTargetsBuildMetrics {
            action_graph_size: self.action_graph_size,
            metrics: Some(self.metrics.as_proto()),
