...
pub trait BxlAqueryFunctions: Send {
    ...
    ) -> kuro_error::Result<(Vec<ConfiguredTargetLabel>, TargetSet<ActionQueryNode>)>;
...
pub static NEW_BXL_CQUERY_FUNCTIONS: LateBinding<
    fn(
        ...
        CellName,
        CellResolver,
    ) -> Pin<Box<dyn Future<Output = kuro_error::Result<Box<dyn BxlCqueryFunctions>>>>>,
...
pub static NEW_BXL_UQUERY_FUNCTIONS: LateBinding<
    fn(
        ...
        -> Pin<Box<dyn Future<Output = kuro_error::Result<Box<dyn BxlUqueryFunctions>>> + Send>>,
...
pub static NEW_BXL_AQUERY_FUNCTIONS: LateBinding<
    fn(
        ...
        CellName,
        CellResolver,
    ) -> Pin<Box<dyn Future<Output = kuro_error::Result<Box<dyn BxlAqueryFunctions>>>>>,
