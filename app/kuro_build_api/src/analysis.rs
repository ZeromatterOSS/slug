...
// TODO(@wendyy) move into `kuro_node`
pub mod anon_promises_dyn;
// TODO(@wendyy) move into `kuro_interpreter_for_build`
...
impl AnalysisResult {
    ...
    pub fn providers(&self) -> kuro_error::Result<FrozenProviderCollectionValueRef<'_>> {
