...
///
/// When you create custom actions with `ctx.actions.run()`, you need to tell Kuro which artifacts
...
/// - If you forget to bind a declared artifact, Kuro will raise an error
#[starlark_module]
