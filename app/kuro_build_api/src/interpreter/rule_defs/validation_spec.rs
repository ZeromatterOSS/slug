...
pub struct StarlarkValidationSpecGen<V: ValueLifetimeless> {
    ...
    /// Should contain JSON of defined schema setting API between Kuro and user-created validators/scripts.
...
fn validate_validation_spec<'v, V>(spec: &StarlarkValidationSpecGen<V>) -> kuro_error::Result<()>
where
    V: ValueLike<'v>,
{
