...
impl CoercedSelector {
    ...
    fn check_all_keys_unique(
        ...
        fn duplicate_key(key: &ConfigurationSettingKey) -> kuro_error::Error {
            kuro_error!(
    ...
    pub fn to_json(&self, ctx: &AttrFmtContext) -> kuro_error::Result<serde_json::Value> {
...
impl CoercedAttr {
    ...
    pub fn select_the_most_specific<'a, 'x>(
        ...
        >,
    ) -> kuro_error::Result<Option<&'a CoercedAttr>> {
    ...
    pub fn configure(
        ...
        ty: &AttrType,
        ctx: &dyn AttrConfigurationContext,
    ) -> kuro_error::Result<ConfiguredAttr> {
