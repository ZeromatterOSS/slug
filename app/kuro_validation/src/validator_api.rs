...
//! This module defines the API between validators and Kuro by specifying
...
pub(crate) fn parse_validation_result(content: &str) -> kuro_error::Result<ValidationResult> {
