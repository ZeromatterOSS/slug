...
pub struct ProfilerData {
    ...
    profile_data: Option<kuro_error::Result<ProfileData>>,
}
...
impl ProfilerData {
    ...
    pub(crate) fn initialize(&mut self, eval: &mut Evaluator) -> kuro_error::Result<bool> {
    ...
    ) -> kuro_error::Result<Option<Arc<StarlarkProfileDataAndStats>>> {
