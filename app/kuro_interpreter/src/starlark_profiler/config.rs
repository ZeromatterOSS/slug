...
use kuro_common::pattern::parse_from_cli::parse_patterns_from_cli_args_typed;
use kuro_core::pattern::package::PackagePredicate;
use kuro_core::pattern::pattern::ParsedPatternPredicate;
...
impl ProfileRegex {
    pub fn new(patterns: &[String]) -> kuro_error::Result<Self> {
...
impl Key for StarlarkProfilerConfigurationResolvedKey {
    type Value = kuro_error::Result<Arc<StarlarkProfilerConfigurationResolved>>;
...
impl ProjectionKey for StarlarkProfileModeForKind {
    ...
    type Value = kuro_error::Result<StarlarkProfileMode>;

    fn compute(
        &self,
        configuration: &kuro_error::Result<Arc<StarlarkProfilerConfigurationResolved>>,
        _ctx: &DiceProjectionComputations,
    ) -> kuro_error::Result<StarlarkProfileMode> {
