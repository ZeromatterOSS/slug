...
fn to_diagnostic(err: &kuro_error::Error, id: &str) -> kuro_error::Error {
...
impl InterpreterFileLoader {
    ...
    fn find_module(&self, id: StarlarkModulePath) -> kuro_error::Result<&FrozenModule> {
...
mod tests {
    ...
    impl LoadResolver for TestLoadResolver {
        fn resolve_load(
            ...
            match path {
                ...
                _ => Err(kuro_error!(kuro_error::ErrorTag::Tier0, "error")),
            }
        }
    }
    ...
    #[test]
    fn no_resolution() -> kuro_error::Result<()> {
    ...
    #[test]
    fn missing_in_loaded_modules() -> kuro_error::Result<()> {
    ...
    #[test]
    fn valid_load() -> kuro_error::Result<()> {
        let path = "cell1//next/package:import.bzl".to_owned();
        let resolver = resolver();
    ...
    #[test]
    fn valid_find() -> kuro_error::Result<()> {
        let path = "cell1//next/package:import.bzl".to_owned();
        let resolver = resolver();
