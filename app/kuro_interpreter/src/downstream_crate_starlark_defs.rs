...
/// Globals defined in `kuro_build_api`.
...
/// `__internal__`s defined in `kuro_build_api`.
...
/// Globals defined in `kuro_transitions` crate.
...
/// Globals defined in `kuro_action_impl` crate.
...
/// Globals defined in `kuro_anon_targets` crate.
...
/// Globals defined in `kuro_bxl` crate,
...
/// Globals defined in `kuro_cfg_constructor` crate.
