...
use kuro_execute::execute::action_digest::ActionDigestKind;
...
impl CacheType {
    fn to_proto(&self) -> kuro_data::CacheType {
        match self {
            CacheType::ActionCache => kuro_data::CacheType::ActionCache,
            CacheType::RemoteDepFileCache(_) => kuro_data::CacheType::RemoteDepFileCache,
        }
    }
}
