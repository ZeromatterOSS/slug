...
/// then you can fix forward by bumping the `kuro.sqlite_incremental_state_version`
...
mod tests {
    ...
    #[test]
    fn test_initialize_incremental_sqlite_db() -> kuro_error::Result<()> {
        ...
        mapping.insert(
            kuro_fs::paths::forward_rel_path::ForwardRelativePathBuf::unchecked_new(
                "test_file".to_owned(),
            ),
