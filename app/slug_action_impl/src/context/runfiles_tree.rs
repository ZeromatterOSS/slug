...
//! executable) can locate its runtime dependencies. Slug didn't emit this tree from
...
use slug_build_api::interpreter::rule_defs::provider::builtin::default_info::SYNTHESIZE_RUNFILES_TREE;
...
) -> slug_error::Result<(Option<String>, String, BuckOutPathKind)> {
...
fn build_unpack_entries<'v>(
    ...
    &'v str,
    slug_build_api::interpreter::rule_defs::artifact::starlark_artifact_like::ValueAsInputArtifactLike<'v>,
>{
