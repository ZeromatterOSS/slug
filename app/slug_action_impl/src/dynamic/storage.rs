...
use slug_build_api::analysis::registry::AnalysisValueStorage;
...
use slug_build_api::dynamic::storage::DynamicLambdaParamStorages;
use slug_build_api::dynamic::storage::DynamicLambdaParamsStorage;
use slug_build_api::dynamic::storage::FrozenDynamicLambdaParamsStorage;
...
impl<'v> DynamicLambdaParamsStorageImpl<'v> {
    ...
    ) -> slug_error::Result<&'a mut DynamicLambdaParamsStorageImpl<'v>> {
        storage
            .lambda_params
            .as_any_mut()
            .downcast_mut()
    ...
    pub fn next_dynamic_actions_key(&self) -> slug_error::Result<DynamicLambdaResultsKey> {
...
impl FrozenDynamicLambdaParamsStorageImpl {
    pub(crate) fn lookup_lambda<'f>(
        ...
        key: &DynamicLambdaResultsKey,
    ) -> slug_error::Result<OwnedRefFrozenRef<'f, FrozenDynamicLambdaParams>> {
