...
use slug_execute::directory::re_directory_to_re_tree;
...
enum CasArtifactActionDeclarationError {
    ...
    #[slug(tag = ReCasArtifactWrongNumberOfOutputs)]
...
enum CasArtifactActionExecutionError {
    ...
    #[slug(tag = ReCasArtifactInvalidExpiration)]
    InvalidExpiration {
        digest: FileDigest,
...
impl Action for CasArtifactAction {
    fn kind(&self) -> slug_data::ActionKind {
        slug_data::ActionKind::CasArtifact
    }
    ...
    async fn execute(
        ...
        let get_expiration = || async {
            slug_error::Ok(
                re_client
                    ...
                    .tag(slug_error::ErrorTag::ReCasArtifactGetDigestExpirationError)?
                    .1,
            )
        };
        ...
        if expiration < self.inner.expires_after {
            ...
            let error: slug_error::Error = CasArtifactActionExecutionError::InvalidExpiration {
