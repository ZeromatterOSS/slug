...
use slug_build_api::actions::impls::json;
use slug_build_api::actions::impls::json::JsonUnpack;
use slug_build_api::actions::impls::json::validate_json;
use slug_build_api::artifact_groups::ArtifactGroup;
use slug_build_api::command_line_arg_like_impl;
...
impl UnregisteredWriteJsonAction {
    ...
    pub(crate) fn cli<'v>(
        artifact: Value<'v>,
        content: Value<'v>,
    ) -> slug_error::Result<StarlarkWriteJsonCommandLineArg<'v>> {
...
impl Action for WriteJsonAction {
    ...
    fn aquery_attributes(
        ...
        let res: slug_error::Result<String> =
