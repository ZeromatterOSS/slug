...
use slug_build_api::interpreter::rule_defs::cmd_args::CommandLineLocation;
use slug_build_api::interpreter::rule_defs::cmd_args::DefaultCommandLineContext;
use slug_build_api::interpreter::rule_defs::cmd_args::WriteToFileMacroVisitor;
use slug_build_api::interpreter::rule_defs::cmd_args::arg_builder::ArgBuilder;
...
impl Action for WriteMacrosToFileAction {
    fn kind(&self) -> slug_data::ActionKind {
        slug_data::ActionKind::WriteMacrosToFile
    }
...
impl WriteToFileMacroVisitor for MacroToFileWriter<'_> {
    ...
    fn set_current_relative_to_path(
        &mut self,
        generate: &dyn Fn(&dyn CommandLineContext) -> slug_error::Result<Option<RelativePathBuf>>,
    ) -> slug_error::Result<()> {
...
impl CommandLineContext for MacroContext<'_> {
    ...
    ) -> slug_error::Result<CommandLineLocation<'_>> {
    ...
    fn next_macro_file_path(&mut self) -> slug_error::Result<RelativePathBuf> {
