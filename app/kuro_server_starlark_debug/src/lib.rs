...
//! Provides the (daemon-side) support for kuro's starlark debugging.
//!
//! Components of the debugger:
//!
//! [BuckStarlarkDebuggerServer] is the main way that the core of kuro integrates
...
//! will be created for each kuro command and put in the dice per-transaction data. Code
...
//! helper [kuro_interpreter::factory::StarlarkEvaluatorProvider]).
//!
