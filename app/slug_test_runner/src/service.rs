...
use slug_test_api::grpc::spawn_executor_server;
use tokio::io::AsyncRead;
use tokio::io::AsyncWrite;

use crate::executor::SlugTestExecutor;
use crate::runner::SlugTestRunner;
    ...
    EW: AsyncWrite + Send + Unpin + 'static,
{
    ...
    let executor_server =
        spawn_executor_server(executor_channel, SlugTestExecutor::new(spec_sender));
    ...
    let runner = SlugTestRunner::new(orchestrator_client, spec_receiver, args)?;
