...
use kuro_build_api::interpreter::rule_defs::resolved_macro::ResolvedStringWithMacrosPart;
...
use kuro_node::attrs::attr_type::arg::ConfiguredMacro;
...
fn resolve_configured_macro<'v>(
    ...
    ctx: &mut dyn AttrResolutionContext<'v>,
    pkg: PackageLabel,
) -> kuro_error::Result<ResolvedMacro<'v>> {
