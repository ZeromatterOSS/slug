...
use kuro_interpreter::downstream_crate_starlark_defs::REGISTER_BUCK2_ACTION_IMPL_GLOBALS;
use kuro_interpreter::downstream_crate_starlark_defs::REGISTER_BUCK2_ANON_TARGETS_GLOBALS;
use kuro_interpreter::downstream_crate_starlark_defs::REGISTER_BUCK2_BUILD_API_GLOBALS;
use kuro_interpreter::downstream_crate_starlark_defs::REGISTER_BUCK2_BUILD_API_INTERNALS;
use kuro_interpreter::downstream_crate_starlark_defs::REGISTER_BUCK2_BXL_GLOBALS;
...
use kuro_interpreter::starlark_promise::register_promise;
use kuro_interpreter::types::cell_path::register_cell_path;
use kuro_interpreter::types::cell_root::register_cell_root;
use kuro_interpreter::types::configured_providers_label::register_providers_label;
use kuro_interpreter::types::package_path::register_package_path;
use kuro_interpreter::types::project_root::register_project_root;
use kuro_interpreter::types::regex::register_buck_regex;
use kuro_interpreter::types::target_label::register_target_label;
...
// and `starlark_library_extensions_for_kuro` are all the same, since all symbols are available
...
pub fn starlark_library_extensions_for_kuro() -> &'static [LibraryExtension] {
    &[
...
fn register_all_natives(builder: &mut GlobalsBuilder) {
    ...
    for ext in starlark_library_extensions_for_kuro() {
        ext.add(builder);
    }
}
