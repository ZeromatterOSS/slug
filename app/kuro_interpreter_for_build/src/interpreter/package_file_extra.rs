...
pub static MAKE_CFG_CONSTRUCTOR: LateBinding<
    fn(OwnedFrozenValue) -> kuro_error::Result<Arc<dyn CfgConstructorImpl>>,
...
impl<'v> PackageFileExtra<'v> {
    ...
    ) -> kuro_error::Result<&'v PackageFileExtra<'v>> {
...
impl FrozenPackageFileExtra {
    pub(crate) fn get(
        module: &FrozenModule,
    ) -> kuro_error::Result<Option<OwnedFrozenRef<FrozenPackageFileExtra>>> {
