...
use kuro_node::attrs::attr_type::arg::ArgAttrType;
use kuro_node::attrs::attr_type::arg::MacroBase;
use kuro_node::attrs::attr_type::arg::QueryExpansion;
use kuro_node::attrs::attr_type::arg::StringWithMacrosPart;
use kuro_node::attrs::attr_type::arg::UnconfiguredMacro;
use kuro_node::attrs::attr_type::arg::UnconfiguredStringWithMacros;
use kuro_node::attrs::attr_type::arg::UnrecognizedMacro;
use kuro_node::attrs::attr_type::arg::parser;
use kuro_node::attrs::attr_type::arg::parser::ParsedMacro;
use kuro_node::attrs::attr_type::arg::parser::parse_macros;
use kuro_node::attrs::attr_type::query::QueryAttrType;
...
fn get_single_target_arg(
    args: Vec<String>,
    ctx: &dyn AttrCoercionContext,
) -> kuro_error::Result<ProvidersLabel> {
    if args.len() != 1 {
...
pub trait UnconfiguredMacroExt {
    fn new_location(
        ...
        args: Vec<String>,
        exec_dep: bool,
    ) -> kuro_error::Result<UnconfiguredMacro> {
...
mod tests {
    ...
    trait GetMacroDeps {
        type DepsType;
        fn get_deps(&self) -> kuro_error::Result<Vec<Self::DepsType>>;
    }
    ...
    #[test]
    fn test_location() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_location_exec() -> kuro_error::Result<()> {
        let ctx = coercion_ctx();
        let location =
    ...
    fn test_exe() -> kuro_error::Result<()> {
        ...
        if let MacroBase::Exe { label, .. } = &configured {
            ...
            return Err(kuro_error!(kuro_error::ErrorTag::Input, "Expected Exe"));
        }
    ...
    #[test]
    fn test_exe_target() -> kuro_error::Result<()> {
        let ctx = coercion_ctx();
