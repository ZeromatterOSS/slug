...
fn run_ctx_test(
    content: &str,
    result_handler: impl FnOnce(starlark::Result<Value>) -> kuro_error::Result<()>,
) -> kuro_error::Result<()> {
...
#[test]
fn ctx_instantiates() -> kuro_error::Result<()> {
    let content = indoc!(
        r#"
         def test(ctx):
...
#[test]
fn declare_output_declares_outputs() -> kuro_error::Result<()> {
    let content = indoc!(
        r#"
         def test(c):
...
#[test]
fn declare_output_with_prefix() -> kuro_error::Result<()> {
    let content = indoc!(
        r#"
         def test(c):
...
#[test]
fn declare_output_dot() -> kuro_error::Result<()> {
    let content = indoc!(
        r#"
         def test(c):
...
#[test]
fn declare_output_dot_bad() -> kuro_error::Result<()> {
    let content = indoc!(
        r#"
         def test(c):
...
#[test]
fn declare_output_dotdot() -> kuro_error::Result<()> {
    let content = indoc!(
        r#"
         def test(c):
