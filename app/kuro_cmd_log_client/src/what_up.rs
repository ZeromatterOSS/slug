...
use kuro_client_ctx::subscribers::superconsole::CUTOFFS;
use kuro_client_ctx::subscribers::superconsole::StatefulSuperConsole;
use kuro_client_ctx::subscribers::superconsole::SuperConsoleConfig;
use kuro_client_ctx::subscribers::superconsole::SuperConsoleState;
use kuro_client_ctx::subscribers::superconsole::session_info::SessionInfoComponent;
use kuro_client_ctx::subscribers::superconsole::timed_list::TimedList;
        ...
        while let Ok(Some(event)) = events.try_next().await {
            match event {
                ...
                StreamValue::Result(result) => {
                    ...
                    kuro_client_ctx::eprintln!("No open spans to render when log ended")?;
...
impl WhatUpCommand {
    fn component(state: &SuperConsoleState) -> impl Component<Error = kuro_error::Error> + '_ {
