...
#[cold]
#[track_caller]
pub fn kuro_error_impl(tag: crate::ErrorTag, args: Arguments) -> crate::Error {
...
#[macro_export]
macro_rules! kuro_error {
    ($tags:expr, $format:expr) => {
        $crate::kuro_error!($tags, $format,)
    };
    ($tags:expr, $format:expr, $($arg:tt)*) => {
        $crate::macros::kuro_error_impl($tags, format_args!($format, $($arg)*))
    };
}

/// Indicates a bug in kuro.
#[macro_export]
