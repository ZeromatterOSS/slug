...
//! Conversion impls for different error types to 'kuro_error::Error'
...
/// Helper function that can be explicitly called to convert `std::error::Error` into `kuro_error`.
///
