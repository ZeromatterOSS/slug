...
pub(crate) struct InternalTestRunnerCommand {
    #[cfg(unix)]
    #[clap(flatten)]
    unix_runner: kuro_test_runner::unix::KuroTestRunnerUnix,

    #[cfg(not(unix))]
    #[clap(flatten)]
    tcp_runner: kuro_test_runner::tcp::KuroTestRunnerTcp,
}
...
impl InternalTestRunnerCommand {
    pub(crate) fn exec(
        ...
        // Internal test runner should only be used in the open source version of Kuro.
