...
use kuro_build_event_stream::build_event_stream as bes;
use prost::Message;
...
fn sample_build_event() -> bes::BuildEvent {
    ...
    bes::BuildEvent {
        ...
        payload: Some(bes::build_event::Payload::Started(bes::BuildStarted {
            ...
            build_tool_version: "kuro-test".to_owned(),
...
fn publish_build_event_types_available() {
    use kuro_build_event_stream::google::devtools::build::v1 as bes_v1;
