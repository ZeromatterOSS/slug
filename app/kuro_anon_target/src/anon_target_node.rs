...
impl AnonTarget {
    pub(crate) fn as_proto(&self) -> kuro_data::AnonTarget {
        kuro_data::AnonTarget {
...
impl AnonTargetDyn for AnonTarget {
    ...
    ) -> kuro_error::Result<ValueOfUncheckedGeneric<Value<'v>, StructRef<'static>>> {
    ...
    ) -> kuro_error::Result<HashMap<PromiseArtifactId, Artifact>> {
