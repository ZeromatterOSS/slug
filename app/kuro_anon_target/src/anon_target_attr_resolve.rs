...
use kuro_analysis::attrs::resolve::attr_type::arg::ConfiguredStringWithMacrosExt;
use kuro_analysis::attrs::resolve::attr_type::dep::DepAttrTypeExt;
...
impl AnonTargetDependents {
    ...
    ) -> kuro_error::Result<AnonTargetDependents> {
    ...
    ) -> kuro_error::Result<AnonTargetDependentAnalysisResults<'v>> {
