...
pub async fn get_info() -> slug_error::Result<String> {
...
async fn get_hg_info() -> slug_error::Result<CommandResult> {
...
async fn get_git_info() -> slug_error::Result<CommandResult> {
...
fn from_utf8(result: Vec<u8>, subject: &str) -> slug_error::Result<String> {
