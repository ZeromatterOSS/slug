...
impl QueryEnvironment for Env {
    ...
    async fn get_node(&self, _node_ref: &TargetRef) -> kuro_error::Result<Self::Target> {
        unimplemented!()
    }
    ...
    async fn dfs_postorder(
        ...
        _visit: impl FnMut(Self::Target) -> kuro_error::Result<()> + Send,
    ) -> kuro_error::Result<()> {
        unimplemented!()
    }
...
#[tokio::test]
pub async fn test_missing_arg() -> kuro_error::Result<()> {
