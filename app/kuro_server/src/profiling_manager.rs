...
use kuro_cli_proto::client_context::ProfilePatternOptions;
use kuro_error::BuckErrorContext;
use kuro_events::dispatch::EventDispatcher;
use kuro_fs::paths::abs_path::AbsPathBuf;
use kuro_interpreter::starlark_profiler::config::ProfileRegex;
...
impl StarlarkProfilingManager {
    ...
    pub fn finalize(&self) -> kuro_error::Result<()> {
