...
use kuro_server_ctx::late_bindings::DOCS_SERVER_COMMAND;
...
pub(crate) async fn new_generic_command(
    ...
    req: kuro_cli_proto::NewGenericRequestMessage,
    partial_result_dispatcher: PartialResultDispatcher<NoPartialResult>,
) -> kuro_error::Result<kuro_cli_proto::NewGenericResponseMessage> {
    ...
    Ok(kuro_cli_proto::NewGenericResponseMessage {
