...
mod collector {
    ...
    impl SystemNetworkIoCollector {
        ...
        pub fn collect(&self) -> kuro_error::Result<Option<HashMap<String, NetworkStat>>> {
                ...
                counters.insert(
                    ...
                    NetworkStat {
                        ...
                        network_kind: match interface.network_kind() {
                            kuro_util::os::win::network_interface::NetworkKind::Ethernet => {
                                NetworkKind::Ethernet
                            }
                            kuro_util::os::win::network_interface::NetworkKind::WiFi => {
                                NetworkKind::WiFi
                            }
                            _ => NetworkKind::Unknown,
                        },
