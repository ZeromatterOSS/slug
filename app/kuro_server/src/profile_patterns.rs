...
impl FileWritingProfileEventListener {
    ...
    fn handle_profile_collected(
        &self,
        eval_kind: kuro_interpreter::dice::starlark_provider::StarlarkEvalKind,
        profile_data: &std::sync::Arc<
            kuro_interpreter::starlark_profiler::data::StarlarkProfileDataAndStats,
        >,
    ) -> kuro_error::Result<()> {
