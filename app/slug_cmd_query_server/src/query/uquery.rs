...
use slug_cli_proto::HasClientContext as _;
...
use slug_node::nodes::unconfigured::TargetNodeData;
...
impl ServerCommandTemplate for UqueryServerCommand {
    type StartEvent = slug_data::QueryCommandStart;
    type EndEvent = slug_data::QueryCommandEnd;
