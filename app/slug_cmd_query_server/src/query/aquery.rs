...
impl ServerCommandTemplate for AqueryServerCommand {
    type StartEvent = slug_data::AqueryCommandStart;
    type EndEvent = slug_data::AqueryCommandEnd;
    type Response = slug_cli_proto::AqueryResponse;
...
async fn aquery(
    ...
    request: &slug_cli_proto::AqueryRequest,
) -> slug_error::Result<slug_cli_proto::AqueryResponse> {
    ...
    let slug_cli_proto::AqueryRequest {
        query, query_args, ..
    } = request;
    ...
    Ok(slug_cli_proto::AqueryResponse {})
}
