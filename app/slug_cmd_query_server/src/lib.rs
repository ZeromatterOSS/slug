...
impl QueryServerCommands for QueryServerCommandsInstance {
    async fn uquery(
        ...
        req: UqueryRequest,
    ) -> slug_error::Result<UqueryResponse> {
    ...
    async fn cquery(
        ...
        partial_result_dispatcher: PartialResultDispatcher<StdoutBytes>,
        req: CqueryRequest,
    ) -> slug_error::Result<CqueryResponse> {
    ...
    async fn aquery(
        ...
        partial_result_dispatcher: PartialResultDispatcher<StdoutBytes>,
        req: AqueryRequest,
    ) -> slug_error::Result<AqueryResponse> {
        aquery_command(ctx, partial_result_dispatcher, req).await
    }
}

pub fn init_late_bindings() {
    slug_server_ctx::late_bindings::QUERY_SERVER_COMMANDS.init(&QueryServerCommandsInstance);
