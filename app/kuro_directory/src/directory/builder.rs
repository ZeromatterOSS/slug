    ...
    H: DirectoryDigest,
{
    ...
    pub fn merge_with_compatible_leaves(&mut self, other: Self) -> Result<(), DirectoryMergeError> {
        if !kuro_core::faster_directories::is_enabled() {
...
mod tests {
    ...
    #[test]
    fn test_insert() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_merge() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_merge_overwrite() -> kuro_error::Result<()> {
        let mut a = TestDirectoryBuilder::empty();
        a.insert(path("a/b"), DirectoryEntry::Leaf(NopEntry))?;
    ...
    #[test]
    fn test_merge_conflict() -> kuro_error::Result<()> {
        let mut a = TestDirectoryBuilder::empty();
    ...
    #[test]
    fn test_copy_on_write() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_mkdir() -> kuro_error::Result<()> {
        let mut b = TestDirectoryBuilder::empty();
    ...
    #[test]
    fn test_mkdir_overwrite() -> kuro_error::Result<()> {
        let mut b = TestDirectoryBuilder::empty();
        b.insert(path("a/b"), DirectoryEntry::Leaf(NopEntry))?;
