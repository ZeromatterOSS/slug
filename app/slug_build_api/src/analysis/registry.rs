...
impl<'v> AnalysisRegistry<'v> {
    ...
    pub fn finalize(
        ...
        impl FnOnce(&FrozenModule) -> slug_error::Result<RecordedAnalysisValues> + use<>,
    > {
...
impl<'v> AnalysisValueStorage<'v> {
    ...
    fn write_to_module(self, module: &'v Module) -> slug_error::Result<()> {
    ...
    pub(crate) fn register_transitive_set<
        F: FnOnce(TransitiveSetKey) -> slug_error::Result<ValueTyped<'v, TransitiveSet<'v>>>,
    >(
        &mut self,
        func: F,
    ) -> slug_error::Result<ValueTyped<'v, TransitiveSet<'v>>> {
...
impl AnalysisValueFetcher {
    fn extra_value(
        &self,
    ) -> slug_error::Result<Option<(&FrozenAnalysisValueStorage, &FrozenHeapRef)>> {
    ...
    pub fn get_action_data(
        &self,
        id: &ActionKey,
    ) -> slug_error::Result<(Option<OwnedFrozenValue>, Option<OwnedFrozenValue>)> {
...
impl RecordedAnalysisValues {
    ...
    ) -> slug_error::Result<OwnedFrozenValueTyped<FrozenTransitiveSet>> {
    ...
    pub fn lookup_action(&self, key: &ActionKey) -> slug_error::Result<ActionLookup> {
        if key.holder_key() != &self.self_key {
            return Err(internal_error!(
    ...
    pub fn analysis_storage(
        &self,
    ) -> slug_error::Result<OwnedRefFrozenRef<'_, FrozenAnalysisValueStorage>> {
        Ok(self
            .analysis_storage
            .as_ref()
    ...
    pub fn provider_collection(&self) -> slug_error::Result<FrozenProviderCollectionValueRef<'_>> {
    ...
    pub fn retained_memory(&self) -> slug_error::Result<usize> {
        Ok(self
            .analysis_storage
            .as_ref()
            .internal_error("missing analysis storage")?
