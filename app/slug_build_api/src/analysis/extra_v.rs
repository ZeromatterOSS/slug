...
impl<'v> AnalysisExtraValue<'v> {
    pub fn get(module: &'v Module) -> slug_error::Result<Option<&'v AnalysisExtraValue<'v>>> {
    ...
    pub fn get_or_init(module: &'v Module) -> slug_error::Result<&'v AnalysisExtraValue<'v>> {
...
impl FrozenAnalysisExtraValue {
    pub fn get(
        module: &FrozenModule,
    ) -> slug_error::Result<OwnedFrozenValueTyped<StarlarkAnyComplex<FrozenAnalysisExtraValue>>>
    {
        Ok(module
            .owned_extra_value()
