...
///
/// When you create custom actions with `ctx.actions.run()`, you need to tell Slug which artifacts
...
/// - If you forget to bind a declared artifact, Slug will raise an error
#[starlark_module]
