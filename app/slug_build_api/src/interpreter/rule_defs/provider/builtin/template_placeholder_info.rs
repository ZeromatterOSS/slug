...
fn verify_variables_type(field_key: &str, variables: Value) -> slug_error::Result<()> {
...
impl<'v> TemplatePlaceholderInfo<'v> {
    fn new(unkeyed_variables: Value<'v>, keyed_variables: Value<'v>) -> slug_error::Result<Self> {
