...
use slug_interpreter::types::cell_root::CellRoot;
use slug_interpreter::types::configured_providers_label::StarlarkConfiguredProvidersLabel;
use slug_interpreter::types::project_root::StarlarkProjectRoot;
...
pub trait CommandLineContext {
    ...
    fn resolve_cell_path(&self, path: CellPathRef) -> slug_error::Result<CommandLineLocation<'_>> {
