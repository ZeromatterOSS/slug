...
pub struct StarlarkValidationSpecGen<V: ValueLifetimeless> {
    ...
    /// Should contain JSON of defined schema setting API between Slug and user-created validators/scripts.
...
fn validate_validation_spec<'v, V>(spec: &StarlarkValidationSpecGen<V>) -> slug_error::Result<()>
where
    V: ValueLike<'v>,
{
