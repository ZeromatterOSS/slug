...
pub trait HasBuildContextData {
    async fn get_buck_out_path(&mut self) -> slug_error::Result<BuckOutPathResolver>;
}
...
impl SetBuildContextData for DiceTransactionUpdater {
    fn set_buck_out_path(
        ...
        slug_execute::path::artifact_path::set_artifact_path_buck_out_root(buck_out_path.to_buf());
