...
pub fn process_exists(pid: Pid) -> slug_error::Result<bool> {
...
pub fn kill(pid: Pid) -> slug_error::Result<Option<KilledProcessHandle>> {
    match imp::kill(pid)? {
...
impl KilledProcessHandle {
    pub fn has_exited(&self) -> slug_error::Result<bool> {
