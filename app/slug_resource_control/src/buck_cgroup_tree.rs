...
fn parse_procfs_cgroup_output(out: &str) -> slug_error::Result<CgroupPathBuf> {
...
impl PreppedBuckCgroups {
    ...
    ///  2. Slug may manage the child cgroups by itself without interference from outside things;
    ...
    pub fn prep_current_process() -> slug_error::Result<Self> {
...
mod tests {
    ...
    fn test_cgroup_info_parse() {
        let cgroup = "\
0::/user.slice/user-532497.slice/user@532497.service/slug.cg\n";
        assert_eq!(
