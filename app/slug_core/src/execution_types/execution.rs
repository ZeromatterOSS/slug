...
impl ExecutionPlatformResolution {
    ...
    // TODO(cjhopman): Should this be an slug_error::Result and never return an invalid configuration?
    #[inline]
    ...
    pub fn platform(&self) -> slug_error::Result<&ExecutionPlatform> {
        match &self.platform {
            Some(v) => Ok(v),
    ...
    pub fn executor_config(&self) -> slug_error::Result<&Arc<CommandExecutorConfig>> {
