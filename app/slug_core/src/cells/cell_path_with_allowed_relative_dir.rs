...
impl CellPathWithAllowedRelativeDir {
    ...
    pub fn join_normalized(&self, path: &RelativePath) -> slug_error::Result<CellPath> {
...
mod tests {
    ...
    #[test]
    fn parent_directory_traversal() -> slug_error::Result<()> {
    ...
    #[test]
    fn multiple_parent_directory_traversal() -> slug_error::Result<()> {
        let import = "../../foo.bzl";
        let cell_path_with_allowed_relative_dir = CellPathWithAllowedRelativeDir {
    ...
    #[test]
    fn parent_directory_with_subpath() -> slug_error::Result<()> {
    ...
    #[test]
    fn traversal_out_of_allowed_dir() -> slug_error::Result<()> {
    ...
    #[test]
    fn nonleading_parent_dir_component() -> slug_error::Result<()> {
