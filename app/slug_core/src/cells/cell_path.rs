...
impl CellPath {
    ...
    pub fn strip_prefix<'a>(
        &'a self,
        base: CellPathRef,
    ) -> slug_error::Result<&'a ForwardRelativePath> {
    ...
    /// # slug_error::Ok(())
    /// ```
    pub fn join_normalized<P: AsRef<RelativePath>>(&self, path: P) -> slug_error::Result<CellPath> {
...
impl<'a> CellPathRef<'a> {
    ...
    #[inline]
    pub fn strip_prefix(&self, base: CellPathRef) -> slug_error::Result<&'a ForwardRelativePath> {
