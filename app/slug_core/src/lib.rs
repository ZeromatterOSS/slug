...
pub use slug_env::env;
pub use slug_env::soft_error as error;
...
// Re-export macros from slug_env so they're available at the crate root
pub use slug_env::env::slug_env;
pub use slug_env::env::slug_env_name;
...
#[doc(inline)]
pub use slug_env::soft_error::tag_error;
#[doc(inline)]
pub use slug_env::soft_error::tag_result;
