...
mod tests {
    ...
    #[test]
    fn buck_path_resolves() -> slug_error::Result<()> {
    ...
    #[test]
    fn buck_output_path_resolves() -> slug_error::Result<()> {
    ...
    #[test]
    fn buck_target_output_path_resolves() -> slug_error::Result<()> {
        let path_resolver =
    ...
    #[test]
    fn test_resolve_test_discovery() -> slug_error::Result<()> {
        let path_resolver =
            BuckOutPathResolver::new(ProjectRelativePathBuf::unchecked_new("buck-out".into()));
