...
impl ProjectRelativePath {
    ...
    /// assert!(ProjectRelativePath::new(Path::new("normalize/../bar")).is_err());
    /// ```
    pub fn new<P: ?Sized + AsRef<Path>>(p: &P) -> slug_error::Result<&ProjectRelativePath> {
    ...
    /// # slug_error::Ok(())
    /// ```
    pub fn strip_prefix<P>(&self, base: P) -> slug_error::Result<&ForwardRelativePath>
    where
    ...
    pub fn strip_suffix<P>(&self, suffix: P) -> slug_error::Result<&ProjectRelativePath>
    where
...
impl<'a> TryFrom<&'a str> for &'a ProjectRelativePath {
    ...
    /// assert!(<&ProjectRelativePath>::try_from("normalize/../bar").is_err());
    /// ```
    fn try_from(s: &'a str) -> slug_error::Result<&'a ProjectRelativePath> {
...
impl<'a> TryFrom<&'a RelativePath> for &'a ProjectRelativePath {
    ...
    /// assert!(<&ProjectRelativePath>::try_from(RelativePath::new("normalize/../bar")).is_err());
    /// ```
    fn try_from(s: &'a RelativePath) -> slug_error::Result<&'a ProjectRelativePath> {
...
impl TryFrom<String> for ProjectRelativePathBuf {
    ...
    /// assert!(ProjectRelativePathBuf::try_from("normalize/../bar".to_owned()).is_err());
    /// ```
    fn try_from(s: String) -> slug_error::Result<ProjectRelativePathBuf> {
...
impl TryFrom<RelativePathBuf> for ProjectRelativePathBuf {
    ...
    /// assert!(ProjectRelativePathBuf::try_from(RelativePathBuf::from("normalize/../bar")).is_err());
    /// ```
    fn try_from(p: RelativePathBuf) -> slug_error::Result<ProjectRelativePathBuf> {
        Ok(ProjectRelativePathBuf::from(
...
impl TryFrom<PathBuf> for ProjectRelativePathBuf {
    ...
    /// assert!(ProjectRelativePathBuf::try_from(PathBuf::from("normalize/../bar")).is_err());
    /// ```
    fn try_from(p: PathBuf) -> slug_error::Result<ProjectRelativePathBuf> {
...
mod tests {
    ...
    #[test]
    fn path_display_is_readable() -> slug_error::Result<()> {
    ...
    #[test]
    fn path_is_comparable() -> slug_error::Result<()> {
    ...
    #[test]
    fn wrapped_paths_work_in_maps() -> slug_error::Result<()> {
