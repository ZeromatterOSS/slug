...
impl TargetName {
    #[inline]
    pub fn new(name: &str) -> slug_error::Result<Self> {
    ...
    fn bad_name_error(name: &str) -> slug_error::Error {
    ...
    fn verify(name: &str) -> slug_error::Result<()> {
...
impl TargetNameRef {
    #[inline]
    pub fn new(name: &str) -> slug_error::Result<&TargetNameRef> {
