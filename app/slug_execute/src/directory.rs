...
use slug_directory::directory::builder_lazy::DirectoryBuilderLike;
use slug_directory::directory::builder_lazy::LazyDirectoryBuilder;
use slug_directory::directory::dashmap_directory_interner::DashMapDirectoryInterner;
...
use slug_directory::directory::directory_ref::FingerprintedDirectoryRef;
use slug_directory::directory::directory_selector::DirectorySelector;
use slug_directory::directory::entry::DirectoryEntry;
use slug_directory::directory::find::DirectoryFindError;
use slug_directory::directory::find::find;
use slug_directory::directory::fingerprinted_directory::FingerprintedDirectory;
use slug_directory::directory::immutable_directory::ImmutableDirectory;
use slug_directory::directory::shared_directory::SharedDirectory;
...
pub fn new_symlink<T: AsRef<Path>>(target: T) -> slug_error::Result<ActionDirectoryMember> {
...
pub fn extract_artifact_value(
    ...
    digest_config: DigestConfig,
) -> slug_error::Result<Option<ArtifactValue>> {
...
mod tests {
    ...
    #[test]
    fn directory_relativized() -> slug_error::Result<()> {
    ...
    fn build_test_dir() -> slug_error::Result<ActionDirectoryBuilder> {
        let digest_config = DigestConfig::testing_default();
    ...
    #[test]
    fn test_extract_no_deps() -> slug_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    #[test]
    fn test_extract_has_deps_dir() -> slug_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    #[test]
    fn test_extract_has_deps_leaf() -> slug_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    #[test]
    fn test_extract_cycle() -> slug_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    #[test]
    fn test_extract_symlink_chain() -> slug_error::Result<()> {
    ...
    #[test]
    fn test_re_tree_roundtrip() -> slug_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    ///
    /// ```sh
    /// slug run fbcode//remote_execution/rust/recli:recli -- \
    ...
    /// ```
    #[test]
    fn test_re_tree_compatibility() -> slug_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
    ...
    fn test_unnormalized_symlinks() -> slug_error::Result<()> {
        if !cfg!(windows) {
            return Ok(());
        }
    ...
    #[test]
    fn test_rename_and_serialize() -> slug_error::Result<()> {
        let digest_config = DigestConfig::testing_default();
