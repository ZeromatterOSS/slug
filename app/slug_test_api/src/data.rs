...
pub use slug_test_proto::CasDigest;
pub use slug_test_proto::ExecutionDetails;
...
pub struct ExecutionResult2 {
    ...
    pub max_memory_used_bytes: Option<u64>,
    /// We don't try to convert this field, mostly because it shares with slug.data, and that
