...
use slug_test_proto::ExternalRunnerSpecRequest;
use slug_test_proto::UnstableHeapDumpRequest;
use slug_test_proto::UnstableHeapDumpResponse;
use slug_test_proto::test_executor_client;
use slug_test_proto::test_executor_server;
...
impl TestExecutor for TestExecutorClient {
    ...
    async fn unstable_heap_dump(&self, path: &str) -> slug_error::Result<()> {
        self.client
            .clone()
