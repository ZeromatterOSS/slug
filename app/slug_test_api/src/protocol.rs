...
pub trait TestExecutor: Send + Sync {
    ...
    async fn external_runner_spec(&self, s: ExternalRunnerSpec) -> slug_error::Result<()>;
    ...
    async fn unstable_heap_dump(&self, _: &str) -> slug_error::Result<()> {
        Err(slug_error::slug_error!(ErrorTag::Input, "Unimplemented!"))
    }
}
