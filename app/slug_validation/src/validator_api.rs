...
//! This module defines the API between validators and Slug by specifying
...
pub(crate) fn parse_validation_result(content: &str) -> slug_error::Result<ValidationResult> {
