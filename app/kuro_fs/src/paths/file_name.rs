...
fn verify_file_name(file_name: &str) -> kuro_error::Result<()> {
...
impl FileName {
    ...
    /// ```
    #[inline]
    pub fn new<S: ?Sized + AsRef<str>>(s: &S) -> kuro_error::Result<&Self> {
        verify_file_name(s.as_ref())?;
        Ok(Self::unchecked_new(s.as_ref()))
    }

    pub fn from_os_string(file_name: &OsString) -> kuro_error::Result<&FileName> {
...
impl<'a> TryFrom<&'a str> for &'a FileName {
    ...
    #[inline]
    fn try_from(value: &'a str) -> kuro_error::Result<&'a FileName> {
        FileName::new(value)
    }
}
...
impl TryFrom<String> for FileNameBuf {
    ...
    #[inline]
    fn try_from(value: String) -> kuro_error::Result<FileNameBuf> {
...
impl TryFrom<CompactString> for FileNameBuf {
    ...
    #[inline]
    fn try_from(value: CompactString) -> kuro_error::Result<FileNameBuf> {
        verify_file_name(value.as_str())?;
