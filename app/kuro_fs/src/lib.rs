...
//! Project-agnostic filesystem utilities for Kuro.
//!
//! This crate contains filesystem types and utilities that have no knowledge
//! of Kuro projects, cells, or build artifacts. It provides:
...
//!
//! For project-aware filesystem functionality, see the `kuro_core::fs` module.
