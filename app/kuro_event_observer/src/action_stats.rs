...
impl ActionStats {
    ...
    pub fn update(&mut self, action: &kuro_data::ActionExecutionEnd) {
...
pub fn was_local_action(action: &kuro_data::ActionExecutionEnd) -> bool {
    action.execution_kind() == kuro_data::ActionExecutionKind::Local
        || action.execution_kind() == kuro_data::ActionExecutionKind::LocalWorker
}

pub fn scheduling_mode(action: &kuro_data::ActionExecutionEnd) -> Option<SchedulingMode> {
    action
        .scheduling_mode
...
pub fn was_fallback_action(action: &kuro_data::ActionExecutionEnd) -> bool {
    ...
    fn test_file_change_invalidation_source() {
        ...
        let action_execution_end = ActionExecutionEnd {
            ...
            invalidation_info: Some(kuro_data::CommandInvalidationInfo {
                changed_file: Some(kuro_data::command_invalidation_info::InvalidationSource {}),
                ..Default::default()
            }),
            ..Default::default()
        };
