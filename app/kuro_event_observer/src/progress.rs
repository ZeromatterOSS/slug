...
use kuro_data::ActionExecutionStart;
use kuro_data::AnalysisEnd;
use kuro_data::AnalysisStageStart;
use kuro_data::AnalysisStart;
use kuro_data::ExecutorStageStart;
use kuro_data::LoadBuildFileEnd;
use kuro_data::LocalStage;
use kuro_data::ReStage;
use kuro_data::analysis_stage_start;
use kuro_data::executor_stage_start;
use kuro_data::instant_event;
use kuro_data::local_stage;
...
impl BuildProgressStateTracker {
    ...
    pub fn handle_event(&mut self, event: &BuckEvent) -> kuro_error::Result<()> {
    ...
    fn handle_load(&mut self, ev: &UnpackedBuckEvent) -> kuro_error::Result<()> {
        match ev {
    ...
    fn handle_analysis(&mut self, ev: &UnpackedBuckEvent) -> kuro_error::Result<()> {
        match ev {
            UnpackedBuckEvent::SpanStart(
                BuckEvent {
                    span_id: Some(span_id),
    ...
    fn handle_actions(&mut self, ev: &UnpackedBuckEvent) -> kuro_error::Result<()> {
        match ev {
            UnpackedBuckEvent::SpanStart(
                BuckEvent {
                    span_id: Some(span_id),
...
mod tests {
    ...
    #[test]
    fn test_span_map() -> kuro_error::Result<()> {
