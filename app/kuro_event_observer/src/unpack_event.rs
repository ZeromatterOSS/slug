...
pub enum UnpackedBuckEvent<'a> {
    SpanStart(
        &'a BuckEvent,
        &'a SpanStartEvent,
        &'a kuro_data::span_start_event::Data,
    ),
    SpanEnd(
        &'a BuckEvent,
        &'a SpanEndEvent,
        &'a kuro_data::span_end_event::Data,
    ),
    Instant(
        &'a BuckEvent,
        &'a InstantEvent,
        &'a kuro_data::instant_event::Data,
    ),
...
pub fn unpack_event(event: &BuckEvent) -> kuro_error::Result<UnpackedBuckEvent<'_>> {
    match &event.data() {
