...
impl VerbosityItem {
    fn from(value: &str) -> kuro_error::Result<Self> {
...
impl Verbosity {
    pub fn try_from_cli(value: &str) -> kuro_error::Result<Verbosity> {
        ...
        if levels.len() > 1 {
            return Err(kuro_error::Error::from(VerbosityError::MoreThan1Level).into());
        }
