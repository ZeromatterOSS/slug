...
mod tests {
    ...
    fn setup_dice_state(dice_state: &mut DiceState, finished: u32, total: u32) {
        dice_state.update(&kuro_data::DiceStateSnapshot {
            key_states: {
    ...
    #[test]
    fn test_completion_no_progress() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_completion_percentage_build_complete() -> kuro_error::Result<()> {
        let mut dice = DiceState::new();
        let mut tracker = BuckEventSpanTracker::new();
    ...
    #[test]
    fn test_completion_percentage_intermediate_state() -> kuro_error::Result<()> {
        let mut dice = DiceState::new();
        let mut tracker = BuckEventSpanTracker::new();
    ...
    #[test]
    fn test_completion_percentage_invalid_dice_state() -> kuro_error::Result<()> {
        let mut dice = DiceState::new();
        let mut tracker = BuckEventSpanTracker::new();
    ...
    #[test]
    fn test_completion_percentage_empty_span() -> kuro_error::Result<()> {
        let mut dice = DiceState::new();
