...
use slug_interpreter_for_build::attrs::coerce;
use slug_interpreter_for_build::attrs::coerce::testing;
...
pub(crate) fn resolution_ctx_with_providers(
    ...
    impl<'v> AttrResolutionContext<'v> for Ctx<'v> {
        ...
        fn resolve_query(&mut self, _query: &str) -> slug_error::Result<Arc<AnalysisQueryResult>> {
