...
use slug_interpreter_for_build::attrs::coerce::attr_type::AttrTypeExt;
use slug_interpreter_for_build::attrs::coerce::testing::coercion_ctx;
use slug_interpreter_for_build::attrs::coerce::testing::coercion_ctx_listing;
use slug_interpreter_for_build::attrs::coerce::testing::to_value;
use slug_interpreter_for_build::interpreter::selector::register_select;
...
use slug_node::attrs::configured_attr_info_for_tests::ConfiguredAttrInfoForTests;
use slug_node::attrs::display::AttrDisplayWithContextExt;
use slug_node::attrs::fmt_context::AttrFmtContext;
use slug_node::attrs::testing::configuration_ctx;
...
#[test]
fn test_string() -> slug_error::Result<()> {
    let env = Module::new();
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_invalid_concat_coercion_into_one_of() -> slug_error::Result<()> {
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_option() -> slug_error::Result<()> {
    Heap::temp(|heap| {
...
#[test]
fn test_dict() -> slug_error::Result<()> {
    let env = Module::new();
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_one_of() -> slug_error::Result<()> {
    Heap::temp(|heap| {
...
#[test]
fn test_label() -> slug_error::Result<()> {
    Heap::temp(|heap| {
        let value = heap.alloc(vec!["//some:target", "cell1//named:target[foo]"]);
...
#[test]
fn test_coerced_deps() -> slug_error::Result<()> {
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_configured_deps() -> slug_error::Result<()> {
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_resolved_deps() -> slug_error::Result<()> {
    let globals = GlobalsBuilder::standard()
        .with(register_select)
        .with(slug_build_api::interpreter::rule_defs::register_rule_defs)
        .build();
...
#[test]
fn test_dep_requires_providers() -> slug_error::Result<()> {
    let env = Module::new();
...
#[test]
fn test_source_label() -> slug_error::Result<()> {
    Heap::temp(|heap| {
...
#[test]
fn test_source_label_deps() -> slug_error::Result<()> {
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_source_label_resolution() -> slug_error::Result<()> {
    fn resolve_and_test(
        content: &str,
        test_content: &str,
        files: &[&str],
...
#[test]
fn test_single_source_label_fails_if_multiple_returned() -> slug_error::Result<()> {
    Heap::temp(|heap| {
...
#[test]
fn test_bool() -> slug_error::Result<()> {
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_user_placeholders() -> slug_error::Result<()> {
    let env = Module::new();
