...
mod tests {
    ...
    use slug_build_api::artifact_groups::deferred::TransitiveSetKey;
    use slug_build_api::build::detailed_aggregated_metrics::testing::traverse_partial_action_graph;
    ...
    use slug_core::deferred::dynamic::DynamicLambdaIndex;
    ...
    impl Builder {
        ...
        fn artifact_for_key(&self, key: &ActionKey) -> BuildArtifact {
            BuildArtifact::new(
                ...
                key.dupe(),
                slug_execute::execute::request::OutputType::File,
            )
            .unwrap()
        }
    ...
    #[test]
    fn test_empty_graph() -> slug_error::Result<()> {
    ...
    #[test]
    fn test_single_action() -> slug_error::Result<()> {
    ...
    #[test]
    fn test_diamond() -> slug_error::Result<()> {
        let mut state = fxhash::FxHashMap::default();
    ...
    #[test]
    fn test_cycle() -> slug_error::Result<()> {
    ...
    #[test]
    fn test_dynamic_node_analysis_missing() -> slug_error::Result<()> {
        let mut state = fxhash::FxHashMap::default();
    ...
    /*
    #[test]
    fn test_tset() -> slug_error::Result<()> {
        let mut state = fxhash::FxHashMap::default();
