...
use slug_configured::nodes::calculation::ConfiguredTargetNodeKey;
...
#[tokio::test]
async fn lookup_deferred_from_analysis() -> slug_error::Result<()> {
    let target =
...
#[tokio::test]
async fn lookup_deferred_that_has_deferreds() -> slug_error::Result<()> {
    #[derive(Debug, Allocative)]
