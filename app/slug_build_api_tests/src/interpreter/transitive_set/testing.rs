...
use indoc::indoc;
use slug_build_api::artifact_groups::deferred::TransitiveSetIndex;
...
pub(crate) fn new_transitive_set(
    ...
    slug_interpreter_for_build::attrs::coerce::testing::to_value(&env, &globals, code);
...
#[test]
fn test_new_transitive_set() -> slug_error::Result<()> {
