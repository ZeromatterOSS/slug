...
use slug_build_api::interpreter::rule_defs::transitive_set::globals::register_transitive_set_types;
...
#[test]
fn test_define_transitive_set() -> slug_error::Result<()> {
...
#[test]
fn test_hash_transitive_set() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_define_transitive_set_projections() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_create_transitive_set() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_frozen_transitive_sets() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_transitive_set_display() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_transitive_sets_projection() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_transitive_sets_iteration() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_frozen_transitive_sets_iteration() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_projection_args() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_projection_inputs() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_projection_iteration() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_json_projection() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_reduction() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_definition_type() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_type_1() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_type_2() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
    let contents = indoc!(
        r#"
        FooSet = transitive_set()
...
#[test]
fn test_transitive_set_ordering_docs() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_accessors() -> slug_error::Result<()> {
    let mut tester = transitive_set_tester();
