...
#[test]
fn source_artifact() -> slug_error::Result<()> {
...
#[test]
fn bound_artifact() -> slug_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(slug_build_api::interpreter::rule_defs::register_rule_defs);
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
            r#"
...
#[test]
fn declared_artifact() -> slug_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn output_artifact() -> slug_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn declared_bound() -> slug_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(slug_build_api::interpreter::rule_defs::register_rule_defs);
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
...
#[test]
fn project_declared_artifact() -> slug_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
            r#"
...
#[test]
fn test_short_path() -> slug_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
            r#"
...
#[test]
fn stringifies_for_command_line() -> slug_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
            r#"
...
#[test]
fn bound_artifact_with_associated_artifacts() -> slug_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(slug_build_api::interpreter::rule_defs::register_rule_defs);
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
