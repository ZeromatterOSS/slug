...
use slug_build_api::interpreter::rule_defs::cmd_args::StarlarkCommandLineInputs;
...
use slug_interpreter_for_build::interpreter::testing::expect_error;
use slug_interpreter_for_build::label::testing::label_creator;
...
#[test]
fn displays_correctly() -> slug_error::Result<()> {
    let mut tester = tester()?;
    tester.run_starlark_bzl_test(indoc!(
        r#"
        def test():
...
#[test]
fn depset_add_all_and_joined_render_after_freeze() -> slug_error::Result<()> {
    let mut tester = tester()?;
    tester.run_starlark_bzl_test(indoc!(
        r#"
        def test():
...
#[test]
fn map_each_sequence_returns_expand_as_items() -> slug_error::Result<()> {
    let mut tester = tester()?;
    tester.run_starlark_bzl_test(indoc!(
        r#"
        def map_value(value):
...
#[test]
fn map_each_accepts_tree_expander_parameter() -> slug_error::Result<()> {
    let mut tester = tester()?;
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn command_line_builder() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let content = indoc!(
        r#"
        b1 = cmd_args()
...
#[test]
fn test_relative_absolute_old() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_relative_absolute() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_relative_to_propagated_up_and_down() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_relative_to_does_not_affect_new_artifacts() -> slug_error::Result<()> {
    let mut tester = tester().unwrap();
    let content = indoc!(
        r#"
        def test():
...
#[test]
fn test_parent() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_parent_n() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_parent_n_too_many_parents() -> slug_error::Result<()> {
    let mut tester = tester()?;
...
#[test]
fn test_parent_n_parent_type() -> slug_error::Result<()> {
    let mut tester = tester()?;
...
#[test]
fn test_format() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_joined_with_empty_args() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_inputs_outputs() -> slug_error::Result<()> {
    let mut tester = tester()?;
    tester.run_starlark_bzl_test(indoc!(
        r#"
        artifact1 = source_artifact("foo", "bar/baz.h")
...
#[test]
fn test_ignore_artifacts() -> slug_error::Result<()> {
    let mut tester = tester()?;
    tester.run_starlark_bzl_test(indoc!(
        r#"
        def norm(xs):
...
#[test]
fn test_frozen_inputs_outputs() -> slug_error::Result<()> {
    let mut tester = tester()?;
...
#[test]
fn test_quote_style_shell() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_prepend() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_list_list() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_concat() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_replace_regex() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_replace_regex_old() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_replace_regex_regex() -> slug_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
