...
use indoc::indoc;
use slug_build_api::interpreter::rule_defs::validation_spec;
...
#[test]
fn test_construction() -> slug_error::Result<()> {
...
#[test]
fn test_missing_fields_validation() -> slug_error::Result<()> {
    let mut tester = new_tester();
    {
        let test = indoc!(
            r#"
...
#[test]
fn test_validation_failure() -> slug_error::Result<()> {
    let mut tester = new_tester();
    {
        let test = indoc!(
            r#"
...
#[test]
fn test_attributes() -> slug_error::Result<()> {
    let mut tester = new_tester();
    {
        let test = indoc!(
            r#"
