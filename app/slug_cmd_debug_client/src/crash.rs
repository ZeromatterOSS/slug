...
use slug_cli_proto::UnstableCrashRequest;
...
impl CrashType {
    fn to_proto(&self) -> i32 {
        let crash_type = match self {
            CrashType::Panic => slug_cli_proto::unstable_crash_request::CrashType::Panic,
            CrashType::Abort => slug_cli_proto::unstable_crash_request::CrashType::Abort,
        };
        crash_type as i32
    }
}
