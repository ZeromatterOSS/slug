...
impl<'v> DeclaredArtifact<'v> {
    ...
    pub fn ensure_bound(self) -> kuro_error::Result<BoundBuildArtifact> {
        let borrow = self.artifact().borrow();
...
impl<'v> OutputArtifact<'v> {
    ...
    pub fn ensure_output_type(&self, output_type: OutputType) -> kuro_error::Result<()> {
...
impl UnboundArtifact {
    fn bind(self, key: ActionKey) -> kuro_error::Result<BuildArtifact> {
...
mod tests {
    ...
    #[test]
    fn artifact_binding() -> kuro_error::Result<()> {
        Heap::temp(|heap| {
    ...
    #[test]
    fn resolve_artifact() -> kuro_error::Result<()> {
    ...
    #[test]
    fn writes_files() -> kuro_error::Result<()> {
