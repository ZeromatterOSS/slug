...
pub fn parse_expr(input: &str) -> slug_error::Result<SpannedExpr<'_>> {
...
mod tests {
    ...
    #[test]
    fn test_expr() -> slug_error::Result<()> {
        run_tests(
            expr,
            &[
                "f",
    ...
    #[test]
    fn test_function() -> slug_error::Result<()> {
        run_tests(
            expr_function,
    ...
    #[test]
    fn test_word() -> slug_error::Result<()> {
        run_tests(
            expr_word,
            &[
                "@cell//package:target",
    ...
    #[test]
    fn test_integer() -> slug_error::Result<()> {
        run_tests(expr_int, &["0", "1234"], &["w123", ".1", ""], &["0123"]);
        Ok(())
    }

    #[test]
    fn test_trailing_infix() -> slug_error::Result<()> {
        run_tests(
            trailing_infix,
            &[
                " + b",
