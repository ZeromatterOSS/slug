...
mod tests {
    ...
    fn test_truncate_span_in_middle() {
        let error = "rdeps(set(fbcode//slug/... fbsource//xplat/slug/..., fbsource//fbobjc/slug/...), fbcode//slug/cli:slug)";
        let span = Spanned {
        ...
        assert_eq!(
            ...
            [
                "",
                "    rdeps(set(fbcode//slug/... fbsourc<<omitted>>/slug/...), fbcode//slug/cli:slug)",
                "    ^-----------------------------------------------------------------------------^",
                "",
            ]
        );
