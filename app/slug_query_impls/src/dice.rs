...
use slug_common::package_boundary::HasPackageBoundaryExceptions;
...
impl LiteralParser {
    ...
    fn parse_target_pattern_with_modifiers(
        &self,
        value: &str,
    ) -> slug_error::Result<ParsedPatternWithModifiers<TargetPatternExtra>> {
    ...
    pub(crate) fn parse_providers_pattern(
        &self,
        value: &str,
    ) -> slug_error::Result<ParsedPattern<ProvidersPatternExtra>> {
    ...
    pub(crate) fn parse_providers_pattern_with_modifiers(
        &self,
        value: &str,
    ) -> slug_error::Result<ParsedPatternWithModifiers<ProvidersPatternExtra>> {
    ...
    fn parse_file_literal(&self, literal: &str) -> slug_error::Result<CellPath> {
...
pub(crate) async fn get_dice_query_delegate<'a, 'c: 'a, 'd>(
    ...
    global_cfg_options: GlobalCfgOptions,
) -> slug_error::Result<DiceQueryDelegate<'c, 'd>> {
