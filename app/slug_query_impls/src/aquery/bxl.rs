...
use slug_build_api::query::bxl::BxlAqueryFunctions;
use slug_build_api::query::bxl::NEW_BXL_AQUERY_FUNCTIONS;
...
use slug_query::query::syntax::simple::functions::DefaultQueryFunctions;
...
impl BxlAqueryFunctionsImpl {
    ...
    ) -> slug_error::Result<Arc<DiceAqueryDelegate<'c, 'd>>> {
    ...
    ) -> slug_error::Result<AqueryEnvironment<'c>> {
        ...
        let target_sets = dice
            .try_compute_join(
                ...
                |ctx: &mut DiceComputations,
                 ...
                 -> BoxFuture<
                    slug_error::Result<Either<ConfiguredTargetLabel, TargetSet<ActionQueryNode>>>,
                > {
                    async move {
