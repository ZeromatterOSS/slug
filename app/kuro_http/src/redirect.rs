...
trait UriWithRedirect {
    fn with_redirect(&self, location: &Uri) -> kuro_error::Result<Uri>;
...
impl PendingRequest {
    ...
    pub(super) fn to_request(&self) -> kuro_error::Result<Request<Bytes>> {
...
impl<B> RedirectEngine<B> {
    ...
    fn update_and_create_request(&mut self) -> kuro_error::Result<Option<Request<Bytes>>> {
