...
use kuro_certs::certs::find_internal_cert;
use kuro_certs::certs::supports_vpnless;
use kuro_certs::certs::tls_config_with_single_cert;
use kuro_certs::certs::tls_config_with_system_roots;
...
impl HttpClientBuilder {
    ...
    pub async fn oss() -> kuro_error::Result<Self> {
    ...
    pub async fn internal() -> kuro_error::Result<Self> {
        let mut builder = Self::https_with_system_roots().await?;
        if supports_vpnless() {
    ...
    pub async fn https_with_system_roots() -> kuro_error::Result<Self> {
    ...
    pub fn with_proxy_from_env(&mut self) -> kuro_error::Result<&mut Self> {
...
mod tests {
    ...
    #[tokio::test]
    async fn test_default_builder() -> kuro_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_supports_vpnless_set_true() -> kuro_error::Result<()> {
        kuro_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_http2_option() -> kuro_error::Result<()> {
        kuro_certs::certs::maybe_setup_cryptography();
        let mut builder = HttpClientBuilder::https_with_system_roots().await?;
    ...
    #[tokio::test]
    async fn test_with_max_redirects_overrides_default() -> kuro_error::Result<()> {
        kuro_certs::certs::maybe_setup_cryptography();
        let mut builder = HttpClientBuilder::https_with_system_roots().await?;
    ...
    #[tokio::test]
    async fn test_builder_with_proxy_adds_proxy() -> kuro_error::Result<()> {
        kuro_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_set_connect_timeout() -> kuro_error::Result<()> {
        kuro_certs::certs::maybe_setup_cryptography();
        let mut builder = HttpClientBuilder::https_with_system_roots().await?;
    ...
    #[tokio::test]
    async fn test_set_connect_and_read_timeouts() -> kuro_error::Result<()> {
        kuro_certs::certs::maybe_setup_cryptography();
        let mut builder = HttpClientBuilder::https_with_system_roots().await?;
        builder
