...
use kuro_cli_proto::TargetsShowOutputsResponse;
use kuro_cli_proto::targets_show_outputs_response::TargetPaths;
...
pub async fn targets_show_outputs_command(
    ...
    req: TargetsRequest,
) -> kuro_error::Result<TargetsShowOutputsResponse> {
    run_server_command(
...
impl ServerCommandTemplate for TargetsShowOutputsServerCommand {
    ...
    type Response = kuro_cli_proto::TargetsShowOutputsResponse;
...
) -> kuro_error::Result<Vec<TargetsArtifacts>> {
...
async fn retrieve_artifacts_for_provider_label(
    ...
    global_cfg_options: &GlobalCfgOptions,
) -> kuro_error::Result<TargetsArtifacts> {
