...
//! Server-side implementation of `kuro targets` command
...
use kuro_node::nodes::lookup::ConfiguredTargetNodeLookup;
    ...
    let target_hashes = dice
        ...
        .with_linear_recompute(|linear_ctx| async move {
            match hash_options.graph_type {
                TargetHashGraphType::Configured => kuro_error::Ok(Some(
