...
impl Invocation {
    ...
    pub(crate) fn parse_json_line(json: &str) -> slug_error::Result<Invocation> {
        let i = serde_json::from_str::<slug_data::Invocation>(json)
            .with_buck_error_context(|| format!("Invalid header: {}", json.trim_end()))?;
        Ok(Invocation::from_proto(i))
    }

    pub fn to_proto(self) -> slug_data::Invocation {
        slug_data::Invocation {
    ...
    pub(crate) fn from_proto(proto: slug_data::Invocation) -> Self {
        Invocation {
...
mod tests {
    ...
    fn test_parse_json_line() {
        ...
        let line = r#"{"command_line_args":["/some/path/slug","test","@//mode/mac","app/..."],"working_dir":"/Users/nga/dir45","trace_id":"281d1c16-8930-40cd-8fc1-7d71355c20f5"}"#;
