...
) -> slug_error::Result<Option<UserEvent>> {
    match stream_value {
...
pub(crate) fn try_get_user_event(buck_event: &BuckEvent) -> slug_error::Result<Option<UserEvent>> {
        ...
        .ok_or_else(|| SerializeUserEventError::MissingData("BuckEvent".to_owned()))?
    {
        slug_data::buck_event::Data::Instant(instant) => {
            ...
            {
                slug_data::instant_event::Data::StarlarkUserEvent(event) => Ok(Some(UserEvent {
        ...
        slug_data::buck_event::Data::SpanEnd(span_end_event) => {
            ...
            {
                slug_data::span_end_event::Data::ActionExecution(action_execution) => {
                ...
                slug_data::span_end_event::Data::BxlEnsureArtifacts(_) => {
