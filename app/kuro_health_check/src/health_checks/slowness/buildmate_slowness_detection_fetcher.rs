...
pub trait SlownessConfigurationFetcher {
    ...
    ) -> kuro_error::Result<Option<BuildmateSlownessConfiguration>>;
}
...
impl BuildmateSlownessDetectionFetcher {
    pub fn new() -> Self {
        Self {
            // This should have already been initialized by the kuro client.
            fb: kuro_common::fbinit::get_or_init_fbcode_globals(),
        }
    }
}
