...
const REMEDIATION_LINK: &str = "https://fburl.com/kuro_stable_revision";
...
impl StableRevisionCheck {
        ...
        is_stable_revision_check_enabled(context)
            ...
            && context
                ...
                .is_some_and(|data| match data {
                    ...
                    | kuro_data::command_start::Data::Test(..)
                    | kuro_data::command_start::Data::Install(..) => true,
                    _ => false,
                })
    }
    ...
    fn target_bookmarks(
        &self,
        targets: &kuro_data::ParsedTargetPatterns,
...
impl HealthCheck for StableRevisionCheck {
    ...
    ) -> kuro_error::Result<Option<Report>> {
        Ok(self.run())
    }
...
mod tests {
    ...
    fn valid_health_check_context(revision: &str) -> HealthCheckContext {
        HealthCheckContext {
            ...
            command_data: Some(kuro_data::command_start::Data::Build(
                kuro_data::BuildCommandStart {
                    ..Default::default()
                },
            )),
            experiment_configurations: Some(kuro_data::SystemInfo {
    ...
    fn target_patterns(pattern: String) -> kuro_data::ParsedTargetPatterns {
        kuro_data::ParsedTargetPatterns {
            target_patterns: vec![kuro_data::TargetPattern {
                value: pattern,
                ..Default::default()
            }],
            ..Default::default()
    ...
    #[tokio::test]
    async fn test_get_invalid_bookmark() -> kuro_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_get_valid_bookmark() -> kuro_error::Result<()> {
        let checker = test_stable_revision_checker();
    ...
    #[tokio::test]
    async fn test_can_run() -> kuro_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_cannot_run() -> kuro_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_run_on_stable_revision() -> kuro_error::Result<()> {
        let context = valid_health_check_context(STABLE_REVISION);
    ...
    #[tokio::test]
    async fn test_run_on_unstable_revision() -> kuro_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_run_on_invalid_context() -> kuro_error::Result<()> {
        let context = invalid_health_check_context();
        let mut checker = test_stable_revision_checker();
        checker.try_compute_recommended_bookmarks(&context).await;
        assert_eq!(
    ...
    #[tokio::test]
    async fn test_target_computation_not_updated() -> kuro_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_report_on_unstable_revision() -> kuro_error::Result<()> {
        let context = valid_health_check_context(UNSTABLE_REVISION);
        let mut checker = test_stable_revision_checker();
        checker.try_compute_recommended_bookmarks(&context).await;
    ...
    #[tokio::test]
    async fn test_multiple_bookmarks() -> kuro_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_report_stable_info_not_available() -> kuro_error::Result<()> {
        let context = valid_health_check_context(UNSTABLE_REVISION);
