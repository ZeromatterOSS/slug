...
use slug_health_check_proto::Empty;
use slug_health_check_proto::HealthCheckContextEvent;
use slug_health_check_proto::HealthCheckResult;
use slug_health_check_proto::HealthCheckSnapshotData;
use slug_health_check_proto::health_check_server;
