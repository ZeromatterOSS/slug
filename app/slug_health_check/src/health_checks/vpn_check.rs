...
pub const REMEDIATION_LINK: &str = "https://fburl.com/slug_vpn_enabled";
...
impl VpnCheck {
    ...
    fn cisco_iface_connected() -> slug_error::Result<bool> {
    ...
    fn cisco_iface_connected() -> slug_error::Result<bool> {
        let table = slug_util::os::win::network_interface_table::NetworkInterfaceTable::new()?;
...
mod tests {
    ...
    fn health_check_context(target: Option<String>, regex: Option<String>) -> HealthCheckContext {
        HealthCheckContext {
            ...
            parsed_target_patterns: target.map(|t| slug_data::ParsedTargetPatterns {
