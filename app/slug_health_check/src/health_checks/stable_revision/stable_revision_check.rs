...
const REMEDIATION_LINK: &str = "https://fburl.com/slug_stable_revision";
...
impl StableRevisionCheck {
        ...
        is_stable_revision_check_enabled(context)
            ...
            && context
                ...
                .is_some_and(|data| match data {
                    slug_data::command_start::Data::Build(..)
                    | slug_data::command_start::Data::Test(..)
                    | slug_data::command_start::Data::Install(..) => true,
                    _ => false,
                })
    }
    ...
    fn target_bookmarks(
        &self,
        targets: &slug_data::ParsedTargetPatterns,
...
impl HealthCheck for StableRevisionCheck {
    ...
    ) -> slug_error::Result<Option<Report>> {
        Ok(self.run())
    }
...
mod tests {
    ...
    fn valid_health_check_context(revision: &str) -> HealthCheckContext {
        HealthCheckContext {
            ...
            command_data: Some(slug_data::command_start::Data::Build(
                slug_data::BuildCommandStart {
                    ..Default::default()
                },
            )),
            experiment_configurations: Some(slug_data::SystemInfo {
    ...
    fn target_patterns(pattern: String) -> slug_data::ParsedTargetPatterns {
        slug_data::ParsedTargetPatterns {
            target_patterns: vec![slug_data::TargetPattern {
                value: pattern,
                ..Default::default()
            }],
            ..Default::default()
    ...
    #[tokio::test]
    async fn test_get_invalid_bookmark() -> slug_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_get_valid_bookmark() -> slug_error::Result<()> {
        let checker = test_stable_revision_checker();
    ...
    #[tokio::test]
    async fn test_can_run() -> slug_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_cannot_run() -> slug_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_run_on_stable_revision() -> slug_error::Result<()> {
        let context = valid_health_check_context(STABLE_REVISION);
    ...
    #[tokio::test]
    async fn test_run_on_unstable_revision() -> slug_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_run_on_invalid_context() -> slug_error::Result<()> {
        let context = invalid_health_check_context();
        let mut checker = test_stable_revision_checker();
        checker.try_compute_recommended_bookmarks(&context).await;
        assert_eq!(
    ...
    #[tokio::test]
    async fn test_target_computation_not_updated() -> slug_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_report_on_unstable_revision() -> slug_error::Result<()> {
        let context = valid_health_check_context(UNSTABLE_REVISION);
        let mut checker = test_stable_revision_checker();
        checker.try_compute_recommended_bookmarks(&context).await;
    ...
    #[tokio::test]
    async fn test_multiple_bookmarks() -> slug_error::Result<()> {
        let mut context = valid_health_check_context(UNSTABLE_REVISION);
        context.parsed_target_patterns = Some(slug_data::ParsedTargetPatterns {
            target_patterns: vec![
    ...
    #[tokio::test]
    async fn test_report_stable_info_not_available() -> slug_error::Result<()> {
        let context = valid_health_check_context(UNSTABLE_REVISION);
    ...
    #[tokio::test]
    async fn test_report_stable_info_not_available_due_to_some_targets() -> slug_error::Result<()> {
