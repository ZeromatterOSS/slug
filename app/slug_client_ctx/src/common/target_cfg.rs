...
pub struct TargetCfgWithUniverseOptions {
    ...
    /// this argument, slug will use the target literals in your cquery expression as the value
...
mod tests {
    ...
    fn parse(args: &[&str]) -> slug_error::Result<TargetCfgOptions> {
    ...
    #[test]
    fn opt_multiple() -> slug_error::Result<()> {
    ...
    #[test]
    fn space_separated_fails() -> slug_error::Result<()> {
