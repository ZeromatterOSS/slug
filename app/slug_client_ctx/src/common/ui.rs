...
use slug_event_observer::event_observer::NoopEventObserverExtra;
...
pub fn get_console_with_root(
    ...
    let result: slug_error::Result<Box<dyn EventSubscriber>> = match console_type {
...
pub struct CommonConsoleOptions {
    #[clap(
        ...
        default_value = "auto",
        ignore_case = true,
        env = slug_env_name!("BUCK_CONSOLE"),
    ...
    #[clap(
        ...
        env = slug_env_name!(BUCK_NO_INTERACTIVE_CONSOLE),
...
impl CommonConsoleOptions {
    ...
    pub fn superconsole_config(&self) -> SuperConsoleConfig {
        let mut config = SuperConsoleConfig {
            expanded_progress: !slug_env!("BUCK_DISABLE_EXPANDED_PROGRESS", bool).unwrap_or(false),
