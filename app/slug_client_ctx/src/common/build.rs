...
fn parse_build_report_option(s: &str) -> slug_error::Result<BuildReportOption> {
...
pub struct CommonBuildOptions {
    ...
    #[clap(long, group = "build_strategy", env = slug_env_name!("BUCK_OFFLINE_BUILD"), value_parser = FalseyValueParser::new())]
    local_only: bool,
    ...
    #[clap(long, group = "build_strategy", env = slug_env_name!("BUCK_PREFER_REMOTE"), value_parser = FalseyValueParser::new())]
    prefer_remote: bool,
    ...
    /// dir is preferred.
    #[clap(long, env = slug_env_name!("BUCK_OFFLINE_BUILD"), value_parser = FalseyValueParser::new())]
    ...
    /// Slug already prints failure details; this flag is accepted but currently
...
impl CommonBuildOptions {
    ...
    ) -> slug_cli_proto::CommonBuildOptions {
    ...
    pub fn to_proto(&self) -> slug_cli_proto::CommonBuildOptions {
