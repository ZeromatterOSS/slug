...
use slug_event_observer::test_state::TestState;
...
pub struct TestCounterColumn {
    ...
    get_from_test_statues: fn(
        &slug_cli_proto::test_response::TestStatuses,
    ) -> &Option<slug_cli_proto::CounterWithExamples>,
}
...
impl Component for TestHeader<'_> {
    ...
    ) -> slug_error::Result<superconsole::Lines> {
