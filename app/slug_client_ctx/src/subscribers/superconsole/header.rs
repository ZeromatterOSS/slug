...
use slug_event_observer::humanized::HumanizedCount;
use slug_event_observer::pending_estimate::pending_estimate;
use slug_event_observer::progress::BuildProgressPhaseStats;
use slug_event_observer::progress::BuildProgressStats;
...
impl Component for CountComponent<'_> {
    ...
    fn draw_unchecked(&self, _dimensions: Dimensions, mode: DrawMode) -> slug_error::Result<Lines> {
        match mode {
            DrawMode::Normal => {
...
mod tests {
    ...
    use slug_event_observer::progress::BuildProgressPhaseStatsItem;
    ...
    #[test]
    fn test_different_sizes_dont_fail() -> slug_error::Result<()> {
    ...
    #[test]
    fn test_rendering_golden() -> slug_error::Result<()> {
        ...
        for width in [30, 40, 60, 80, 100, 129, 130, 140, 160] {
            ...
            .map_err(|e| from_any_with_tag(e, slug_error::ErrorTag::SuperConsole))?;
        }
    ...
    #[test]
    fn test_remaining_with_pending() -> slug_error::Result<()> {
        let action_stats = ActionStats {
            local_actions: 0,
            remote_actions: 0,
            cached_actions: 0,
    ...
    #[test]
    fn test_simple_header_final() -> slug_error::Result<()> {
        let action_stats = ActionStats {
            local_actions: 0,
            remote_actions: 0,
            cached_actions: 1,
