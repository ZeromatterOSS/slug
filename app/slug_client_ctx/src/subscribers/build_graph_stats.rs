...
impl BuildGraphStats {
    ...
    async fn handle_build_response(
        &self,
        res: &slug_cli_proto::BuildResponse,
    ) -> slug_error::Result<()> {
            ...
            .map(|ts| {
                slug_events::BuckEvent::new(
                    ...
                    slug_data::RecordEvent {
                        data: Some(
                            slug_data::BuildGraphStats {
                                build_targets: ts
                                    .iter()
                                    .map(|t| slug_data::BuildTarget {
    ...
    async fn send_events(&self, events: Vec<slug_events::BuckEvent>) {
...
mod tests {
    ...
    fn build_graph_stats_normal(fb: FacebookInit) {
        let res = slug_cli_proto::BuildResponse {
            build_targets: vec![
                slug_cli_proto::BuildTarget {
        ...
        let event_expected = slug_data::BuckEvent {
            data: Some(slug_data::buck_event::Data::Record(
                slug_data::RecordEvent {
                    data: Some(slug_data::record_event::Data::BuildGraphStats(
                        slug_data::BuildGraphStats {
                            build_targets: vec![
                                slug_data::BuildTarget {
                                    target: "//some/target:A".to_owned(),
                                    configuration: "//some/conf:A".to_owned(),
                                    configured_graph_size: Some(123),
                                },
    ...
    fn build_graph_stats_too_long_targets(fb: FacebookInit) {
        let build_target = slug_cli_proto::BuildTarget {
            target: "T".to_owned(),
        ...
        let build_target = slug_data::BuildTarget {
            target: "T".to_owned(),
            configuration: "C".to_owned(),
            configured_graph_size: Some(1),
        };
        ...
        let event_expected_3000 = slug_data::BuckEvent {
            data: Some(slug_data::buck_event::Data::Record(
                slug_data::RecordEvent {
                    data: Some(slug_data::record_event::Data::BuildGraphStats(
                        slug_data::BuildGraphStats {
        ...
        let event_expected_2 = slug_data::BuckEvent {
            data: Some(slug_data::buck_event::Data::Record(
                slug_data::RecordEvent {
                    data: Some(slug_data::record_event::Data::BuildGraphStats(
                        slug_data::BuildGraphStats {
