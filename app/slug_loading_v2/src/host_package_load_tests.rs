...
"###;
const RULES_CC_PRIVATE_PATHS_SOURCE: &str = r###"# Copyright 2025 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
def is_path_absolute(path):
    ...
    return len(path) >= 3 and \
           ...
           path[2] in ("/", "\\")
"###;
const RULES_CC_HELPER_INTERNAL_SOURCE: &str = r###"# Copyright 2024 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
const RULES_CC_CC_INFO_SOURCE: &str = r###"# Copyright 2023 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
const RULES_CC_SHARED_LIBRARY_HINT_INFO_SOURCE: &str = r###"# Copyright 2023 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
const RULES_CC_COMPILATION_OUTPUTS_SOURCE: &str = r###"# Copyright 2025 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
const RULES_CC_COMPILATION_HELPER_SOURCE: &str = r###"# Copyright 2023 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
"###;
const RULES_CC_NATIVE_CC_COMMON_SOURCE: &str = r###"# Copyright 2022 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
"###;
const RULES_CC_COMPILE_BUILD_VARIABLES_SOURCE: &str = r###"# Copyright 2025 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
"###;
const RULES_CC_COMPILE_SOURCE: &str = r###"# Copyright 2025 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
"###;
const RULES_CC_LTO_BACKENDS_SOURCE: &str = r###"# Copyright 2025 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
"###;
const RULES_CC_CREATE_LIBRARY_TO_LINK_SOURCE: &str = r###"# Copyright 2025 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
"###;
const RULES_CC_COLLECT_SOLIB_DIRS_SOURCE: &str = r###"# Copyright 2025 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
"###;
const RULES_CC_CREATE_LIBRARIES_TO_LINK_VALUES_SOURCE: &str = r###"# Copyright 2025 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
"###;
const RULES_CC_LINK_BUILD_VARIABLES_SOURCE: &str = r###"# Copyright 2020 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
def setup_lto_indexing_variables(
    ...
    return vars
"###;
const RULES_CC_FINALIZE_LINK_ACTION_SOURCE: &str = r###"# Copyright 2024 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
"###;
const RULES_CC_CPP_LINK_ACTION_SOURCE: &str = r###"# Copyright 2024 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
def _map_linkstamps_to_outputs(actions, linkstamps, output):
    ...
    return map
"###;
const RULES_CC_LTO_INDEXING_ACTION_SOURCE: &str = r###"# Copyright 2024 The Bazel Authors. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
const TOOLCHAIN_CONFIG_PROVIDERS: &str = "EnvEntryInfo VariableWithValueInfo MakeVariableInfo FeatureSetInfo WithFeatureSetInfo EnvSetInfo FlagGroupInfo FlagSetInfo FeatureInfo ToolPathInfo ToolInfo ActionConfigInfo ArtifactNamePatternInfo";
const TOOLCHAIN_CONFIG_PUBLIC_FUNCTIONS: &str = "env_entry variable_with_value make_variable feature_set with_feature_set env_set flag_group flag_set feature tool_path tool action_config artifact_name_pattern get_profile_correction_flags";
const TOOLCHAIN_CONFIG_PRIVATE_FUNCTIONS: &str = "_check_is_none _check_is_none_or_right_type _check_right_type _check_same_type _check_is_nonempty_string _check_is_nonempty_list _is_gcc_compiler";
...
"###;
const CC_PROXY_OBJC_INFO_LOAD: &str = r###"load("@rules_cc//cc/private:objc_info.bzl", _ObjcInfo = "ObjcInfo")
"###;
const CC_PROXY_OBJC_INFO_EXPORTS: &str = "ObjcInfo = _ObjcInfo\nnew_objc_provider = _ObjcInfo\n";
...
#[test]
fn exact_rules_cc_private_paths_complete_source_freezes_lazy_export() {
    assert_eq!(RULES_CC_PRIVATE_PATHS_SOURCE.lines().count(), 39);
    assert_eq!(
        format!(
            "{:x}",
            Sha256::digest(RULES_CC_PRIVATE_PATHS_SOURCE.as_bytes())
        ),
        "c982ac685f0bfbd32602d82d1c37f3bf50a2714ca6a13bfd3c08d4e5cc8b8872"
    );
    let module = eval_bzl_with_identity(
        RULES_CC_PRIVATE_PATHS_SOURCE,
        BzlModuleIdentity {
            label: CanonicalLabel::parse("@@rules_cc+//cc/private:paths.bzl").unwrap(),
            workspace_path: PathBuf::from("/rules_cc/cc/private/paths.bzl"),
            repository_mapping: Arc::from([]),
        },
    )
    .unwrap();
    assert_eq!(
        module.get("is_path_absolute").unwrap().value().get_type(),
        "function"
    );
    assert!(module.get("_is_path_absolute").is_err());
}

#[test]
fn exact_rules_cc_helper_internal_freezes_complete_recursive_producer() {
    assert_eq!(RULES_CC_HELPER_INTERNAL_SOURCE.lines().count(), 383);
    let hash = format!(
        "{:x}",
        Sha256::digest(RULES_CC_HELPER_INTERNAL_SOURCE.as_bytes())
    );
    assert_eq!(
        hash,
        "793ab429f8e397df9c486f4c3c7b5c57fae81c8432ba6d08189d65d75676dae1"
    );
    let child_owner = |label: &str, path: &str| BzlModuleIdentity {
        label: CanonicalLabel::parse(label).unwrap(),
        workspace_path: PathBuf::from(path),
        repository_mapping: Arc::from([]),
    };
    let skylib_owner = child_owner(
        "@@bazel_skylib+//lib:paths.bzl",
        "/bazel_skylib/lib/paths.bzl",
    );
    let internal_owner = child_owner(
        "@@rules_cc+//cc/private:cc_internal.bzl",
        "/rules_cc/cc/private/cc_internal.bzl",
    );
    let private_paths_owner = child_owner(
    ...
    let private_paths_load = "//cc/private:paths.bzl";
    let helper = eval_bzl_with_loaded_children(
        ...
        &[
            ("@bazel_skylib//lib:paths.bzl", skylib_owner, skylib.dupe()),
    ...
    .unwrap();
    let public = |name| helper.get(name).unwrap();
    let private = |name| helper.get_any_visibility(name).unwrap().0;
    let skylib_paths = skylib.get("paths").unwrap();
    let absolute = private_paths.get("is_path_absolute").unwrap();
    let cc_internal = internal.get("cc_internal").unwrap();
    assert!(public("paths").value().ptr_eq(skylib_paths.value()));
    assert!(public("is_path_absolute").value().ptr_eq(absolute.value()));
    assert!(private("_cc_internal").value().ptr_eq(cc_internal.value()));
    for (name, kind) in [
        ("extensions", "struct"),
        ("artifact_category_names", "struct"),
        ("output_subdirectories", "struct"),
        ("check_private_api", "function"),
        ("wrap_with_check_private_api", "function"),
        ("root_relative_path", "function"),
    ] {
        assert_eq!(public(name).value().get_type(), kind);
    }
    assert_eq!(
        public("CREATE_COMPILE_ACTION_API_ALLOWLISTED_PACKAGES")
            .value()
            .get_type(),
        "list"
    );
    let provider = private("_ArtifactCategoryInfo");
    let raw = private("_unused_new_aci");
    assert_eq!(provider.value().get_type(), "provider_callable");
    assert_eq!(raw.value().get_type(), "function");
...
fn complete_rules_cc_cc_info_children() -> Vec<(&'static str, BzlModuleIdentity, FrozenModule)> {
    let owner = |label: &str, path: &str| BzlModuleIdentity {
        label: CanonicalLabel::parse(label).unwrap(),
        workspace_path: PathBuf::from(path),
        repository_mapping: Arc::from([]),
    ...
    .map(|(label, path)| owner(label, path));
    let helper_owner = BzlModuleIdentity {
        repository_mapping: Arc::from([(
            ApparentRepoName::new("bazel_skylib").unwrap(),
            CanonicalRepoName::new("bazel_skylib+").unwrap(),
        )]),
    ...
    vec![
        ("@bazel_skylib//lib:paths.bzl", skylib_owner, skylib),
        ("//cc/common:cc_helper_internal.bzl", helper_owner, helper),
        ("//cc/private:cc_internal.bzl", internal_owner, internal),
        (
            "//cc/private/link:create_extra_link_time_library.bzl",
            extra_owner,
            extra,
        ),
    ]
...
fn assert_cc_info_interface_bindings(
    cc_info: &FrozenModule,
    children: &[(&'static str, BzlModuleIdentity, FrozenModule)],
) {
    let public = |name| cc_info.get(name).unwrap();
    let private = |name| cc_info.get_any_visibility(name).unwrap().0;
    assert!(
        public("paths")
            .value()
            .ptr_eq(children[0].2.get("paths").unwrap().value())
    );
    assert!(
        public("check_private_api")
            .value()
            .ptr_eq(children[1].2.get("check_private_api").unwrap().value())
    );
    assert!(
        private("_cc_internal")
            .value()
            .ptr_eq(children[2].2.get("cc_internal").unwrap().value())
    );
    for name in [
        "create_extra_link_time_libraries",
        "merge_extra_link_time_libraries",
        ...
        assert!(
            public(name)
                .value()
                .ptr_eq(children[3].2.get(name).unwrap().value())
        );
    }
    for (value, name) in [
        (
            public("CcCompilationContextInfo"),
            "CcCompilationContextInfo",
        ),
        (public("CcLinkingContextInfo"), "CcLinkingContextInfo"),
        (public("CcNativeLibraryInfo"), "CcNativeLibraryInfo"),
        (public("CcDebugContextInfo"), "CcDebugContextInfo"),
        (private("_ModuleMapInfo"), "_ModuleMapInfo"),
    ] {
        let provider = FrozenUserProviderCallable::from_value(value.value()).unwrap();
        assert_eq!(
    ...
    let providers = [
        public("CcCompilationContextInfo"),
        public("CcLinkingContextInfo"),
        public("CcNativeLibraryInfo"),
        public("CcDebugContextInfo"),
        private("_ModuleMapInfo"),
        public("CcInfo"),
    ];
    for (index, left) in providers.iter().enumerate() {
        assert_eq!(left.value().get_type(), "provider_callable");
        for right in &providers[index + 1..] {
            assert!(!left.value().ptr_eq(right.value()));
        }
    }
    assert!(cc_info.get("_ModuleMapInfo").is_err());
    let cc = public("CcInfo");
    assert_eq!(
        cc.value().to_string(),
        "provider[@@rules_cc+//cc/private:cc_info.bzl%CcInfo]"
    );
    assert_eq!(private("_").value().get_type(), "function");
    assert!(cc_info.get("_").is_err());
    for name in "create_module_map create_separate_module_map create_linking_context merge_linking_contexts create_debug_context merge_debug_context create_compilation_context create_compilation_context_with_extra_header_tokens create_cc_compilation_context_with_cpp20_modules merge_cc_infos".split_whitespace() {
        assert_eq!(public(name).value().get_type(), "function");
    }
    for name in "_create_cc_info _normalize_paths _flat_depset _merge_compilation_contexts"
        .split_whitespace()
    {
        assert_eq!(private(name).value().get_type(), "function");
        assert!(cc_info.get(name).is_err());
    }
}

#[rustfmt::skip]
fn assert_cc_info_empty_context_shapes(cc_info: &FrozenModule) {
    let public = |name| cc_info.get(name).unwrap();
    let private = |name| cc_info.get_any_visibility(name).unwrap().0;
    let compilation = public("EMPTY_COMPILATION_CONTEXT");
    let linking = private("_EMPTY_LINKING_CONTEXT");
    let debug = private("_EMPTY_DEBUG_CONTEXT");
    for (context, name) in [(&compilation, "CcCompilationContextInfo"), (&linking, "CcLinkingContextInfo"), (&debug, "CcDebugContextInfo")] {
        let id = loading_provider_id(context.value()).unwrap();
        assert_eq!((id.source_label(), id.exported_name()), ("@@rules_cc+//cc/private:cc_info.bzl", name));
    }
    let scratch = Module::new();
    macro_rules! field {
        ($value:expr, $name:expr) => {
            $value.value().to_value().get_attr($name, scratch.heap()).unwrap().unwrap()
        };
    }
    for (context, lists, depsets, none) in [
        (&compilation, "direct_headers direct_public_headers direct_private_headers direct_textual_headers", "defines local_defines headers includes quote_includes system_includes framework_includes external_includes validation_artifacts _virtual_to_original_headers _exporting_module_maps _exporting_module_map_files _non_code_inputs _transitive_modules _transitive_pic_modules _direct_module_maps _modules_info_files _pic_modules_info_files _module_files _pic_module_files", "_module_map"),
        (&linking, "", "linker_inputs", "_extra_link_time_libraries"), (&debug, "", "files pic_files", ""),
    ] {
        for name in lists.split_whitespace() { assert_eq!(FrozenListRef::from_value(field!(context, name)).unwrap().len(), 0); }
        for name in depsets.split_whitespace() { assert_eq!(StarlarkDepset::direct_from_value(field!(context, name)).unwrap().len(), 0); }
        for name in none.split_whitespace() { assert_eq!(field!(context, name).get_type(), "NoneType"); }
    }
    let header = field!(&compilation, "_header_info");
    assert_eq!(header.get_type(), "HeaderInfo");
    for name in "modular_public_headers modular_private_headers textual_headers separate_module_headers".split_whitespace() {
        assert_eq!(FrozenListRef::from_value(header.get_attr(name, scratch.heap()).unwrap().unwrap()).unwrap().len(), 0);
    }
    for name in "header_module pic_header_module separate_module separate_pic_module".split_whitespace() {
        assert_eq!(header.get_attr(name, scratch.heap()).unwrap().unwrap().get_type(), "NoneType");
    }
    assert!(cc_info.get("_EMPTY_LINKING_CONTEXT").is_err());
    assert!(cc_info.get("_EMPTY_DEBUG_CONTEXT").is_err());
}
#[test]
fn exact_rules_cc_info_freezes_complete_recursive_producer() {
    assert_eq!(RULES_CC_CC_INFO_SOURCE.lines().count(), 656);
    assert_eq!(
        format!("{:x}", Sha256::digest(RULES_CC_CC_INFO_SOURCE.as_bytes())),
        "4424bb876c3f8234d7cfce20652e7ab1a7b2fc34cc2c637b1cb4313590d9f1bc"
    );
    let children = complete_rules_cc_cc_info_children();
    let cc_info = eval_bzl_with_loaded_children(
...
#[test]
fn exact_rules_cc_shared_library_hint_info_freezes_complete_producer() {
    assert_eq!(RULES_CC_SHARED_LIBRARY_HINT_INFO_SOURCE.lines().count(), 56);
    assert_eq!(
        format!(
            "{:x}",
            Sha256::digest(RULES_CC_SHARED_LIBRARY_HINT_INFO_SOURCE.as_bytes())
        ),
        "7d067aad7862af26ee701dfa32c611d608fd606aaba06ca7dc232b6d7291d415"
    );
    let module = eval_bzl_with_identity(
        RULES_CC_SHARED_LIBRARY_HINT_INFO_SOURCE,
        BzlModuleIdentity {
            label: CanonicalLabel::parse("@@rules_cc+//cc/private:cc_shared_library_hint_info.bzl")
                .unwrap(),
            workspace_path: PathBuf::from("/rules_cc/cc/private/cc_shared_library_hint_info.bzl"),
            repository_mapping: Arc::from([]),
        },
    )
    .unwrap();
    let provider = module.get("CcSharedLibraryHintInfo").unwrap();
    assert_eq!(provider.value().get_type(), "provider_callable");
...
fn complete_rules_cc_compilation_outputs_children()
-> Vec<(&'static str, BzlModuleIdentity, FrozenModule)> {
    let previous = complete_rules_cc_cc_info_children();
    let helper = &previous[1];
    let internal = &previous[2];
    let lto = eval_bzl_with_loaded_children(
        RULES_CC_LTO_COMPILATION_CONTEXT_SOURCE,
        BzlModuleIdentity {
            label: CanonicalLabel::parse(
    ...
    vec![
        ...
        (
            "//cc/private/compile:lto_compilation_context.bzl",
            BzlModuleIdentity {
                label: CanonicalLabel::parse(
                    "@@rules_cc+//cc/private/compile:lto_compilation_context.bzl",
                )
...
fn assert_compilation_outputs_interfaces(
    outputs: &FrozenModule,
    children: &[(&'static str, BzlModuleIdentity, FrozenModule)],
) {
    let public = |name| outputs.get(name).unwrap();
    let private = |name| outputs.get_any_visibility(name).unwrap().0;
    assert!(
        public("wrap_with_check_private_api").value().ptr_eq(
            children[0]
                .2
                .get("wrap_with_check_private_api")
                .unwrap()
    ...
    assert!(
        private("_PRIVATE_STARLARKIFICATION_ALLOWLIST")
            .value()
            .ptr_eq(
                children[0]
                    .2
    ...
    assert!(
        private("_cc_internal")
            .value()
            .ptr_eq(children[1].2.get("cc_internal").unwrap().value())
    );
    for name in [
        "EMPTY_LTO_COMPILATION_CONTEXT",
        "merge_lto_compilation_contexts",
    ] {
        assert!(
            public(name)
                .value()
                .ptr_eq(children[2].2.get(name).unwrap().value())
        );
    }
    for (value, name) in [
        (
            private("_UnboundValueProviderDoNotUse"),
            "_UnboundValueProviderDoNotUse",
        ),
        (
            public("CcCompilationOutputsInfo"),
            "CcCompilationOutputsInfo",
        ),
    ] {
        assert_eq!(value.value().get_type(), "provider_callable");
        let provider = FrozenUserProviderCallable::from_value(value.value()).unwrap();
        assert_eq!(
            provider.id().source_label(),
    ...
    assert!(
        !private("_UnboundValueProviderDoNotUse")
            .value()
            .ptr_eq(public("CcCompilationOutputsInfo").value())
    );
    for name in [
    ...
    assert_eq!(id.exported_name(), "_UnboundValueProviderDoNotUse");
    for (name, is_private) in [
        ("create_compilation_outputs_internal", false),
        ("_validate_extensions", true),
        ("_to_list", true),
        ("create_compilation_outputs", false),
        ("merge_compilation_outputs", false),
    ] {
...
fn assert_empty_compilation_outputs_shape(outputs: &FrozenModule, lto: &FrozenModule) {
    ...
    assert_eq!(id.exported_name(), "CcCompilationOutputsInfo");
    let scratch = Module::new();
    macro_rules! field {
        ($name:expr) => {
            empty
                .value()
                .to_value()
                .get_attr($name, scratch.heap())
                .unwrap()
                .unwrap()
        };
    }
    for name in "objects pic_objects _header_tokens _module_files _gcno_files _pic_gcno_files _dwo_files _pic_dwo_files cpp_module_files pic_cpp_module_files".split_whitespace() {
        assert_eq!(FrozenListRef::from_value(field!(name)).unwrap().len(), 0);
    }
    for name in ["cpp_modules_info_file", "pic_cpp_modules_info_file"] {
        assert_eq!(field!(name).get_type(), "NoneType");
    }
    assert_eq!(field!("temps").get_type(), "function");
    assert!(
        field!("_lto_compilation_context").ptr_eq(
            lto.get("EMPTY_LTO_COMPILATION_CONTEXT")
                .unwrap()
                .value()
                .to_value()
        )
...
#[test]
fn exact_rules_cc_compilation_outputs_freezes_complete_producer() {
    assert_eq!(RULES_CC_COMPILATION_OUTPUTS_SOURCE.lines().count(), 226);
    assert_eq!(
        format!(
            "{:x}",
            Sha256::digest(RULES_CC_COMPILATION_OUTPUTS_SOURCE.as_bytes())
        ),
        "294e3da16da4444122e7dee058ec1e06b30cec93d64a32f217cf9e1e3e4bfb44"
    );
    let children = complete_rules_cc_compilation_outputs_children();
    let outputs = eval_bzl_with_loaded_children(
        RULES_CC_COMPILATION_OUTPUTS_SOURCE,
        BzlModuleIdentity {
            label: CanonicalLabel::parse(
                "@@rules_cc+//cc/private/compile:cc_compilation_outputs.bzl",
            )
...
fn complete_rules_cc_compilation_helper_children()
-> Vec<(&'static str, BzlModuleIdentity, FrozenModule)> {
    let cc_info_children = complete_rules_cc_cc_info_children();
    let cc_info_owner = BzlModuleIdentity {
        label: CanonicalLabel::parse("@@rules_cc+//cc/private:cc_info.bzl").unwrap(),
        workspace_path: PathBuf::from("/rules_cc/cc/private/cc_info.bzl"),
        repository_mapping: Arc::from([(
            ApparentRepoName::new("bazel_skylib").unwrap(),
    ...
    .unwrap();
    let semantics_owner = BzlModuleIdentity {
    ...
    let semantics =
        eval_bzl_with_identity(RULES_CC_SEMANTICS_SOURCE, semantics_owner.clone()).unwrap();
    vec![
        (
            "@bazel_skylib//lib:paths.bzl",
            cc_info_children[0].1.clone(),
            cc_info_children[0].2.dupe(),
        ),
        (
            "//cc/common:cc_helper_internal.bzl",
            cc_info_children[1].1.clone(),
            cc_info_children[1].2.dupe(),
        ),
        ("//cc/common:semantics.bzl", semantics_owner, semantics),
        ("//cc/private:cc_info.bzl", cc_info_owner, cc_info),
        (
            "//cc/private:cc_internal.bzl",
            cc_info_children[2].1.clone(),
            cc_info_children[2].2.dupe(),
        ),
    ]
}

fn assert_compilation_helper_interfaces(
    helper: &FrozenModule,
    children: &[(&'static str, BzlModuleIdentity, FrozenModule)],
) {
    let public = |name| helper.get(name).unwrap();
    ...
    for (name, child, export) in [
        ("paths", 0, "paths"),
        ("get_relative_path", 1, "get_relative_path"),
        ("package_source_root", 1, "package_source_root"),
        ("repository_exec_path", 1, "repository_exec_path"),
        (
            "STRIP_INCLUDE_PREFIX_APPLIES_TO_TEXTUAL_HEADERS",
            2,
            "STRIP_INCLUDE_PREFIX_APPLIES_TO_TEXTUAL_HEADERS",
        ),
        (
        ...
        ("create_module_map", 3, "create_module_map"),
    ] {
        assert!(
            public(name)
                .value()
    ...
    assert!(
        private("_cc_internal")
            .value()
            .ptr_eq(children[4].2.get("cc_internal").unwrap().value())
    );
    assert_eq!(
        private("_VIRTUAL_INCLUDES_DIR").unpack_str(),
        Some("_virtual_includes")
    );
    let module_map_info = private("_ModuleMapInfo");
    let provider = FrozenUserProviderCallable::from_value(module_map_info.value()).unwrap();
    assert_eq!(
    ...
    assert!(helper.get("_ModuleMapInfo").is_err());
    let private_names = "_include_dir _repo_relative_path _enabled _compute_public_headers _generates_header_module _header_module_artifact _collect_module_maps _module_map_struct_to_module_map_content _create_module_map_action _init_cc_compilation_context";
    assert_eq!(private_names.split_whitespace().count(), 10);
    for name in private_names.split_whitespace() {
        assert_eq!(private(name).value().get_type(), "function", "{name}");
        assert!(helper.get(name).is_err(), "{name}");
    }
    for name in ["dotd_files_enabled", "serialized_diagnostics_file_enabled"] {
        assert_eq!(public(name).value().get_type(), "function", "{name}");
    }
    let mut names = helper.names().map(|name| name.as_str()).collect::<Vec<_>>();
    names.sort_unstable();
    let mut expected = "STRIP_INCLUDE_PREFIX_APPLIES_TO_TEXTUAL_HEADERS USE_EXEC_ROOT_FOR_VIRTUAL_INCLUDES_SYMLINKS cc_compilation_helper create_compilation_context create_module_map dotd_files_enabled get_relative_path package_source_root paths repository_exec_path serialized_diagnostics_file_enabled".split_whitespace().collect::<Vec<_>>();
    expected.sort_unstable();
    assert_eq!(names, expected);
    let mut names_any = helper
        .names_any_visibility()
        .map(|name| name.as_str())
        .collect::<Vec<_>>();
    names_any.sort_unstable();
    expected.extend(private_names.split_whitespace());
    expected.extend(["_ModuleMapInfo", "_VIRTUAL_INCLUDES_DIR", "_cc_internal"]);
    expected.sort_unstable();
    assert_eq!(names_any, expected);
    let helper_binding = public("cc_compilation_helper");
    let structure = StructRef::from_value(helper_binding.value()).unwrap();
    assert_eq!(structure.iter().count(), 1);
    let init = structure.iter().next().unwrap();
    assert_eq!(init.0.as_str(), "init_cc_compilation_context");
    assert!(
        init.1
            .ptr_eq(private("_init_cc_compilation_context").value())
    );
}

#[test]
fn exact_rules_cc_compilation_helper_freezes_complete_recursive_producer() {
    assert_eq!(RULES_CC_COMPILATION_HELPER_SOURCE.lines().count(), 666);
    assert_eq!(
        format!(
            "{:x}",
            Sha256::digest(RULES_CC_COMPILATION_HELPER_SOURCE.as_bytes())
        ),
        "2c484cade81f0d70efd203612b5492e5578871b2b3e9be7987de42de9c57863f"
    );
    let children = complete_rules_cc_compilation_helper_children();
    let child_labels = [
        "@@bazel_skylib+//lib:paths.bzl",
        "@@rules_cc+//cc/common:cc_helper_internal.bzl",
    ...
    for (child, label) in children.iter().zip(child_labels) {
        assert_eq!(child.1.label, CanonicalLabel::parse(label).unwrap());
    }
    let mapping = |apparent: &str, canonical: &str| {
        Arc::from([(
    ...
    assert_eq!(
        ...
        mapping("bazel_skylib", "bazel_skylib+")
    );
    assert_eq!(
    ...
    .unwrap();
    assert_compilation_helper_interfaces(&helper, &children);
}

fn complete_rules_cc_compile_build_variables_children()
-> Vec<(&'static str, BzlModuleIdentity, FrozenModule)> {
    let previous = complete_rules_cc_cc_info_children();
    let native_owner = BzlModuleIdentity {
        label: CanonicalLabel::parse("@@rules_cc+//cc/private/rules_impl:native_cc_common.bzl")
            .unwrap(),
        workspace_path: PathBuf::from("/rules_cc/cc/private/rules_impl/native_cc_common.bzl"),
        repository_mapping: Arc::from([]),
    };
    let native_globals = loading_globals();
    let predeclared_cc_common = native_globals
        .iter()
        .find_map(|(name, value)| (name == "cc_common").then_some(value))
        .unwrap();
    let native = eval_bzl_with_identity_and_globals(
        RULES_CC_NATIVE_CC_COMMON_SOURCE,
        native_owner.clone(),
        &native_globals,
    )
    .unwrap();
    assert!(
        native
            .get("native_cc_common")
            .unwrap()
            .value()
            .ptr_eq(predeclared_cc_common.to_value())
    );
    vec![
        (
            "//cc/common:cc_helper_internal.bzl",
...
fn assert_compile_build_variables_interfaces(
    variables: &FrozenModule,
    children: &[(&'static str, BzlModuleIdentity, FrozenModule)],
) {
    let public = |name| variables.get(name).unwrap();
    let private = |name| variables.get_any_visibility(name).unwrap().0;
    for (name, child, export) in [
        ...
        ("_cc_common_internal", 2, "native_cc_common"),
    ] {
    ...
    let vars = private("_VARS");
    let vars = StructRef::from_value(vars.value()).unwrap();
    let expected = "FRAMEWORK_PATHS|framework_include_paths SOURCE_FILE|source_file USER_COMPILE_FLAGS|user_compile_flags OUTPUT_FILE|output_file DEPENDENCY_FILE|dependency_file SERIALIZED_DIAGNOSTICS_FILE|serialized_diagnostics_file MODULE_NAME|module_name INCLUDE_PATHS|include_paths QUOTE_INCLUDE_PATHS|quote_include_paths SYSTEM_INCLUDE_PATHS|system_include_paths EXTERNAL_INCLUDE_PATHS|external_include_paths MODULE_MAP_FILE|module_map_file DEPENDENT_MODULE_MAP_FILES|dependent_module_map_files MODULE_FILES|module_files PREPROCESSOR_DEFINES|preprocessor_defines GCOV_GCNO_FILE|gcov_gcno_file LTO_INDEXING_BITCODE_FILE|lto_indexing_bitcode_file THINLTO_INDEX|thinlto_index THINLTO_INPUT_BITCODE_FILE|thinlto_input_bitcode_file THINLTO_OUTPUT_OBJECT_FILE|thinlto_output_object_file IS_USING_FISSION|is_using_fission PER_OBJECT_DEBUG_INFO_FILE|per_object_debug_info_file PIC|pic IS_USING_MEMPROF|is_using_memprof INCLUDES|includes";
    assert_eq!(expected.split_whitespace().count(), 25);
    assert_eq!(vars.iter().count(), 25);
    for row in expected.split_whitespace() {
    ...
    let provider_binding = private("_UnboundValueProviderDoNotUse");
    assert_eq!(provider_binding.value().get_type(), "provider_callable");
    ...
    let set = private("_SOURCE_TYPES_FOR_CXXOPTS");
    assert_eq!(set.value().get_type(), "set");
    let scratch = Module::new();
    let actual = set
        .value()
        .to_value()
        .iterate(scratch.heap())
        .unwrap()
        .map(|value| value.unpack_str().unwrap())
        .collect::<Vec<_>>();
    assert_eq!(actual, ".cc .cpp .cxx .c++ .C .cu .cl .h .hh .hpp .ipp .hxx .h++ .inc .inl .tlh .tli .H .tcc .ipb .cppmap .mm".split_whitespace().collect::<Vec<_>>());
    let private_functions = "_setup_common_compile_build_variables_internal _get_fdo_build_stamp _copts_from_options _setup_fdo_build_variables _get_auxiliary_fdo_inputs_list _should_pass_propeller_profiles _compute_all_linkstamp_defines";
    let public_functions = "create_compile_variables setup_common_compile_build_variables get_specific_compile_build_variables get_copts get_fdo_variables_and_inputs get_linkstamp_compile_variables";
    for name in private_functions.split_whitespace() {
        assert_eq!(private(name).value().get_type(), "function", "{name}");
        assert!(variables.get(name).is_err(), "{name}");
    }
    for name in public_functions.split_whitespace() {
        assert_eq!(public(name).value().get_type(), "function", "{name}");
    }
    let mut names = variables
        ...
        .collect::<Vec<_>>();
    names.sort_unstable();
    let mut expected = "extensions create_compile_variables setup_common_compile_build_variables get_specific_compile_build_variables get_copts get_fdo_variables_and_inputs get_linkstamp_compile_variables".split_whitespace().collect::<Vec<_>>();
    expected.sort_unstable();
    assert_eq!(names, expected);
    ...
    expected.extend("_PRIVATE_STARLARKIFICATION_ALLOWLIST _cc_internal _cc_common_internal _VARS _UnboundValueProviderDoNotUse _UNBOUND _SOURCE_TYPES_FOR_CXXOPTS".split_whitespace());
    expected.sort_unstable();
    assert_eq!(all, expected);
}

#[test]
fn exact_rules_cc_compile_build_variables_freezes_complete_recursive_producer() {
    for (source, lines, hash) in [
        (
            RULES_CC_NATIVE_CC_COMMON_SOURCE,
            18,
        ...
        assert_eq!(source.lines().count(), lines);
        assert_eq!(format!("{:x}", Sha256::digest(source.as_bytes())), hash);
    }
    let children = complete_rules_cc_compile_build_variables_children();
    ...
    assert!(children[1].1.repository_mapping.is_empty());
    assert!(children[2].1.repository_mapping.is_empty());
    let native_cc_common = children[2].2.get("native_cc_common").unwrap();
    assert_eq!(native_cc_common.value().get_type(), "cc_common");
...
#[test]
fn exact_rules_cc_compile_source_is_authenticated() {
    assert_eq!(RULES_CC_COMPILE_SOURCE.lines().count(), 2295);
    assert_eq!(
...
fn assert_lto_backend_child_identities(
    children: &[(&'static str, BzlModuleIdentity, FrozenModule); 4],
) {
    for (child, label) in children.iter().zip([
        "@@bazel_skylib+//lib:paths.bzl",
        "@@rules_cc+//cc/common:cc_helper_internal.bzl",
...
#[test]
fn exact_rules_cc_lto_backends_freezes_complete_producer() {
    assert_eq!(RULES_CC_LTO_BACKENDS_SOURCE.lines().count(), 540);
    assert_eq!(
        format!(
            "{:x}",
            Sha256::digest(RULES_CC_LTO_BACKENDS_SOURCE.as_bytes())
        ),
        "078bfb686e85b584745fcea2d9e5535938f9afc1a0066f80cc88aceb699f4226"
    );
    let cc = complete_rules_cc_cc_info_children();
    let native = complete_rules_cc_compile_build_variables_children();
    let children = [
        (
            "@bazel_skylib//lib:paths.bzl",
            cc[0].1.clone(),
    ...
    assert_lto_backend_child_identities(&children);
    let module = eval_bzl_with_loaded_children(
        RULES_CC_LTO_BACKENDS_SOURCE,
        BzlModuleIdentity {
            label: CanonicalLabel::parse("@@rules_cc+//cc/private/link:lto_backends.bzl").unwrap(),
            workspace_path: PathBuf::from("/rules_cc/cc/private/link/lto_backends.bzl"),
            repository_mapping: Arc::from([(
                ApparentRepoName::new("bazel_skylib").unwrap(),
                CanonicalRepoName::new("bazel_skylib+").unwrap(),
            )]),
    ...
    .unwrap();
    let public = |n| module.get(n).unwrap();
    let private = |n| module.get_any_visibility(n).unwrap().0;
    for (n, i, e) in [
        ("paths", 0, "paths"),
        (
            "should_create_per_object_debug_info",
        ...
        ("_cc_internal", 2, "cc_internal"),
        ("_cc_common_internal", 3, "native_cc_common"),
    ] {
        let v = if n.starts_with('_') {
            private(n)
        } else {
            public(n)
        };
        assert!(v.value().ptr_eq(children[i].2.get(e).unwrap().value()));
    }
    let info = public("LtoBackendArtifactsInfo");
    let provider = FrozenUserProviderCallable::from_value(info.value()).unwrap();
    assert_eq!(
        (provider.id().source_label(), provider.id().exported_name()),
        (
    ...
    for n in "create_lto_backends create_shared_non_lto_artifacts setup_common_lto_variables create_lto_backend_artifacts".split_whitespace(){assert_eq!(public(n).value().get_type(),"function");}
    for n in "_backend_user_compile_flags _add_profile_for_lto_backend _create_lto_backend_action _paths_build_variables _get_lto_backend_action_inputs _get_lto_backend_action_outputs".split_whitespace(){assert_eq!(private(n).value().get_type(),"function");assert!(module.get(n).is_err());}
    let mut names = module.names().map(|n| n.as_str()).collect::<Vec<_>>();
    names.sort_unstable();
    let mut expected="paths should_create_per_object_debug_info LtoBackendArtifactsInfo create_lto_backends create_shared_non_lto_artifacts setup_common_lto_variables create_lto_backend_artifacts".split_whitespace().collect::<Vec<_>>();
    expected.sort_unstable();
    assert_eq!(names, expected);
    let mut all = module
        .names_any_visibility()
        ...
        .collect::<Vec<_>>();
    all.sort_unstable();
    expected.extend("_cc_internal _cc_common_internal _backend_user_compile_flags _add_profile_for_lto_backend _create_lto_backend_action _paths_build_variables _get_lto_backend_action_inputs _get_lto_backend_action_outputs".split_whitespace());
    expected.sort_unstable();
    assert_eq!(all, expected);
}

fn complete_rules_cc_create_library_to_link_children()
-> Vec<(&'static str, BzlModuleIdentity, FrozenModule)> {
    let cc = complete_rules_cc_cc_info_children();
    let native = complete_rules_cc_compile_build_variables_children();
    let lto_context_owner = BzlModuleIdentity {
        label: CanonicalLabel::parse("@@rules_cc+//cc/private/compile:lto_compilation_context.bzl")
            .unwrap(),
        workspace_path: PathBuf::from("/rules_cc/cc/private/compile/lto_compilation_context.bzl"),
        repository_mapping: Arc::from([]),
    };
    let lto_context = eval_bzl_with_loaded_children(
        RULES_CC_LTO_COMPILATION_CONTEXT_SOURCE,
        lto_context_owner.clone(),
        &[
            (cc[1].0, cc[1].1.clone(), cc[1].2.dupe()),
            (cc[2].0, cc[2].1.clone(), cc[2].2.dupe()),
        ],
    )
    .unwrap();
    let lto_backends_owner = BzlModuleIdentity {
        label: CanonicalLabel::parse("@@rules_cc+//cc/private/link:lto_backends.bzl").unwrap(),
        workspace_path: PathBuf::from("/rules_cc/cc/private/link/lto_backends.bzl"),
        repository_mapping: Arc::from([(
            ApparentRepoName::new("bazel_skylib").unwrap(),
    ...
    let lto_backends = eval_bzl_with_loaded_children(
        RULES_CC_LTO_BACKENDS_SOURCE,
        lto_backends_owner.clone(),
        &[
            (cc[0].0, cc[0].1.clone(), cc[0].2.dupe()),
            (cc[1].0, cc[1].1.clone(), cc[1].2.dupe()),
            (cc[2].0, cc[2].1.clone(), cc[2].2.dupe()),
            (native[2].0, native[2].1.clone(), native[2].2.dupe()),
        ],
    )
    .unwrap();
    vec![
        ...
        (
            "//cc/private/link:lto_backends.bzl",
            lto_backends_owner,
            lto_backends,
        ),
    ]
...
#[test]
fn exact_rules_cc_create_library_to_link_freezes_complete_producer() {
    assert_eq!(RULES_CC_CREATE_LIBRARY_TO_LINK_SOURCE.lines().count(), 291);
    assert_eq!(
        format!(
            "{:x}",
            Sha256::digest(RULES_CC_CREATE_LIBRARY_TO_LINK_SOURCE.as_bytes())
        ),
        "5f57423312f24392f106aeb5959485c4f30c54ee2d8e926a45934de51a2455d1"
    );
    let children = complete_rules_cc_create_library_to_link_children();
    for (child, label) in children.iter().zip([
        "@@bazel_skylib+//lib:paths.bzl",
        "@@rules_cc+//cc/common:cc_helper_internal.bzl",
        "@@rules_cc+//cc/private:cc_internal.bzl",
    ...
    assert!(children[0].1.repository_mapping.is_empty());
    assert_eq!(children[1].1.repository_mapping, skylib_mapping);
    assert!(children[2].1.repository_mapping.is_empty());
    assert!(children[3].1.repository_mapping.is_empty());
    assert_eq!(children[4].1.repository_mapping, skylib_mapping);
    let module = eval_bzl_with_loaded_children(
        RULES_CC_CREATE_LIBRARY_TO_LINK_SOURCE,
        BzlModuleIdentity {
            label: CanonicalLabel::parse("@@rules_cc+//cc/private/link:create_library_to_link.bzl")
                .unwrap(),
            workspace_path: PathBuf::from("/rules_cc/cc/private/link/create_library_to_link.bzl"),
            repository_mapping: Arc::from([(
                ApparentRepoName::new("bazel_skylib").unwrap(),
                CanonicalRepoName::new("bazel_skylib+").unwrap(),
            )]),
    ...
    for (name, child, export) in [
        ...
        ("_cc_internal", 2, "cc_internal"),
        ("_EMPTY_LTO", 3, "EMPTY_LTO_COMPILATION_CONTEXT"),
        (
            "create_shared_non_lto_artifacts",
            4,
            "create_shared_non_lto_artifacts",
        ),
    ] {
    ...
    assert_eq!(
        private("_warning").value().unpack_str(),
        Some(
            " Don't use this field. It's intended for internal use and will be changed or removed\n    without warning."
        )
    );
    let provider_binding = public("LibraryToLinkInfo");
    let provider = FrozenUserProviderCallable::from_value(provider_binding.value()).unwrap();
    assert_eq!(
        (provider.id().source_label(), provider.id().exported_name()),
        (
    ...
    for name in "make_library_to_link create_library_to_link".split_whitespace() {
        assert_eq!(public(name).value().get_type(), "function");
    }
    for name in "_validate_symlink_path _validate_extension".split_whitespace() {
        assert_eq!(private(name).value().get_type(), "function");
        assert!(module.get(name).is_err());
    }
    let mut names = module.names().map(|name| name.as_str()).collect::<Vec<_>>();
    names.sort_unstable();
    let mut expected = "paths is_versioned_shared_library path_contains_up_level_references create_shared_non_lto_artifacts LibraryToLinkInfo make_library_to_link create_library_to_link".split_whitespace().collect::<Vec<_>>();
    expected.sort_unstable();
    assert_eq!(names, expected);
    let mut all = module
        .names_any_visibility()
    ...
    all.sort_unstable();
    expected.extend(
        "_cc_internal _EMPTY_LTO _warning _validate_symlink_path _validate_extension"
            .split_whitespace(),
    );
    expected.sort_unstable();
    assert_eq!(all, expected);
...
fn complete_rules_cc_collect_solib_dirs_children()
-> [(&'static str, BzlModuleIdentity, FrozenModule); 3] {
    ...
    let action =
        eval_bzl_with_identity(RULES_CC_ACTION_NAMES_SOURCE, action_owner.clone()).unwrap();
    let target_owner = BzlModuleIdentity {
        label: CanonicalLabel::parse("@@rules_cc+//cc/private/link:target_types.bzl").unwrap(),
        workspace_path: PathBuf::from("/rules_cc/cc/private/link/target_types.bzl"),
        repository_mapping: Arc::from([]),
    };
    let target = eval_bzl_with_loaded_children(
        RULES_CC_TARGET_TYPES_SOURCE,
        target_owner.clone(),
        &[
            ("//cc:action_names.bzl", action_owner, action),
    ...
    [
        (cc[0].0, cc[0].1.clone(), cc[0].2.dupe()),
        (cc[1].0, cc[1].1.clone(), cc[1].2.dupe()),
        ("//cc/private/link:target_types.bzl", target_owner, target),
    ]
}

#[test]
fn exact_rules_cc_collect_solib_dirs_freezes_complete_producer() {
    assert_eq!(RULES_CC_COLLECT_SOLIB_DIRS_SOURCE.lines().count(), 479);
    assert_eq!(
        format!(
            "{:x}",
            Sha256::digest(RULES_CC_COLLECT_SOLIB_DIRS_SOURCE.as_bytes())
        ),
        "f25b0f978bce3a3cf810b36c6897a85adefce7036ec68ba53613352afa218125"
    );
    let children = complete_rules_cc_collect_solib_dirs_children();
    for (child, label) in children.iter().zip([
        "@@bazel_skylib+//lib:paths.bzl",
        "@@rules_cc+//cc/common:cc_helper_internal.bzl",
    ...
    assert!(children[2].1.repository_mapping.is_empty());
    let module = eval_bzl_with_loaded_children(
        RULES_CC_COLLECT_SOLIB_DIRS_SOURCE,
        BzlModuleIdentity {
            label: CanonicalLabel::parse("@@rules_cc+//cc/private/link:collect_solib_dirs.bzl")
                .unwrap(),
            workspace_path: PathBuf::from("/rules_cc/cc/private/link/collect_solib_dirs.bzl"),
            repository_mapping: Arc::from([(
                ApparentRepoName::new("bazel_skylib").unwrap(),
                CanonicalRepoName::new("bazel_skylib+").unwrap(),
            )]),
    ...
    for (name, child, export) in [
        ("paths", 0, "paths"),
        ("is_shared_library", 1, "is_shared_library"),
        ("LINKING_MODE", 2, "LINKING_MODE"),
        ("LINK_TARGET_TYPE", 2, "LINK_TARGET_TYPE"),
        ("is_dynamic_library", 2, "is_dynamic_library"),
    ] {
        assert!(
            module
                .get(name)
    ...
    assert_eq!(
        module.get("collect_solib_dirs").unwrap().value().get_type(),
        "function"
    );
    let private_functions = "_collect_solib_dirs_from_libraries _collect_toolchain_runtime_library_search_directories _find_potential_solib_parents _find_toolchain_solib_parents _get_runfiles_repo_name _get_relative";
    for name in private_functions.split_whitespace() {
        assert_eq!(
            module
    ...
    let mut names = module.names().map(|name| name.as_str()).collect::<Vec<_>>();
    names.sort_unstable();
    let mut expected = "paths is_shared_library LINKING_MODE LINK_TARGET_TYPE is_dynamic_library collect_solib_dirs".split_whitespace().collect::<Vec<_>>();
    expected.sort_unstable();
    assert_eq!(names, expected);
    let mut all = module
        .names_any_visibility()
...
fn assert_rules_cc_create_libraries_to_link_values_interfaces(
    module: &FrozenModule,
    child: &FrozenModule,
) {
    let public = |name| module.get(name).unwrap();
    ...
    for name in [
        ...
        assert!(
            public(name)
                .value()
                .ptr_eq(child.get(name).unwrap().value())
        );
    }
    let type_binding = private("_TYPE");
    assert!(module.get("_TYPE").is_err());
    let types = StructRef::from_value(type_binding.value()).unwrap();
    let mut actual = types
        .iter()
        .map(|(name, value)| (name.as_str(), value.unpack_str().unwrap()))
        .collect::<Vec<_>>();
    ...
    let provider_bindings = provider_names.map(|name| private(name));
    for (binding, name) in provider_bindings.iter().zip(provider_names) {
        let provider = FrozenUserProviderCallable::from_value(binding.value()).unwrap();
        assert_eq!(
            (provider.id().source_label(), provider.id().exported_name()),
            (
    ...
    for (index, left) in provider_bindings.iter().enumerate() {
        for right in &provider_bindings[index + 1..] {
            assert!(!left.value().ptr_eq(right.value()));
        }
    }
    let public_functions = "add_object_files_to_link add_libraries_to_link process_objects_for_lto";
    let private_functions = "_add_static_library_to_link _add_dynamic_library_to_link";
    for name in public_functions.split_whitespace() {
        assert_eq!(public(name).value().get_type(), "function");
    }
    for name in private_functions.split_whitespace() {
    ...
    let mut names = module.names().map(|name| name.as_str()).collect::<Vec<_>>();
    names.sort_unstable();
    let mut expected = "is_shared_library is_versioned_shared_library root_relative_path add_object_files_to_link add_libraries_to_link process_objects_for_lto".split_whitespace().collect::<Vec<_>>();
    expected.sort_unstable();
    assert_eq!(names, expected);
    let mut all = module
        .names_any_visibility()
...
#[test]
fn exact_rules_cc_create_libraries_to_link_values_freezes_complete_producer() {
    assert_eq!(
        RULES_CC_CREATE_LIBRARIES_TO_LINK_VALUES_SOURCE
            .lines()
            .count(),
        363
    );
    assert_eq!(
        format!(
            "{:x}",
            Sha256::digest(RULES_CC_CREATE_LIBRARIES_TO_LINK_VALUES_SOURCE.as_bytes())
        ),
    ...
    .unwrap();
    assert_rules_cc_create_libraries_to_link_values_interfaces(&module, &complete[1].2);
}

fn assert_rules_cc_link_build_variables_interfaces(
    module: &FrozenModule,
    children: &[(&'static str, BzlModuleIdentity, FrozenModule); 2],
) {
    let public = |name| module.get(name).unwrap();
    let private = |name| module.get_any_visibility(name).unwrap().0;
    for (name, child, export) in [
        ("get_relative_path", 0, "get_relative_path"),
        (
            "should_create_per_object_debug_info",
            0,
            "should_create_per_object_debug_info",
        ),
        ("artifact_category", 0, "artifact_category_names"),
        ("_cc_internal", 1, "cc_internal"),
    ] {
    ...
    assert!(module.get("_cc_internal").is_err());
    let variables_binding = public("LINK_BUILD_VARIABLES");
    let variables = StructRef::from_value(variables_binding.value()).unwrap();
    let expected = "OUTPUT_EXECPATH|output_execpath LIBRARIES_TO_LINK|libraries_to_link RUNTIME_LIBRARY_SEARCH_DIRECTORIES|runtime_library_search_directories LIBRARY_SEARCH_DIRECTORIES|library_search_directories RUNTIME_SOLIB_NAME|runtime_solib_name GENERATE_INTERFACE_LIBRARY|generate_interface_library INTERFACE_LIBRARY_BUILDER|interface_library_builder_path INTERFACE_LIBRARY_INPUT|interface_library_input_path INTERFACE_LIBRARY_OUTPUT|interface_library_output_path USER_LINK_FLAGS|user_link_flags FORCE_PIC|force_pic STRIP_DEBUG_SYMBOLS|strip_debug_symbols IS_CC_TEST|is_cc_test IS_USING_FISSION|is_using_fission LINKER_PARAM_FILE|linker_param_file THINLTO_PARAM_FILE|thinlto_param_file THINLTO_OPTIONAL_PARAMS_FILE|thinlto_optional_params_file THINLTO_INDEXING_PARAM_FILE|thinlto_indexing_param_file THINLTO_PREFIX_REPLACE|thinlto_prefix_replace THINLTO_OBJECT_SUFFIX_REPLACE|thinlto_object_suffix_replace THINLTO_MERGED_OBJECT_FILE|thinlto_merged_object_file FDO_INSTRUMENT_PATH|fdo_instrument_path CS_FDO_INSTRUMENT_PATH|cs_fdo_instrument_path PROPELLER_OPTIMIZE_LD_PATH|propeller_optimize_ld_path";
    assert_eq!(variables.iter().count(), 24);
    for row in expected.split_whitespace() {
        let (name, value) = row.split_once('|').unwrap();
        assert_eq!(
            variables
                .iter()
                .find_map(|(field, actual)| (field.as_str() == name).then_some(actual))
                .unwrap()
                .unpack_str(),
            Some(value)
        );
    }
    let dont_binding = private("_DONT_GENERATE_INTERFACE_LIBRARY");
    assert!(module.get("_DONT_GENERATE_INTERFACE_LIBRARY").is_err());
    let mut dont = DictRef::from_value(dont_binding.value())
        .unwrap()
        .iter()
        .map(|(key, value)| (key.unpack_str().unwrap(), value.unpack_str().unwrap()))
        .collect::<Vec<_>>();
    dont.sort_unstable();
    assert_eq!(
        dont,
        [
            ("generate_interface_library", "no"),
            ("interface_library_builder_path", "ignored"),
            ("interface_library_input_path", "ignored"),
            ("interface_library_output_path", "ignored"),
        ]
    );
    let public_functions = "create_link_variables setup_common_linking_variables setup_linking_variables setup_lto_indexing_variables";
    for name in public_functions.split_whitespace() {
        assert_eq!(public(name).value().get_type(), "function", "{name}");
    }
    assert_eq!(private("_remove_pie").value().get_type(), "function");
    assert!(module.get("_remove_pie").is_err());
    let mut names = module.names().map(|name| name.as_str()).collect::<Vec<_>>();
    names.sort_unstable();
    let mut expected = "get_relative_path should_create_per_object_debug_info artifact_category LINK_BUILD_VARIABLES create_link_variables setup_common_linking_variables setup_linking_variables setup_lto_indexing_variables".split_whitespace().collect::<Vec<_>>();
    expected.sort_unstable();
    assert_eq!(names, expected);
    let mut all = module
        .names_any_visibility()
...
#[test]
fn exact_rules_cc_link_build_variables_freezes_complete_producer() {
    assert_eq!(RULES_CC_LINK_BUILD_VARIABLES_SOURCE.lines().count(), 392);
    assert_eq!(
        format!(
            "{:x}",
            Sha256::digest(RULES_CC_LINK_BUILD_VARIABLES_SOURCE.as_bytes())
        ),
    ...
    assert!(children[1].1.repository_mapping.is_empty());
    let module = eval_bzl_with_loaded_children(
        RULES_CC_LINK_BUILD_VARIABLES_SOURCE,
        BzlModuleIdentity {
            label: CanonicalLabel::parse("@@rules_cc+//cc/private/link:link_build_variables.bzl")
                .unwrap(),
            workspace_path: PathBuf::from("/rules_cc/cc/private/link/link_build_variables.bzl"),
            repository_mapping: Arc::from([]),
        },
        &children,
    )
    .unwrap();
    assert_rules_cc_link_build_variables_interfaces(&module, &children);
}

fn complete_rules_cc_finalize_link_action_children()
-> Vec<(&'static str, BzlModuleIdentity, FrozenModule)> {
    let cc = complete_rules_cc_cc_info_children();
    let compile = complete_rules_cc_compile_children();
    let linkstamp_children = [1, 2, 3, 4, 5, 9].map(|index| {
        (
            compile[index].0,
            compile[index].1.clone(),
            compile[index].2.dupe(),
        )
    });
    let linkstamp = compile_child(
    ...
    let solib_children = complete_rules_cc_collect_solib_dirs_children();
    let solib = compile_child(
        RULES_CC_COLLECT_SOLIB_DIRS_SOURCE,
    ...
    let variable_children = [
        (cc[1].0, cc[1].1.clone(), cc[1].2.dupe()),
        (cc[2].0, cc[2].1.clone(), cc[2].2.dupe()),
    ];
    let variables = compile_child(
        RULES_CC_LINK_BUILD_VARIABLES_SOURCE,
    ...
    let native = complete_rules_cc_compile_build_variables_children();
    vec![
        (compile[3].0, compile[3].1.clone(), compile[3].2.dupe()),
        (cc[2].0, cc[2].1.clone(), cc[2].2.dupe()),
        (
        ...
        ("//cc/private/link:collect_solib_dirs.bzl", solib.0, solib.1),
        (
        ...
        (
            "//cc/private/link:link_build_variables.bzl",
            variables.0,
            variables.1,
        ),
...
fn assert_rules_cc_finalize_link_action_interfaces(
    module: &FrozenModule,
    children: &[(&'static str, BzlModuleIdentity, FrozenModule)],
) {
    let public = |name| module.get(name).unwrap();
    ...
    for (name, child, export) in [
        ...
        ("collect_solib_dirs", 3, "collect_solib_dirs"),
        ("add_libraries_to_link", 4, "add_libraries_to_link"),
        ("add_object_files_to_link", 4, "add_object_files_to_link"),
        ("process_objects_for_lto", 4, "process_objects_for_lto"),
        (
            "setup_common_linking_variables",
            5,
            "setup_common_linking_variables",
        ),
        ("LINKING_MODE", 6, "LINKING_MODE"),
        ("LINK_TARGET_TYPE", 6, "LINK_TARGET_TYPE"),
        ("USE_ARCHIVER", 6, "USE_ARCHIVER"),
        ("USE_LINKER", 6, "USE_LINKER"),
        ("is_dynamic_library", 6, "is_dynamic_library"),
        ("_cc_common_internal", 7, "native_cc_common"),
    ] {
        let binding = if name.starts_with('_') {
            private(name)
        } else {
    ...
    for name in ["_cc_internal", "_cc_common_internal"] {
        assert!(module.get(name).is_err());
    }
    assert_eq!(
        public("finalize_link_action").value().get_type(),
        "function"
    );
    let private_functions = "_create_action _can_split_command_line _need_whole_archive _quote_replacement _resource_set";
    for name in private_functions.split_whitespace() {
        assert_eq!(private(name).value().get_type(), "function", "{name}");
    ...
    let mut names = module.names().map(|name| name.as_str()).collect::<Vec<_>>();
    names.sort_unstable();
    let mut expected = "semantics register_linkstamp_compile_action collect_solib_dirs add_libraries_to_link add_object_files_to_link process_objects_for_lto setup_common_linking_variables LINKING_MODE LINK_TARGET_TYPE USE_ARCHIVER USE_LINKER is_dynamic_library finalize_link_action".split_whitespace().collect::<Vec<_>>();
    expected.sort_unstable();
    assert_eq!(names, expected);
    let mut all = module
        .names_any_visibility()
    ...
    all.sort_unstable();
    expected.extend(private_functions.split_whitespace());
    expected.extend(["_cc_internal", "_cc_common_internal"]);
    expected.sort_unstable();
    assert_eq!(all, expected);
}

#[test]
fn exact_rules_cc_finalize_link_action_freezes_complete_producer() {
    assert_eq!(RULES_CC_FINALIZE_LINK_ACTION_SOURCE.lines().count(), 469);
    assert_eq!(
        format!(
            "{:x}",
            Sha256::digest(RULES_CC_FINALIZE_LINK_ACTION_SOURCE.as_bytes())
        ),
        "adc6ea3b355d0c5e5fbf1b1e9eaa7d7dd7c0c095234a0cff7fdb4fc72eb167c9"
    );
    let children = complete_rules_cc_finalize_link_action_children();
    for (child, label) in children.iter().zip([
        "@@rules_cc+//cc/common:semantics.bzl",
        "@@rules_cc+//cc/private:cc_internal.bzl",
        "@@rules_cc+//cc/private/compile:linkstamp_compile.bzl",
    ...
    let module = eval_bzl_with_loaded_children(
        RULES_CC_FINALIZE_LINK_ACTION_SOURCE,
        BzlModuleIdentity {
            label: CanonicalLabel::parse("@@rules_cc+//cc/private/link:finalize_link_action.bzl")
                .unwrap(),
            workspace_path: PathBuf::from("/rules_cc/cc/private/link/finalize_link_action.bzl"),
            repository_mapping: Arc::from([]),
        },
        &children,
    )
    .unwrap();
    assert_rules_cc_finalize_link_action_interfaces(&module, &children);
}

fn complete_rules_cc_cpp_link_action_children()
-> Vec<(&'static str, BzlModuleIdentity, FrozenModule)> {
    let cc = complete_rules_cc_cc_info_children();
    let native = complete_rules_cc_compile_build_variables_children();
    let finalizer_children = complete_rules_cc_finalize_link_action_children();
    let finalizer = compile_child(
        RULES_CC_FINALIZE_LINK_ACTION_SOURCE,
    ...
    vec![
        ...
        ("//cc/private/link:lto_backends.bzl", lto.0, lto.1),
        ("//cc/private/link:target_types.bzl", targets.0, targets.1),
        (native[2].0, native[2].1.clone(), native[2].2.dupe()),
    ]
}

fn assert_rules_cc_cpp_link_action_interfaces(
    module: &FrozenModule,
    children: &[(&'static str, BzlModuleIdentity, FrozenModule)],
) {
    let public = |name| module.get(name).unwrap();
    ...
    for (name, child, export) in [
        ...
        ("artifact_category", 1, "artifact_category_names"),
        ("_cc_internal", 2, "cc_internal"),
        ("finalize_link_action", 3, "finalize_link_action"),
        ("setup_linking_variables", 4, "setup_linking_variables"),
        (
            "create_shared_non_lto_artifacts",
            5,
            "create_shared_non_lto_artifacts",
    ...
    assert_eq!(public("link_action").value().get_type(), "function");
    assert_eq!(
        private("_map_linkstamps_to_outputs").value().get_type(),
        "function"
    );
    assert!(module.get("_map_linkstamps_to_outputs").is_err());
    let mut names = module.names().map(|name| name.as_str()).collect::<Vec<_>>();
    names.sort_unstable();
    let mut expected = "paths artifact_category finalize_link_action setup_linking_variables create_shared_non_lto_artifacts LINK_TARGET_TYPE USE_ARCHIVER USE_LINKER is_dynamic_library link_action".split_whitespace().collect::<Vec<_>>();
    expected.sort_unstable();
    assert_eq!(names, expected);
    let mut all = module
        .names_any_visibility()
...
#[test]
fn exact_rules_cc_cpp_link_action_freezes_complete_producer() {
    assert_eq!(RULES_CC_CPP_LINK_ACTION_SOURCE.lines().count(), 273);
    assert_eq!(
        format!(
            "{:x}",
            Sha256::digest(RULES_CC_CPP_LINK_ACTION_SOURCE.as_bytes())
        ),
        "0cbe9d6b0ce0f6bea5abe1d9783b79435f495ba93bdaf402ad9539513a82223f"
    );
    let children = complete_rules_cc_cpp_link_action_children();
    for (child, label) in children.iter().zip([
        "@@bazel_skylib+//lib:paths.bzl",
        "@@rules_cc+//cc/common:cc_helper_internal.bzl",
        "@@rules_cc+//cc/private:cc_internal.bzl",
    ...
    assert_eq!(children[1].1.repository_mapping, skylib_mapping);
    assert_eq!(children[5].1.repository_mapping, skylib_mapping);
    for child in [
        &children[0],
        &children[2],
        &children[3],
    ...
    let module = eval_bzl_with_loaded_children(
        RULES_CC_CPP_LINK_ACTION_SOURCE,
        BzlModuleIdentity {
            label: CanonicalLabel::parse("@@rules_cc+//cc/private/link:cpp_link_action.bzl")
                .unwrap(),
            workspace_path: PathBuf::from("/rules_cc/cc/private/link/cpp_link_action.bzl"),
            repository_mapping: skylib_mapping,
        },
        &children,
    )
    .unwrap();
    assert_rules_cc_cpp_link_action_interfaces(&module, &children);
}

fn complete_rules_cc_lto_indexing_action_children()
-> Vec<(&'static str, BzlModuleIdentity, FrozenModule)> {
    let compile = complete_rules_cc_compile_children();
    let link = complete_rules_cc_cpp_link_action_children();
    vec![
        (compile[2].0, compile[2].1.clone(), compile[2].2.dupe()),
        (compile[5].0, compile[5].1.clone(), compile[5].2.dupe()),
        (compile[10].0, compile[10].1.clone(), compile[10].2.dupe()),
        (link[3].0, link[3].1.clone(), link[3].2.dupe()),
        (link[4].0, link[4].1.clone(), link[4].2.dupe()),
        (link[5].0, link[5].1.clone(), link[5].2.dupe()),
        (link[6].0, link[6].1.clone(), link[6].2.dupe()),
    ]
}

fn assert_rules_cc_lto_indexing_action_interfaces(
    module: &FrozenModule,
    children: &[(&'static str, BzlModuleIdentity, FrozenModule)],
) {
    let public = |name| module.get(name).unwrap();
    let private = |name| module.get_any_visibility(name).unwrap().0;
    for (name, child, export) in [
        ("root_relative_path", 0, "root_relative_path"),
        ("_cc_internal", 1, "cc_internal"),
        (
            "get_minimized_bitcode_or_self",
            2,
        ...
        ("finalize_link_action", 3, "finalize_link_action"),
        (
            "setup_lto_indexing_variables",
            4,
            "setup_lto_indexing_variables",
        ),
        ("create_lto_backends", 5, "create_lto_backends"),
        ("LINKING_MODE", 6, "LINKING_MODE"),
        ("LINK_TARGET_TYPE", 6, "LINK_TARGET_TYPE"),
        ("is_dynamic_library", 6, "is_dynamic_library"),
    ] {
    ...
    assert!(module.get("_cc_internal").is_err());
    assert_eq!(
        public("create_lto_artifacts_and_lto_indexing_action")
            .value()
            .get_type(),
        "function"
    );
    assert_eq!(
        private("_lto_indexing_action").value().get_type(),
        "function"
    );
    assert!(module.get("_lto_indexing_action").is_err());
    let mut names = module.names().map(|name| name.as_str()).collect::<Vec<_>>();
    names.sort_unstable();
    let mut expected = "root_relative_path get_minimized_bitcode_or_self finalize_link_action setup_lto_indexing_variables create_lto_backends LINKING_MODE LINK_TARGET_TYPE is_dynamic_library create_lto_artifacts_and_lto_indexing_action".split_whitespace().collect::<Vec<_>>();
    expected.sort_unstable();
    assert_eq!(names, expected);
    let mut all = module
        .names_any_visibility()
        ...
        .collect::<Vec<_>>();
    all.sort_unstable();
    expected.extend(["_cc_internal", "_lto_indexing_action"]);
    expected.sort_unstable();
    assert_eq!(all, expected);
}

#[test]
fn exact_rules_cc_lto_indexing_action_freezes_complete_producer() {
    assert_eq!(RULES_CC_LTO_INDEXING_ACTION_SOURCE.lines().count(), 288);
    assert_eq!(
        format!(
            "{:x}",
            Sha256::digest(RULES_CC_LTO_INDEXING_ACTION_SOURCE.as_bytes())
        ),
        "03cb57e972bb7503d665ca56340a34fff3e6289f9c7a168ca87a427e57c66863"
    );
    let children = complete_rules_cc_lto_indexing_action_children();
    for (child, label) in children.iter().zip([
        "@@rules_cc+//cc/common:cc_helper_internal.bzl",
        "@@rules_cc+//cc/private:cc_internal.bzl",
        "@@rules_cc+//cc/private/compile:lto_compilation_context.bzl",
    ...
    for child in [&children[0], &children[5]] {
    ...
    let module = eval_bzl_with_loaded_children(
        RULES_CC_LTO_INDEXING_ACTION_SOURCE,
        BzlModuleIdentity {
            label: CanonicalLabel::parse("@@rules_cc+//cc/private/link:lto_indexing_action.bzl")
                .unwrap(),
            workspace_path: PathBuf::from("/rules_cc/cc/private/link/lto_indexing_action.bzl"),
            repository_mapping: Arc::from([]),
        },
        &children,
    )
    .unwrap();
    assert_rules_cc_lto_indexing_action_interfaces(&module, &children);
}
...
fn compile_child(
    ...
    mapping: &[(&str, &str)],
    children: &[(&'static str, BzlModuleIdentity, FrozenModule)],
) -> (BzlModuleIdentity, FrozenModule) {
    let owner = compile_owner(label, path, mapping);
    let module = eval_bzl_with_loaded_children(source, owner.clone(), children).unwrap();
    (owner, module)
}

fn complete_rules_cc_compile_children() -> Vec<(&'static str, BzlModuleIdentity, FrozenModule)> {
    let cc = complete_rules_cc_cc_info_children();
    let action = compile_child(
    ...
    let output_children = complete_rules_cc_compilation_outputs_children();
    let outputs = compile_child(
        RULES_CC_COMPILATION_OUTPUTS_SOURCE,
        "@@rules_cc+//cc/private/compile:cc_compilation_outputs.bzl",
        "/rules_cc/cc/private/compile/cc_compilation_outputs.bzl",
        &[],
    ...
    let template_children = complete_rules_cc_compile_action_template_children();
    let templates = compile_child(
        RULES_CC_COMPILE_ACTION_TEMPLATES_SOURCE,
        "@@rules_cc+//cc/private/compile:compile_action_templates.bzl",
        "/rules_cc/cc/private/compile/compile_action_templates.bzl",
        &[("bazel_skylib", "bazel_skylib+")],
    ...
    let variable_children = complete_rules_cc_compile_build_variables_children();
    let variables = compile_child(
        RULES_CC_COMPILE_BUILD_VARIABLES_SOURCE,
        "@@rules_cc+//cc/private/compile:compile_build_variables.bzl",
        "/rules_cc/cc/private/compile/compile_build_variables.bzl",
    ...
    vec![
        ...
        ("//cc:action_names.bzl", action.0, action.1),
        (
            "//cc/common:cc_helper_internal.bzl",
            cc[1].1.clone(),
            cc[1].2.dupe(),
        ),
        ("//cc/common:semantics.bzl", semantics.0, semantics.1),
        ("//cc/private:cc_info.bzl", cc_info.0, cc_info.1),
        (
            "//cc/private:cc_internal.bzl",
            cc[2].1.clone(),
            cc[2].2.dupe(),
        ...
        (
            "//cc/private/compile:compile_action_templates.bzl",
            templates.0,
            templates.1,
        ),
        (
        ...
        (
            "//cc/private/compile:lto_compilation_context.bzl",
            output_children[2].1.clone(),
            output_children[2].2.dupe(),
        ),
    ]
}

fn assert_compile_imports(
    compile: &FrozenModule,
    children: &[(&'static str, BzlModuleIdentity, FrozenModule)],
) {
    let public = |name| compile.get(name).unwrap();
    let private = |name| compile.get_any_visibility(name).unwrap().0;
    let imports = [
        ("paths", 0, "paths"),
        ("ACTION_NAMES", 1, "ACTION_NAMES"),
        (
            "CPP_SOURCE_TYPE_CLIF_INPUT_PROTO",
            2,
            "CPP_SOURCE_TYPE_CLIF_INPUT_PROTO",
        ),
        ("CPP_SOURCE_TYPE_HEADER", 2, "CPP_SOURCE_TYPE_HEADER"),
        ("CPP_SOURCE_TYPE_SOURCE", 2, "CPP_SOURCE_TYPE_SOURCE"),
        ...
        ("_use_pic_for_binaries", 2, "use_pic_for_binaries"),
        ("_use_pic_for_dynamic_libs", 2, "use_pic_for_dynamic_libs"),
        ("artifact_category", 2, "artifact_category_names"),
        ("_starlark_cc_semantics", 3, "semantics"),
        (
            "create_cc_compilation_context_with_cpp20_modules",
            4,
            "create_cc_compilation_context_with_cpp20_modules",
        ...
        ("_cc_internal", 5, "cc_internal"),
        ("cc_compilation_helper", 6, "cc_compilation_helper"),
        ("dotd_files_enabled", 6, "dotd_files_enabled"),
        (
            "serialized_diagnostics_file_enabled",
            6,
            "serialized_diagnostics_file_enabled",
        ...
        (
            "create_compilation_outputs_internal",
            7,
            "create_compilation_outputs_internal",
        ),
        (
    ...
    for (name, child, export) in imports {
        ...
        if name.starts_with('_') {
            assert!(compile.get(name).is_err(), "{name}");
        }
    }
}

fn assert_compile_eager_values(compile: &FrozenModule) {
    let private = |name| compile.get_any_visibility(name).unwrap().0;
    let scratch = Module::new();
    for (name, expected) in [
        ("_VALID_CPP_SOURCE_TYPES", "SOURCE HEADER CLIF_INPUT_PROTO"),
        (
            "SOURCE_CATEGORY_CC",
            ".cc .cpp .cxx .c++ .C .cu .cl .h .hh .hpp .ipp .hxx .h++ .inc .inl .tlh .tli .H .tcc .c .s .asm .S .ipb",
        ),
        (
            "SOURCE_CATEGORY_CC_AND_OBJC",
            ".cc .cpp .cxx .c++ .C .cu .cl .h .hh .hpp .ipp .hxx .h++ .inc .inl .tlh .tli .H .tcc .m .mm .c .s .asm .S",
        ),
        ("LTO_SOURCE_EXTENSIONS", ".cc .cpp .cxx .c++ .C .cu .cl .c"),
    ] {
        let binding = if name.starts_with('_') {
            private(name)
        } else {
            compile.get(name).unwrap()
        };
        assert_eq!(binding.value().get_type(), "set", "{name}");
        let actual = binding
            .value()
            .to_value()
            .iterate(scratch.heap())
    ...
    let provider = private("_CppSourceInfo");
    assert_eq!(provider.value().get_type(), "provider_callable");
    assert_eq!(
        provider.value().to_string(),
        "provider[@@rules_cc+//cc/private/compile:compile.bzl%_CppSourceInfo]"
    );
    assert_eq!(
        private("__new_cpp_source_info").value().get_type(),
        "function"
    );
    for name in [
        "_VALID_CPP_SOURCE_TYPES",
        "_CppSourceInfo",
        "__new_cpp_source_info",
    ] {
        assert!(compile.get(name).is_err(), "{name}");
    }
}

fn assert_compile_function_and_name_inventory(compile: &FrozenModule) {
    let private_functions = "_cpp_source_init _add_suitable_headers_to_compilation_unit_sources _add_suitable_srcs_to_compilation_unit_sources _add_suitable_srcs_to_module_interfaces_sources _to_file_list _to_file_label_tuple_list _should_provide_header_modules _create_scan_deps_action _create_aggregate_ddi_action _create_gen_modmap_action _create_cc_compile_actions_with_cpp20_module_helper _create_cc_compile_actions_with_cpp20_module _create_cc_compile_actions _create_pic_nopic_compile_source_actions _create_compile_source_action _create_temps_action _create_module_codegen_action _create_module_action _get_compile_output_file _use_dotd_file _calculate_output_name_map_by_type _calculate_output_name_map _get_source_artifacts_by_type _basename_without_extension _maybe_declare_dotd_file _maybe_declare_diagnostics_file _maybe_declare_gcno_file";
    assert_eq!(private_functions.split_whitespace().count(), 27);
    assert_eq!(
        compile.get("compile").unwrap().value().get_type(),
        "function"
    );
    for name in private_functions.split_whitespace() {
        assert_eq!(
    ...
    let public_imports = "paths ACTION_NAMES CPP_SOURCE_TYPE_CLIF_INPUT_PROTO CPP_SOURCE_TYPE_HEADER CPP_SOURCE_TYPE_SOURCE extensions should_create_per_object_debug_info artifact_category create_cc_compilation_context_with_cpp20_modules create_compilation_context_with_extra_header_tokens create_separate_module_map cc_compilation_helper dotd_files_enabled serialized_diagnostics_file_enabled create_compilation_outputs_internal create_compile_action_templates get_copts get_fdo_variables_and_inputs get_specific_compile_build_variables setup_common_compile_build_variables create_lto_compilation_context";
    let mut expected = public_imports
        .split_whitespace()
        .chain(
            "SOURCE_CATEGORY_CC SOURCE_CATEGORY_CC_AND_OBJC LTO_SOURCE_EXTENSIONS compile"
                .split_whitespace(),
        )
        .collect::<Vec<_>>();
    assert_eq!(expected.len(), 25);
    expected.sort_unstable();
    let mut public = compile
        .names()
        .map(|name| name.as_str())
        .collect::<Vec<_>>();
    public.sort_unstable();
    assert_eq!(public, expected);
    expected.extend("_use_pic_for_binaries _use_pic_for_dynamic_libs _starlark_cc_semantics _cc_internal _VALID_CPP_SOURCE_TYPES _CppSourceInfo __new_cpp_source_info".split_whitespace());
    expected.extend(private_functions.split_whitespace());
...
#[test]
fn exact_rules_cc_compile_freezes_complete_recursive_producer() {
    let children = complete_rules_cc_compile_children();
    let labels = [
        "@@bazel_skylib+//lib:paths.bzl",
        "@@rules_cc+//cc:action_names.bzl",
        "@@rules_cc+//cc/common:cc_helper_internal.bzl",
    ...
    for ((child, label), mapping) in children.iter().zip(labels).zip(mappings) {
        assert_eq!(child.1.label, CanonicalLabel::parse(label).unwrap());
        let expected = mapping
            .iter()
            .map(|(a, c)| {
                (
                    ApparentRepoName::new(*a).unwrap(),
                    CanonicalRepoName::new(*c).unwrap(),
                )
            })
            .collect::<Vec<_>>();
        assert_eq!(child.1.repository_mapping.as_ref(), expected.as_slice());
    }
    let compile = eval_bzl_with_loaded_children(
        RULES_CC_COMPILE_SOURCE,
        compile_owner(
    ...
    .unwrap();
    assert_compile_imports(&compile, &children);
    assert_compile_eager_values(&compile);
    assert_compile_function_and_name_inventory(&compile);
}
...
fn assert_toolchain_config_public_declarations(module: &FrozenModule) {
    let mut expected = TOOLCHAIN_CONFIG_PROVIDERS
        .split_whitespace()
        .chain(TOOLCHAIN_CONFIG_PUBLIC_FUNCTIONS.split_whitespace())
        .collect::<Vec<_>>();
    assert_eq!(TOOLCHAIN_CONFIG_PROVIDERS.split_whitespace().count(), 13);
    assert_eq!(
        TOOLCHAIN_CONFIG_PUBLIC_FUNCTIONS.split_whitespace().count(),
        14
    );
    assert_eq!(expected.len(), 27);
    expected.sort_unstable();
    let mut actual = module.names().map(|name| name.as_str()).collect::<Vec<_>>();
    actual.sort_unstable();
    assert_eq!(actual, expected);
    for name in TOOLCHAIN_CONFIG_PROVIDERS.split_whitespace() {
        let binding = module.get(name).unwrap();
        let value = binding.value();
        assert_eq!(value.get_type(), "provider_callable");
        let provider = FrozenUserProviderCallable::from_value(value).unwrap();
        assert_eq!(
            provider.id().source_label(),
    ...
    for name in TOOLCHAIN_CONFIG_PUBLIC_FUNCTIONS.split_whitespace() {
        assert_eq!(module.get(name).unwrap().value().get_type(), "function");
    }
}

fn assert_toolchain_config_private_functions(module: &FrozenModule) {
    assert_eq!(
        TOOLCHAIN_CONFIG_PRIVATE_FUNCTIONS
            .split_whitespace()
            .count(),
        7
    );
    for name in TOOLCHAIN_CONFIG_PRIVATE_FUNCTIONS.split_whitespace() {
        assert_eq!(
            module
                .get_any_visibility(name)
                .unwrap()
...
#[test]
fn exact_rules_cc_toolchain_config_lib_freezes_complete_dependency_free_producer() {
    assert_eq!(RULES_CC_TOOLCHAIN_CONFIG_LIB_SOURCE.lines().count(), 622);
    assert_eq!(
        format!(
            "{:x}",
            Sha256::digest(RULES_CC_TOOLCHAIN_CONFIG_LIB_SOURCE.as_bytes())
        ),
        "f8418490663f7e188fa060265b215e80b154a5d190b32ef75fcb6d0254017808"
    );
    let module = eval_bzl_with_identity(
        RULES_CC_TOOLCHAIN_CONFIG_LIB_SOURCE,
        BzlModuleIdentity {
            label: CanonicalLabel::parse("@@rules_cc+//cc:cc_toolchain_config_lib.bzl").unwrap(),
            workspace_path: PathBuf::from("/rules_cc/cc/cc_toolchain_config_lib.bzl"),
            repository_mapping: Arc::from([]),
        },
    )
    .unwrap();
    assert_toolchain_config_public_declarations(&module);
    assert_toolchain_config_private_functions(&module);
}
...
fn exact_rules_cc_objc_info_child_retains_public_proxy_aliases() {
    ...
    for (source, expected) in [
        ...
        CC_PROXY_OBJC_INFO_LOAD,
        CC_PROXY_OBJC_INFO_EXPORTS,
    ]
    .into_iter()
    .zip([
    ...
    let slice = |start: usize, count: usize| {
        RULES_CC_OBJC_INFO_SOURCE
            .lines()
            .skip(start - 1)
            .take(count)
    ...
    assert_eq!(
        [hash(&slice(17, 47)), hash(&slice(65, 32))],
        [
    ...
    let child = eval_bzl_with_identity(RULES_CC_OBJC_INFO_SOURCE, child_owner.clone()).unwrap();
    let public = child.get("ObjcInfo").unwrap();
    let init = child.get_any_visibility("_objcinfo_init").unwrap().0;
    let raw = child.get_any_visibility("_new_objcinfo").unwrap().0;
    assert_eq!(public.value().get_type(), "provider_callable");
    assert_eq!(init.value().get_type(), "function");
    assert_eq!(raw.value().get_type(), "function");
    assert!(!public.value().ptr_eq(raw.value()));
    assert!(child.get("_objcinfo_init").is_err());
    assert!(child.get("_new_objcinfo").is_err());
    let proxy_source = [CC_PROXY_OBJC_INFO_LOAD, CC_PROXY_OBJC_INFO_EXPORTS].join("\n");
    let proxy = eval_bzl_with_loaded_children(
        &proxy_source,
        BzlModuleIdentity {
            label: CanonicalLabel::parse(
    ...
    .unwrap();
    for name in ["ObjcInfo", "new_objc_provider"] {
        let alias = proxy.get(name).unwrap();
        assert!(alias.value().ptr_eq(public.value()));
        assert!(!alias.value().ptr_eq(raw.value()));
    }
    for omitted in [
        "cc_common",
        "CcInfo",
...
fn eval_bzl_with_identity(
    ...
    eval_bzl_with_identity_and_globals(source, owner, &loading_globals())
}

fn eval_bzl_with_identity_and_globals(
    source: &str,
    owner: BzlModuleIdentity,
    globals: &Globals,
) -> starlark::Result<FrozenModule> {
