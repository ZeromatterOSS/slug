...
use slug_node::attrs::spec::internal::WITHIN_VIEW_ATTRIBUTE;
use slug_node::attrs::spec::internal::attr_is_configurable;
...
pub trait AttributeSpecExt {
    ...
    ) -> slug_error::Result<(&'v TargetNameRef, AttrValues)>;
