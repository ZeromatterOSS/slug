...
use slug_node::attrs::attr_type::arg::QueryExpansion;
use slug_node::attrs::attr_type::arg::StringWithMacrosPart;
use slug_node::attrs::attr_type::arg::UnconfiguredMacro;
use slug_node::attrs::attr_type::arg::UnconfiguredStringWithMacros;
use slug_node::attrs::attr_type::arg::UnrecognizedMacro;
use slug_node::attrs::attr_type::arg::parser;
use slug_node::attrs::attr_type::arg::parser::ParsedMacro;
use slug_node::attrs::attr_type::arg::parser::parse_macros;
use slug_node::attrs::attr_type::query::QueryAttrType;
use slug_node::attrs::attr_type::query::QueryMacroBase;
...
fn get_single_target_arg(
    args: Vec<String>,
    ctx: &dyn AttrCoercionContext,
) -> slug_error::Result<ProvidersLabel> {
    if args.len() != 1 {
...
pub trait UnconfiguredMacroExt {
    fn new_location(
        ...
        args: Vec<String>,
        exec_dep: bool,
    ) -> slug_error::Result<UnconfiguredMacro> {
...
mod tests {
    ...
    trait GetMacroDeps {
        type DepsType;
        fn get_deps(&self) -> slug_error::Result<Vec<Self::DepsType>>;
    }
    ...
    #[test]
    fn test_location() -> slug_error::Result<()> {
    ...
    #[test]
    fn test_location_exec() -> slug_error::Result<()> {
        let ctx = coercion_ctx();
        let location =
    ...
    fn test_exe() -> slug_error::Result<()> {
        ...
        if let MacroBase::Exe { label, .. } = &configured {
            ...
            return Err(slug_error!(slug_error::ErrorTag::Input, "Expected Exe"));
        }
    ...
    #[test]
    fn test_exe_target() -> slug_error::Result<()> {
        let ctx = coercion_ctx();
