...
pub static MAKE_CFG_CONSTRUCTOR: LateBinding<
    fn(OwnedFrozenValue) -> slug_error::Result<Arc<dyn CfgConstructorImpl>>,
...
impl<'v> PackageFileExtra<'v> {
    ...
    ) -> slug_error::Result<&'v PackageFileExtra<'v>> {
...
impl FrozenPackageFileExtra {
    pub(crate) fn get(
        module: &FrozenModule,
    ) -> slug_error::Result<Option<OwnedFrozenRef<FrozenPackageFileExtra>>> {
