...
use slug_common::package_listing::file_listing::PackageFileListing;
...
impl GlobPattern {
    fn new(pattern: &str) -> slug_error::Result<GlobPattern> {
...
mod tests {
    ...
    #[test]
    fn test_glob_match() -> slug_error::Result<()> {
    ...
    #[test]
    fn test_glob_match_case_sensitive() -> slug_error::Result<()> {
    ...
    #[test]
    fn test_resolve_glob() -> slug_error::Result<()> {
