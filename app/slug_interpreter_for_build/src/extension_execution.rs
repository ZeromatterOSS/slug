...
//! - `slug_bzlmod`: Parses MODULE.bazel files and aggregates extension usages
//! - `slug_interpreter_for_build`: Provides Starlark evaluation for .bzl files
//!
//! The flow is:
//! ```text
//! MODULE.bazel parsing (slug_bzlmod)
//!   ↓
...
/// Convert a TagValue from slug_bzlmod to SerializedTagValue.
...
/// Convert a TagValue from slug_bzlmod to a Starlark Value (for direct use).
...
///
/// This is the main entry point for converting slug_bzlmod's aggregated
