...
//!
//! Plan Reference: `thoughts/shared/plans/slug-bazel-subplans/08-aspects.md`
//!
...
impl<'v> StarlarkAspectCallable<'v> {
    ...
    fn new(
        ...
        exec_compatible_with: Vec<String>,
        subrules: Vec<Value<'v>>,
    ) -> slug_error::Result<StarlarkAspectCallable<'v>> {
    ...
    pub fn aspect_type_unfrozen(&self) -> slug_error::Result<StarlarkAspectType> {
...
impl<'v> StarlarkValue<'v> for StarlarkAspectCallable<'v> {
    ...
    fn invoke(
        ...
        Err(slug_error::Error::from(AspectError::AspectCannotBeInvokedDirectly).into())
    }
...
pub fn register_aspect_function(builder: &mut GlobalsBuilder) {
    ...
    fn aspect<'v>(
        ...
        let aspect_path = match &build_context.additional {
            ...
            _ => return Err(slug_error::Error::from(AspectError::AspectNotInBzl).into()),
        };
