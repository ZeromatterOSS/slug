...
use slug_node::cfg_constructor::CfgConstructorCalculationImpl;
...
) -> slug_error::Result<Option<Arc<dyn CfgConstructorImpl>>> {
...
async fn get_cfg_constructor(
    ...
    impl Key for GetCfgConstructorKey {
        type Value = slug_error::Result<Option<Arc<dyn CfgConstructorImpl>>>;
