...
impl ActionStats {
    ...
    pub fn update(&mut self, action: &slug_data::ActionExecutionEnd) {
...
pub fn was_local_action(action: &slug_data::ActionExecutionEnd) -> bool {
    action.execution_kind() == slug_data::ActionExecutionKind::Local
        || action.execution_kind() == slug_data::ActionExecutionKind::LocalWorker
}

pub fn scheduling_mode(action: &slug_data::ActionExecutionEnd) -> Option<SchedulingMode> {
    action
        .scheduling_mode
...
pub fn was_fallback_action(action: &slug_data::ActionExecutionEnd) -> bool {
    ...
    fn test_file_change_invalidation_source() {
        ...
        let action_execution_end = ActionExecutionEnd {
            ...
            invalidation_info: Some(slug_data::CommandInvalidationInfo {
                changed_file: Some(slug_data::command_invalidation_info::InvalidationSource {}),
                ..Default::default()
            }),
            ..Default::default()
        };
