...
mod tests {
    ...
    fn setup_dice_state(dice_state: &mut DiceState, finished: u32, total: u32) {
        dice_state.update(&slug_data::DiceStateSnapshot {
            key_states: {
    ...
    #[test]
    fn test_completion_no_progress() -> slug_error::Result<()> {
    ...
    #[test]
    fn test_completion_percentage_build_complete() -> slug_error::Result<()> {
        let mut dice = DiceState::new();
        let mut tracker = BuckEventSpanTracker::new();
    ...
    #[test]
    fn test_completion_percentage_intermediate_state() -> slug_error::Result<()> {
        let mut dice = DiceState::new();
        let mut tracker = BuckEventSpanTracker::new();
    ...
    #[test]
    fn test_completion_percentage_invalid_dice_state() -> slug_error::Result<()> {
        let mut dice = DiceState::new();
        let mut tracker = BuckEventSpanTracker::new();
    ...
    #[test]
    fn test_completion_percentage_empty_span() -> slug_error::Result<()> {
        let mut dice = DiceState::new();
