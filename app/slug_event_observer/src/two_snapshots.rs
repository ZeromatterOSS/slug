...
pub struct TwoSnapshots {
    pub penultimate: Option<(SystemTime, slug_data::Snapshot)>,
    pub last: Option<(SystemTime, slug_data::Snapshot)>,
}

impl TwoSnapshots {
    pub fn update(&mut self, timestamp: SystemTime, snapshot: &slug_data::Snapshot) {
    ...
    fn per_micro_second(&self, field: impl Fn(&slug_data::Snapshot) -> u64) -> Option<u64> {
...
mod tests {
    ...
    fn test_cpu_percents() {
        ...
        two_snapshots.update(
            t0,
            &slug_data::Snapshot {
                slug_user_cpu_us: 100,
                slug_system_cpu_us: 200,
                ..Default::default()
            },
        );
        assert_eq!(None, two_snapshots.cpu_percents());
        ...
        two_snapshots.update(
            ...
            &slug_data::Snapshot {
                slug_user_cpu_us: 6_000_100,
                slug_system_cpu_us: 8_000_200,
                ..Default::default()
            },
        );
