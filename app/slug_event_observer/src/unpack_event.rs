...
pub enum UnpackedBuckEvent<'a> {
    SpanStart(
        &'a BuckEvent,
        &'a SpanStartEvent,
        &'a slug_data::span_start_event::Data,
    ),
    SpanEnd(
        &'a BuckEvent,
        &'a SpanEndEvent,
        &'a slug_data::span_end_event::Data,
    ),
    Instant(
        &'a BuckEvent,
        &'a InstantEvent,
        &'a slug_data::instant_event::Data,
    ),
...
pub fn unpack_event(event: &BuckEvent) -> slug_error::Result<UnpackedBuckEvent<'_>> {
    match &event.data() {
