...
mod tests {
    ...
    use slug_artifact::deferred::key::DeferredHolderKey;
    use slug_build_api::actions::execute::dice_data::set_fallback_executor_config;
    use slug_build_api::bxl::calculation::BxlComputeResult;
    use slug_build_api::bxl::result::BxlResult;
    use slug_build_api::bxl::types::BxlFunctionLabel;
    use slug_build_api::deferred::calculation::DeferredCalculation;
    use slug_build_api::deferred::types::Deferred;
    use slug_build_api::deferred::types::DeferredCtx;
    use slug_build_api::deferred::types::DeferredInput;
    use slug_build_api::deferred::types::DeferredInputsRef;
    use slug_build_api::deferred::types::DeferredOutput;
    use slug_build_api::deferred::types::DeferredRegistry;
    use slug_build_api::deferred::types::DeferredValue;
    use slug_common::dice::data::testing::SetTestingIoProvider;
    use slug_core::base_deferred_key::BaseDeferredKey;
    ...
    impl Deferred for FakeDeferred {
        ...
        ) -> slug_error::Result<DeferredValue<Self::Output>> {
    ...
    #[tokio::test]
    async fn lookup_deferred_from_bxl() -> slug_error::Result<()> {
        let bxl = BxlKey::new(
            BxlFunctionLabel {
        ...
        let dice = DiceBuilder::new()
            ...
            .mock_and_return(
                ...
                slug_error::Ok(BxlComputeResult(Arc::new(BxlResult::BuildsArtifacts {
