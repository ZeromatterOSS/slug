...
use slug_core::pattern::pattern::maybe_split_cell_alias_and_relative_path;
...
) -> slug_error::Result<Option<CellPath>> {
...
mod tests {
    ...
    #[test]
    fn test_parse_cell_path_as_file_expr_literal() -> slug_error::Result<()> {
