...
enum LazyOperation {
    ...
    ConfiguredTargetNode {
        ...
        global_cfg_options: slug_error::Result<GlobalCfgOptions>,
    },
...
enum LazyResult {
    ...
    Catch(Box<slug_error::Result<LazyResult>>),
}
    ...
    pub(crate) fn new_configured_target_node(
        ...
        Self {
            lazy: Arc::new(LazyOperation::ConfiguredTargetNode {
                arg,
                global_cfg_options: global_cfg_options.map_err(slug_error::Error::from),
            }),
        }
    }
...
) -> slug_error::Result<StarlarkAnalysisResult> {
