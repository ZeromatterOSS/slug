...
use slug_action_impl::dynamic::attrs_starlark::StarlarkDynamicAttrType;
use slug_action_impl::dynamic::bxl::EVAL_BXL_FOR_DYNAMIC_OUTPUT;
use slug_action_impl::dynamic::deferred::DynamicLambdaArgs;
use slug_action_impl::dynamic::deferred::DynamicLambdaCtxDataSpec;
use slug_action_impl::dynamic::deferred::InputArtifactsMaterialized;
use slug_action_impl::dynamic::deferred::dynamic_lambda_ctx_data;
use slug_action_impl::dynamic::deferred::invoke_dynamic_output_lambda;
use slug_action_impl::dynamic::dynamic_actions_callable::DynamicActionsCallable;
use slug_action_impl::dynamic::dynamic_actions_callable::DynamicActionsCallbackParam;
use slug_action_impl::dynamic::dynamic_actions_callable::DynamicActionsCallbackParamSpec;
use slug_action_impl::dynamic::dynamic_actions_callable::DynamicActionsCallbackReturnType;
use slug_action_impl::dynamic::new_dynamic_actions_callable;
use slug_action_impl::dynamic::params::FrozenDynamicLambdaParams;
...
use slug_common::scope::scope_and_collect_with_dice;
use slug_core::deferred::base_deferred_key::BaseDeferredKeyBxl;
    ...
    let (_, futs) = unsafe {
        ...
        scope_and_collect_with_dice(dice_ctx, |dice_ctx, s| {
            s.spawn_cancellable(
                ...
                || Err(slug_error!(slug_error::ErrorTag::Tier0, "cancelled")),
            )
        })
    }
    .await;
