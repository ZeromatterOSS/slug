...
use slug_data::starlark_user_metadata_value::Value::BoolValue;
use slug_data::starlark_user_metadata_value::Value::DictValue;
use slug_data::starlark_user_metadata_value::Value::IntValue;
use slug_data::starlark_user_metadata_value::Value::ListValue;
use slug_data::starlark_user_metadata_value::Value::StringValue;
...
impl<'v> StarlarkUserEventParser<'v> {
    pub(crate) fn parse(
        ...
        id: &str,
        metadata: Value<'v>,
    ) -> slug_error::Result<StarlarkUserEvent> {
    ...
    fn unpack_metadata_map(
        &self,
        metadata: Value<'v>,
    ) -> slug_error::Result<HashMap<String, StarlarkUserMetadataValue>> {
        ...
        metadata
            ...
            .collect::<slug_error::Result<HashMap<_, _>>>()
    }
    ...
    fn get_metadata_value(
        ...
        k: &str,
        v: Value<'v>,
    ) -> slug_error::Result<StarlarkUserMetadataValue> {
