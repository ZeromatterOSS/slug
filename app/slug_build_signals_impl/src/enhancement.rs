...
pub(crate) struct CriticalPathProtoEnhancer {
    ...
    entries: Vec<slug_data::CriticalPathEntry2>,
}
...
impl CriticalPathProtoEnhancer {
    ...
    pub(crate) fn add_entry(&mut self, entry: DetailedCriticalPathEntry) -> slug_error::Result<()> {
            ...
            .is_zero()
        {
            self.add_simple_entry(
                None,
                slug_data::critical_path_entry2::Entry::Waiting(
                    slug_data::critical_path_entry2::Waiting {
    ...
    pub(crate) fn add_simple_entry(
        ...
        entry: slug_data::critical_path_entry2::Entry,
        time_span: TimeSpan,
        is_critical: bool,
    ) -> slug_error::Result<()> {
    ...
    pub(crate) fn into_entries(self) -> Vec<slug_data::CriticalPathEntry2> {
        self.entries
    }
    ...
    fn add_entry_impl(
        ...
        waiting_category: Option<&str>,
        time_span: TimeSpan,
        entry: slug_data::CriticalPathEntry2,
    ) -> slug_error::Result<()> {
    ...
    ) -> slug_error::Result<slug_data::CriticalPathEntry2> {
        let duration_proto: prost_types::Duration = duration.try_into()?;
        Ok(slug_data::CriticalPathEntry2 {
            span_ids: Vec::new(),
