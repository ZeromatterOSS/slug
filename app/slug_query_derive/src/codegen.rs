...
pub(crate) fn codegen(parsed: Parsed) -> syn::Result<TokenStream> {
    ...
    let result = quote! {
        ...
        mod #mod_name {
            ...
            use ::slug_query::__derive_refs::ref_cast::RefCast;
            use ::slug_query::__derive_refs::slug_query_parser::{BinaryOp, SpannedExpr};
            use ::slug_query::__derive_refs::indexmap::indexmap;
            use ::slug_query::__derive_refs::async_trait::async_trait;

            use super::*;
            use ::slug_query::query::{
