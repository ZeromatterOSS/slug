...
const DEFAULT_USER_AGENT: &str = "Slug";
...
pub async fn to_bytes(body: BoxStream<'_, hyper::Result<Bytes>>) -> slug_error::Result<Bytes> {
...
mod tests {
    ...
    #[test]
    fn test_change_scheme_to_http_succeeds() -> slug_error::Result<()> {
    ...
    #[test]
    fn test_change_scheme_to_http_no_effect() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_simple_get_success() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_simple_put_success() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
    ...
    #[tokio::test]
    async fn test_simple_post_success() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(all_of![
    ...
    #[tokio::test]
    async fn test_404_not_found_is_error() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(request::method_path("GET", "/foo"))
    ...
    #[tokio::test]
    async fn test_count_response_size() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(request::method_path("GET", "/foo"))
    ...
    #[tokio::test]
    async fn test_follows_redirects() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
    ...
    #[tokio::test]
    async fn test_head_changes_to_get_on_redirect() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        // Chain of two redirects /foo -> /bar -> /baz.
        test_server.expect(
    ...
    #[tokio::test]
    async fn test_post_gets_redirected() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        // Redirect /foo -> /bar
        test_server.expect(
    ...
    #[tokio::test]
    async fn test_too_many_redirects_fails() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
    ...
    mod unix {
        ...
        impl UnixSocketProxyServer {
            pub async fn new() -> slug_error::Result<Self> {
    ...
    #[cfg(unix)]
    #[tokio::test]
    async fn test_proxies_through_unix_socket_when_set() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_x2p_error_response_is_forbidden_host() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        let url = test_server.url("/foo");
        test_server.expect(
    ...
    #[tokio::test]
    async fn test_x2p_error_response_is_access_denied() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        let url = test_server.url("/foo");
        test_server.expect(
    ...
    #[tokio::test]
    async fn test_x2p_error_response_is_generic_error() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_concurrency_limit() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(request::method_path("GET", "/foo"))
...
mod proxy_tests {
    ...
    const HEADER_SLEEP_DURATION_MS: &str = "x-slug-test-proxy-sleep-duration-ms";
    ...
    impl ProxyServer {
        async fn new() -> slug_error::Result<Self> {
        ...
        fn uri(&self) -> slug_error::Result<http::Uri> {
            http::Uri::builder()
                .scheme("http")
    ...
    #[tokio::test]
    async fn test_uses_http_proxy() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(all_of![
    ...
    #[tokio::test]
    async fn test_uses_http_proxy_with_no_scheme_in_proxy_uri() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(all_of![
    ...
    #[tokio::test]
    async fn test_does_not_proxy_when_no_proxy_matches() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(all_of![request::method_path("GET", "/foo")])
    ...
    #[tokio::test]
    async fn test_proxies_when_no_proxy_does_not_match() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        test_server.expect(
            Expectation::matching(all_of![
    ...
    #[tokio::test]
    async fn test_timeout() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let test_server = httptest::Server::run();
        let proxy_server = ProxyServer::new().await?;
