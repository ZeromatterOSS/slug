...
use slug_certs::certs::find_internal_cert;
use slug_certs::certs::supports_vpnless;
use slug_certs::certs::tls_config_with_single_cert;
use slug_certs::certs::tls_config_with_system_roots;
...
impl HttpClientBuilder {
    ...
    pub async fn oss() -> slug_error::Result<Self> {
    ...
    pub async fn internal() -> slug_error::Result<Self> {
        let mut builder = Self::https_with_system_roots().await?;
        if supports_vpnless() {
    ...
    pub async fn https_with_system_roots() -> slug_error::Result<Self> {
    ...
    pub fn with_proxy_from_env(&mut self) -> slug_error::Result<&mut Self> {
...
mod tests {
    ...
    #[tokio::test]
    async fn test_default_builder() -> slug_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_supports_vpnless_set_true() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_http2_option() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let mut builder = HttpClientBuilder::https_with_system_roots().await?;
    ...
    #[tokio::test]
    async fn test_with_max_redirects_overrides_default() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let mut builder = HttpClientBuilder::https_with_system_roots().await?;
    ...
    #[tokio::test]
    async fn test_builder_with_proxy_adds_proxy() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
    ...
    #[tokio::test]
    async fn test_set_connect_timeout() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let mut builder = HttpClientBuilder::https_with_system_roots().await?;
    ...
    #[tokio::test]
    async fn test_set_connect_and_read_timeouts() -> slug_error::Result<()> {
        slug_certs::certs::maybe_setup_cryptography();
        let mut builder = HttpClientBuilder::https_with_system_roots().await?;
        builder
