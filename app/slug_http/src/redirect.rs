...
trait UriWithRedirect {
    fn with_redirect(&self, location: &Uri) -> slug_error::Result<Uri>;
...
impl PendingRequest {
    ...
    pub(super) fn to_request(&self) -> slug_error::Result<Request<Bytes>> {
...
impl<B> RedirectEngine<B> {
    ...
    fn update_and_create_request(&mut self) -> slug_error::Result<Option<Request<Bytes>>> {
