...
enum LazyOperation {
    ...
    ConfiguredTargetNode {
        ...
        global_cfg_options: kuro_error::Result<GlobalCfgOptions>,
    },
...
enum LazyResult {
    ...
    Catch(Box<kuro_error::Result<LazyResult>>),
}
    ...
    pub(crate) fn new_configured_target_node(
        ...
        Self {
            lazy: Arc::new(LazyOperation::ConfiguredTargetNode {
                arg,
                global_cfg_options: global_cfg_options.map_err(kuro_error::Error::from),
            }),
        }
    }
...
) -> kuro_error::Result<StarlarkAnalysisResult> {
