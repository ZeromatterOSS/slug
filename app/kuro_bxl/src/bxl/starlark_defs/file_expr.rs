...
use kuro_core::pattern::pattern::maybe_split_cell_alias_and_relative_path;
...
) -> kuro_error::Result<Option<CellPath>> {
...
mod tests {
    ...
    #[test]
    fn test_parse_cell_path_as_file_expr_literal() -> kuro_error::Result<()> {
