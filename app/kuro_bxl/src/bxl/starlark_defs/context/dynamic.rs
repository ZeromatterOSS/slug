...
use kuro_action_impl::dynamic::attrs_starlark::StarlarkDynamicAttrType;
use kuro_action_impl::dynamic::bxl::EVAL_BXL_FOR_DYNAMIC_OUTPUT;
use kuro_action_impl::dynamic::deferred::DynamicLambdaArgs;
use kuro_action_impl::dynamic::deferred::DynamicLambdaCtxDataSpec;
use kuro_action_impl::dynamic::deferred::InputArtifactsMaterialized;
use kuro_action_impl::dynamic::deferred::dynamic_lambda_ctx_data;
use kuro_action_impl::dynamic::deferred::invoke_dynamic_output_lambda;
use kuro_action_impl::dynamic::dynamic_actions_callable::DynamicActionsCallable;
use kuro_action_impl::dynamic::dynamic_actions_callable::DynamicActionsCallbackParam;
use kuro_action_impl::dynamic::dynamic_actions_callable::DynamicActionsCallbackParamSpec;
use kuro_action_impl::dynamic::dynamic_actions_callable::DynamicActionsCallbackReturnType;
use kuro_action_impl::dynamic::new_dynamic_actions_callable;
use kuro_action_impl::dynamic::params::FrozenDynamicLambdaParams;
...
use kuro_common::scope::scope_and_collect_with_dice;
...
) -> kuro_error::Result<RecordedAnalysisValues> {
    ...
    let (_, futs) = unsafe {
        ...
        scope_and_collect_with_dice(dice_ctx, |dice_ctx, s| {
            s.spawn_cancellable(
                ...
                || Err(kuro_error!(kuro_error::ErrorTag::Tier0, "cancelled")),
            )
        })
    }
    .await;
