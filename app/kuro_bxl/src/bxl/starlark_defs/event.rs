...
use kuro_data::starlark_user_metadata_value::Value::BoolValue;
use kuro_data::starlark_user_metadata_value::Value::DictValue;
use kuro_data::starlark_user_metadata_value::Value::IntValue;
use kuro_data::starlark_user_metadata_value::Value::ListValue;
use kuro_data::starlark_user_metadata_value::Value::StringValue;
...
impl<'v> StarlarkUserEventParser<'v> {
    pub(crate) fn parse(
        ...
        id: &str,
        metadata: Value<'v>,
    ) -> kuro_error::Result<StarlarkUserEvent> {
    ...
    fn unpack_metadata_map(
        &self,
        metadata: Value<'v>,
    ) -> kuro_error::Result<HashMap<String, StarlarkUserMetadataValue>> {
        ...
        metadata
            ...
            .collect::<kuro_error::Result<HashMap<_, _>>>()
    }
    ...
    fn get_metadata_value(
        ...
        k: &str,
        v: Value<'v>,
    ) -> kuro_error::Result<StarlarkUserMetadataValue> {
