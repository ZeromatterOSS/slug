...
use slug_node::configuration::calculation::ConfigurationCalculationDyn;
use slug_node::configuration::resolved::ConfigurationNode;
...
impl Key for MatchedConfigurationSettingKeysKey {
    type Value = slug_error::Result<MatchedConfigurationSettingKeysWithCfg>;
...
async fn get_configuration_node(
    ...
    target_cell: CellNameForConfigurationResolution,
    cfg_target: &ConfigurationSettingKey,
) -> slug_error::Result<ConfigurationNode> {
...
impl Key for ConfigurationNodeKey {
    type Value = slug_error::Result<ConfigurationNode>;
...
pub(crate) async fn get_platform_configuration(
    ...
    impl Key for PlatformConfigurationKey {
        type Value = slug_error::Result<ConfigurationData>;
...
) -> slug_error::Result<OrderedMap<TargetLabel, ConfigurationData>> {
...
) -> slug_error::Result<MatchedConfigurationSettingKeysWithCfg> {
