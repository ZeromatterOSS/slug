...
) -> slug_error::Result<FlatBufferBuilder<'static>> {
...
fn target_to_fbs<'a>(
    ...
    data: &'_ TargetData,
) -> slug_error::Result<WIPOffset<fbs::ConfiguredTargetNode<'a>>> {
    let node = &data.node;
...
mod tests {
    ...
    use slug_interpreter_for_build::call_stack::StarlarkCallStackWrapper;
    ...
    use slug_node::call_stack::StarlarkCallStack;
    ...
    fn gen_data(
        attrs: Vec<(
            &str,
            slug_node::attrs::attr::Attribute,
            slug_node::attrs::coerced_attr::CoercedAttr,
        )>,
