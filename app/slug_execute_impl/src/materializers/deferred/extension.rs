...
use slug_execute::materialize::materializer::DeferredMaterializerEntry;
use slug_execute::materialize::materializer::DeferredMaterializerExtensions;
use slug_execute::materialize::materializer::DeferredMaterializerIterItem;
...
struct Fsck {
    ...
    /// materializer command thread.
    #[derivative(Debug = "ignore")]
    sender: UnboundedSender<(ProjectRelativePathBuf, slug_error::Error)>,
}
...
#[derivative(Debug)]
struct RefreshTtls {
    sender: Sender<Option<JoinHandle<slug_error::Result<()>>>>,
    min_ttl: i64,
}
