...
use slug_execute::execute::action_digest::ActionDigestKind;
...
impl CacheType {
    fn to_proto(&self) -> slug_data::CacheType {
        match self {
            CacheType::ActionCache => slug_data::CacheType::ActionCache,
            CacheType::RemoteDepFileCache(_) => slug_data::CacheType::RemoteDepFileCache,
        }
    }
}
...
async fn query_action_cache_and_download_result(
    ...
    // BB cache evicted (not a slug non-determinism bug).
    {
