...
/// then you can fix forward by bumping the `slug.sqlite_incremental_state_version`
...
mod tests {
    ...
    #[test]
    fn test_initialize_incremental_sqlite_db() -> slug_error::Result<()> {
        ...
        mapping.insert(
            slug_fs::paths::forward_rel_path::ForwardRelativePathBuf::unchecked_new(
                "test_file".to_owned(),
            ),
