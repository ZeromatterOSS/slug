...
use kuro_interpreter_for_build::attrs::coerce::testing::coercion_ctx;
use kuro_interpreter_for_build::attrs::coerce::testing::coercion_ctx_listing;
use kuro_interpreter_for_build::attrs::coerce::testing::to_value;
use kuro_interpreter_for_build::interpreter::selector::register_select;
...
#[test]
fn test_string() -> kuro_error::Result<()> {
    let env = Module::new();
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_invalid_concat_coercion_into_one_of() -> kuro_error::Result<()> {
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_option() -> kuro_error::Result<()> {
    Heap::temp(|heap| {
...
#[test]
fn test_dict() -> kuro_error::Result<()> {
    let env = Module::new();
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_one_of() -> kuro_error::Result<()> {
    Heap::temp(|heap| {
...
#[test]
fn test_label() -> kuro_error::Result<()> {
    Heap::temp(|heap| {
        let value = heap.alloc(vec!["//some:target", "cell1//named:target[foo]"]);
...
#[test]
fn test_coerced_deps() -> kuro_error::Result<()> {
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_configured_deps() -> kuro_error::Result<()> {
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_resolved_deps() -> kuro_error::Result<()> {
    let globals = GlobalsBuilder::standard()
        .with(register_select)
        .with(kuro_build_api::interpreter::rule_defs::register_rule_defs)
        .build();
...
#[test]
fn test_dep_requires_providers() -> kuro_error::Result<()> {
    let env = Module::new();
...
#[test]
fn test_source_label() -> kuro_error::Result<()> {
    Heap::temp(|heap| {
...
#[test]
fn test_source_label_deps() -> kuro_error::Result<()> {
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_source_label_resolution() -> kuro_error::Result<()> {
    fn resolve_and_test(
        content: &str,
        test_content: &str,
        files: &[&str],
...
#[test]
fn test_single_source_label_fails_if_multiple_returned() -> kuro_error::Result<()> {
    Heap::temp(|heap| {
...
#[test]
fn test_bool() -> kuro_error::Result<()> {
    let globals = GlobalsBuilder::standard().with(register_select).build();
...
#[test]
fn test_user_placeholders() -> kuro_error::Result<()> {
    let env = Module::new();
