...
use kuro_artifact::deferred::key::DeferredHolderKey;
use kuro_build_api::actions::execute::dice_data::set_fallback_executor_config;
use kuro_build_api::analysis::AnalysisResult;
use kuro_build_api::deferred::calculation::DeferredCalculation;
use kuro_build_api::deferred::types::Deferred;
use kuro_build_api::deferred::types::DeferredCtx;
use kuro_build_api::deferred::types::DeferredInput;
use kuro_build_api::deferred::types::DeferredInputsRef;
use kuro_build_api::deferred::types::DeferredOutput;
use kuro_build_api::deferred::types::DeferredRegistry;
use kuro_build_api::deferred::types::DeferredValue;
use kuro_common::dice::data::testing::SetTestingIoProvider;
use kuro_configured::nodes::calculation::ConfiguredTargetNodeKey;
use kuro_core::base_deferred_key::BaseDeferredKey;
...
impl Deferred for FakeDeferred {
    ...
    ) -> kuro_error::Result<DeferredValue<Self::Output>> {
...
#[tokio::test]
async fn lookup_deferred_from_analysis() -> kuro_error::Result<()> {
    let target =
...
#[tokio::test]
async fn lookup_deferred_that_has_deferreds() -> kuro_error::Result<()> {
    #[derive(Debug, Allocative)]
