...
#[test]
fn source_artifact() -> kuro_error::Result<()> {
...
#[test]
fn bound_artifact() -> kuro_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(kuro_build_api::interpreter::rule_defs::register_rule_defs);
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
            r#"
...
#[test]
fn declared_artifact() -> kuro_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn output_artifact() -> kuro_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
        r#"
...
#[test]
fn declared_bound() -> kuro_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(kuro_build_api::interpreter::rule_defs::register_rule_defs);
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
...
#[test]
fn project_declared_artifact() -> kuro_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
            r#"
...
#[test]
fn stringifies_for_command_line() -> kuro_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
            r#"
...
#[test]
fn bound_artifact_with_associated_artifacts() -> kuro_error::Result<()> {
    let mut tester = Tester::new()?;
    tester.additional_globals(kuro_build_api::interpreter::rule_defs::register_rule_defs);
    tester.additional_globals(artifactory);
    tester.run_starlark_bzl_test(indoc!(
