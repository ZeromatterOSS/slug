...
#[test]
fn displays_correctly() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    tester.run_starlark_bzl_test(indoc!(
        r#"
        def test():
...
#[test]
fn test_relative_absolute_old() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_relative_absolute() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_relative_to_propagated_up_and_down() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_relative_to_does_not_affect_new_artifacts() -> kuro_error::Result<()> {
    let mut tester = tester().unwrap();
    let content = indoc!(
        r#"
        def test():
...
#[test]
fn test_parent() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_parent_n() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_parent_n_too_many_parents() -> kuro_error::Result<()> {
    let mut tester = tester()?;
...
#[test]
fn test_parent_n_parent_type() -> kuro_error::Result<()> {
    let mut tester = tester()?;
...
#[test]
fn test_format() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_joined_with_empty_args() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_inputs_outputs() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    tester.run_starlark_bzl_test(indoc!(
        r#"
        artifact1 = source_artifact("foo", "bar/baz.h")
...
#[test]
fn test_ignore_artifacts() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    tester.run_starlark_bzl_test(indoc!(
        r#"
        def norm(xs):
...
#[test]
fn test_frozen_inputs_outputs() -> kuro_error::Result<()> {
    let mut tester = tester()?;
...
#[test]
fn test_quote_style_shell() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_prepend() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_list_list() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_concat() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_replace_regex() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_replace_regex_old() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
...
#[test]
fn test_replace_regex_regex() -> kuro_error::Result<()> {
    let mut tester = tester()?;
    let contents = indoc!(
        r#"
        def test():
