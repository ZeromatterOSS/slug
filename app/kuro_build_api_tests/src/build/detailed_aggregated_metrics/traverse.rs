...
mod tests {
    ...
    use kuro_build_api::build::detailed_aggregated_metrics::testing::traverse_partial_action_graph;
    ...
    use kuro_core::deferred::dynamic::DynamicLambdaIndex;
    ...
    impl Builder {
        ...
        fn artifact_for_key(&self, key: &ActionKey) -> BuildArtifact {
            BuildArtifact::new(
                ...
                key.dupe(),
                kuro_execute::execute::request::OutputType::File,
            )
            .unwrap()
        }
    ...
    #[test]
    fn test_empty_graph() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_single_action() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_diamond() -> kuro_error::Result<()> {
        let mut state = fxhash::FxHashMap::default();
    ...
    #[test]
    fn test_cycle() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_dynamic_node_analysis_missing() -> kuro_error::Result<()> {
        let mut state = fxhash::FxHashMap::default();
    ...
    /*
    #[test]
    fn test_tset() -> kuro_error::Result<()> {
        let mut state = fxhash::FxHashMap::default();
