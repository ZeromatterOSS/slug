...
) -> kuro_error::Result<BuckOutPathData> {
...
impl BuckOutPathParser {
    ...
    pub(crate) fn parse(&self, output_path: &str) -> kuro_error::Result<BuckOutPathType> {
    ...
    ) -> kuro_error::Result<BuckOutPathType> {
        ...
        match iter.next() {
            Some(part) => {
                let result = match part.as_str() {
                    ...
                    _ => Err(kuro_error!(
                        kuro_error::ErrorTag::InvalidBuckOutPath,
...
mod tests {
    ...
    #[test]
    fn test_target_output() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_target_content_based_output() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_target_output_with_slashes() -> kuro_error::Result<()> {
        let (buck_out_parser, expected_config_hash, expected_target_label, expected_cell_path) =
            get_test_data();
    ...
    #[test]
    fn test_target_output_with_eq_sign() -> kuro_error::Result<()> {
        let (buck_out_parser, expected_config_hash, expected_target_label, expected_cell_path) =
            get_test_data();
    ...
    #[test]
    fn test_tmp_output() -> kuro_error::Result<()> {
        let (buck_out_parser, expected_config_hash, expected_target_label, expected_cell_path) =
            get_test_data();
    ...
    #[test]
    fn test_tmp_content_based_output() -> kuro_error::Result<()> {
        let (buck_out_parser, _expected_config_hash, expected_target_label, expected_cell_path) =
            get_test_data();
    ...
    #[test]
    fn test_test_output() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_anon_output() -> kuro_error::Result<()> {
        let (buck_out_parser, expected_config_hash, expected_target_label, expected_cell_path) =
            get_test_data();
    ...
    #[test]
    fn test_anon_content_based_output() -> kuro_error::Result<()> {
        let (buck_out_parser, _expected_config_hash, expected_target_label, expected_cell_path) =
            get_test_data();
    ...
    #[test]
    fn test_bxl_output() -> kuro_error::Result<()> {
        let (buck_out_parser, expected_config_hash, _, _) = get_test_data();
    ...
    #[test]
    fn test_bxl_content_based_output() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_empty_package_path() -> kuro_error::Result<()> {
        let (buck_out_parser, expected_config_hash, _, _) = get_test_data();
