...
use dupe::Dupe;
use slug_cli_proto::new_generic::DocsOutputFormat;
use slug_cli_proto::new_generic::DocsRequest;
use slug_cli_proto::new_generic::DocsStarlarkRequest;
...
impl StreamingCommand for DocsStarlarkCommand {
    ...
    async fn exec_impl(
        ...
        let response = buckd
            ...
            .new_generic(
                client_context,
                slug_cli_proto::new_generic::NewGenericRequest::Docs(DocsRequest::Starlark(
                    DocsStarlarkRequest {
        ...
        let slug_cli_proto::new_generic::NewGenericResponse::Docs(response) = response else {
            return slug_error!(
        ...
        if let Some(json_output) = response.json_output {
            slug_client_ctx::println!("{}", json_output.trim_end())?;
        }
