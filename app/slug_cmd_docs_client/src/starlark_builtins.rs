...
use slug_cli_proto::new_generic::DocsStarlarkBuiltinsRequest;
...
///
/// This command is designed to support slug's doc generation and does not have stable output.
...
impl StreamingCommand for StarlarkBuiltinsCommand {
    ...
    async fn exec_impl(
        ...
        let response = buckd
            ...
            .new_generic(
                client_context,
                slug_cli_proto::new_generic::NewGenericRequest::Docs(
        ...
        let slug_cli_proto::new_generic::NewGenericResponse::Docs(_) = response else {
