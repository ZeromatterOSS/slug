...
pub use kuro_env::env;
pub use kuro_env::soft_error as error;
...
// Re-export macros from kuro_env so they're available at the crate root
pub use kuro_env::env::kuro_env;
pub use kuro_env::env::kuro_env_name;
...
#[doc(inline)]
pub use kuro_env::soft_error::tag_error;
#[doc(inline)]
pub use kuro_env::soft_error::tag_result;
