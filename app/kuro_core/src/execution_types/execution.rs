...
impl ExecutionPlatformResolution {
    ...
    // TODO(cjhopman): Should this be an kuro_error::Result and never return an invalid configuration?
    #[inline]
    ...
    pub fn platform(&self) -> kuro_error::Result<&ExecutionPlatform> {
        match &self.platform {
            Some(v) => Ok(v),
    ...
    pub fn executor_config(&self) -> kuro_error::Result<&Arc<CommandExecutorConfig>> {
