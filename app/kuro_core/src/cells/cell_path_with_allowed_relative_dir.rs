...
impl CellPathWithAllowedRelativeDir {
    ...
    pub fn join_normalized(&self, path: &RelativePath) -> kuro_error::Result<CellPath> {
...
mod tests {
    ...
    #[test]
    fn parent_directory_traversal() -> kuro_error::Result<()> {
    ...
    #[test]
    fn multiple_parent_directory_traversal() -> kuro_error::Result<()> {
        let import = "../../foo.bzl";
        let cell_path_with_allowed_relative_dir = CellPathWithAllowedRelativeDir {
    ...
    #[test]
    fn parent_directory_with_subpath() -> kuro_error::Result<()> {
    ...
    #[test]
    fn traversal_out_of_allowed_dir() -> kuro_error::Result<()> {
    ...
    #[test]
    fn nonleading_parent_dir_component() -> kuro_error::Result<()> {
