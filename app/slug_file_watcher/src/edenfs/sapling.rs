...
pub(crate) async fn get_mergebase<D: AsRef<Path>, C: AsRef<str>, M: AsRef<str>>(
    ...
    commit: C,
    mergegase_with: M,
) -> slug_error::Result<Option<MergebaseDetails>> {
...
fn parse_log_output(output: Vec<u8>) -> slug_error::Result<Option<MergebaseDetails>> {
...
pub(crate) async fn get_status<D: AsRef<Path>, F: AsRef<str>, S: AsRef<str>>(
    ...
    second: Option<S>,
    limit_results: usize,
) -> slug_error::Result<SaplingGetStatusResult> {
...
fn process_one_status_line(line: &str) -> slug_error::Result<Option<(SaplingStatus, String)>> {
...
mod tests {
    ...
    #[test]
    fn test_hg_status_line() -> slug_error::Result<()> {
        assert_eq!(
            process_one_status_line("M slug/app/slug_file_watcher/src/edenfs/sapling.rs")?,
            Some((
                SaplingStatus::Modified,
                "slug/app/slug_file_watcher/src/edenfs/sapling.rs".to_owned()
            ))
        );

        assert_eq!(
            process_one_status_line("A slug/app/slug_file_watcher/src/edenfs/interface.rs")?,
            Some((
                SaplingStatus::Added,
                "slug/app/slug_file_watcher/src/edenfs/interface.rs".to_owned()
            ))
        );

        assert_eq!(
            process_one_status_line("R slug/app/slug_file_watcher/src/edenfs/utils.rs")?,
            Some((
                SaplingStatus::Removed,
                "slug/app/slug_file_watcher/src/edenfs/utils.rs".to_owned()
            ))
        );

        assert_eq!(
            process_one_status_line("! slug/app/slug_file_watcher/src/edenfs/sapling.rs")?,
            Some((
        ...
        assert_eq!(
            process_one_status_line("C slug/app/slug_file_watcher/src/edenfs/sapling.rs")?,
            Some((
                SaplingStatus::Clean,
                "slug/app/slug_file_watcher/src/edenfs/sapling.rs".to_owned()
            ))
        ...
        assert_eq!(
            process_one_status_line("I slug/app/slug_file_watcher/src/edenfs/sapling.rs")?,
            Some((
        ...
        assert!(
            process_one_status_line("Mslug/app/slug_file_watcher/src/edenfs/sapling.rs").is_err()
        );

        // Malformed status (colon instead of space)
        assert!(
            process_one_status_line("M:slug/app/slug_file_watcher/src/edenfs/sapling.rs").is_err()
        );
    ...
    #[test]
    fn test_parse_log_output() -> slug_error::Result<()> {
        // the format is {node}\n{date}\n{global_rev}
        let output =
    ...
    #[test]
    fn test_parse_log_output_no_global_rev() -> slug_error::Result<()> {
