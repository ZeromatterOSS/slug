...
impl BuildGraphStats {
    ...
    async fn handle_build_response(
        &self,
        res: &kuro_cli_proto::BuildResponse,
    ) -> kuro_error::Result<()> {
            ...
            .map(|ts| {
                kuro_events::BuckEvent::new(
                    ...
                    kuro_data::RecordEvent {
                        data: Some(
                            kuro_data::BuildGraphStats {
                                build_targets: ts
                                    .iter()
                                    .map(|t| kuro_data::BuildTarget {
    ...
    async fn send_events(&self, events: Vec<kuro_events::BuckEvent>) {
...
mod tests {
    ...
    fn build_graph_stats_normal(fb: FacebookInit) {
        let res = kuro_cli_proto::BuildResponse {
            build_targets: vec![
                kuro_cli_proto::BuildTarget {
        ...
        let event_expected = kuro_data::BuckEvent {
            data: Some(kuro_data::buck_event::Data::Record(
                kuro_data::RecordEvent {
                    data: Some(kuro_data::record_event::Data::BuildGraphStats(
                        kuro_data::BuildGraphStats {
                            build_targets: vec![
                                kuro_data::BuildTarget {
                                    target: "//some/target:A".to_owned(),
                                    configuration: "//some/conf:A".to_owned(),
                                    configured_graph_size: Some(123),
                                },
    ...
    fn build_graph_stats_too_long_targets(fb: FacebookInit) {
        let build_target = kuro_cli_proto::BuildTarget {
            target: "T".to_owned(),
        ...
        let build_target = kuro_data::BuildTarget {
            target: "T".to_owned(),
            configuration: "C".to_owned(),
            configured_graph_size: Some(1),
        };
        ...
        let event_expected_3000 = kuro_data::BuckEvent {
            data: Some(kuro_data::buck_event::Data::Record(
                kuro_data::RecordEvent {
                    data: Some(kuro_data::record_event::Data::BuildGraphStats(
                        kuro_data::BuildGraphStats {
        ...
        let event_expected_2 = kuro_data::BuckEvent {
            data: Some(kuro_data::buck_event::Data::Record(
                kuro_data::RecordEvent {
                    data: Some(kuro_data::record_event::Data::BuildGraphStats(
                        kuro_data::BuildGraphStats {
