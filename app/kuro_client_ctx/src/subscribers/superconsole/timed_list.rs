...
use kuro_event_observer::span_tracker::BuckEventSpanHandle;
use kuro_event_observer::span_tracker::BuckEventSpanTracker;
...
impl TimedListBody<'_> {
    ...
    fn draw_root(&self, root: &BuckEventSpanHandle) -> kuro_error::Result<Vec<TimedRow>> {
...
mod tests {
    ...
    #[test]
    fn test_normal() -> kuro_error::Result<()> {
        let tick = Tick::now();
        ...
        let label = Arc::new(BuckEvent::new(
            ...
            kuro_data::buck_event::Data::SpanStart(SpanStartEvent {
                data: Some(kuro_data::span_start_event::Data::Fake(FakeStart {
    ...
    #[test]
    fn test_remaining() -> kuro_error::Result<()> {
        let tick = Tick::now();
    ...
    #[tokio::test]
    async fn test_remaining_with_pending() -> kuro_error::Result<()> {
        let tick = Tick::now();
    ...
    #[test]
    fn test_children() -> kuro_error::Result<()> {
        let tick = Tick::now();
        ...
        let prepare = Arc::new(BuckEvent::new(
            ...
            SpanStartEvent {
                data: Some(
                    kuro_data::ExecutorStageStart {
                        stage: Some(kuro_data::PrepareAction {}.into()),
                    }
                    .into(),
                ),
            }
    ...
    fn span_start_event(parent_span: Option<SpanId>, time: SystemTime) -> Arc<BuckEvent> {
        ...
        Arc::new(BuckEvent::new(
            ...
            SpanStartEvent {
                data: Some(
                    kuro_data::ActionExecutionStart {
                        key: Some(kuro_data::ActionKey {
                            id: Default::default(),
