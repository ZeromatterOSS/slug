...
use kuro_event_observer::progress::BuildProgressPhaseStats;
use kuro_event_observer::progress::BuildProgressStats;
...
mod tests {
    ...
    #[test]
    fn test_different_sizes_dont_fail() -> kuro_error::Result<()> {
    ...
    #[test]
    fn test_rendering_golden() -> kuro_error::Result<()> {
        ...
        for width in [30, 40, 60, 80, 100, 129, 130, 140, 160] {
            ...
            .map_err(|e| from_any_with_tag(e, kuro_error::ErrorTag::SuperConsole))?;
        }
    ...
    #[test]
    fn test_remaining_with_pending() -> kuro_error::Result<()> {
        let action_stats = ActionStats {
            local_actions: 0,
            remote_actions: 0,
            cached_actions: 0,
    ...
    #[test]
    fn test_simple_header_final() -> kuro_error::Result<()> {
        let action_stats = ActionStats {
            local_actions: 0,
            remote_actions: 0,
            cached_actions: 1,
