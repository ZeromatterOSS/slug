...
use kuro_event_observer::event_observer::NoopEventObserverExtra;
...
pub fn get_console_with_root(
    ...
    let result: kuro_error::Result<Box<dyn EventSubscriber>> = match console_type {
...
pub struct CommonConsoleOptions {
    #[clap(
        ...
        default_value = "auto",
        ignore_case = true,
        env = kuro_env_name!("BUCK_CONSOLE"),
    ...
    #[clap(
        ...
        env = kuro_env_name!(BUCK_NO_INTERACTIVE_CONSOLE),
...
impl CommonConsoleOptions {
    ...
    pub fn superconsole_config(&self) -> SuperConsoleConfig {
        let mut config = SuperConsoleConfig {
            expanded_progress: !kuro_env!("BUCK_DISABLE_EXPANDED_PROGRESS", bool).unwrap_or(false),
