...
use slug_build_api::interpreter::rule_defs::artifact::starlark_promise_artifact::StarlarkPromiseArtifact;
use slug_build_api::interpreter::rule_defs::provider::dependency::Dependency;
use slug_build_api::interpreter::rule_defs::resolved_macro::ResolvedStringWithMacros;
...
use slug_node::attrs::attr_type::dep::DepAttr;
use slug_node::attrs::attr_type::dep::DepAttrTransition;
use slug_node::attrs::attr_type::dict::DictAttrType;
use slug_node::attrs::attr_type::dict::DictLiteral;
use slug_node::attrs::attr_type::list::ListAttrType;
use slug_node::attrs::attr_type::list::ListLiteral;
use slug_node::attrs::attr_type::one_of::OneOfAttrType;
use slug_node::attrs::attr_type::string::StringLiteral;
use slug_node::attrs::attr_type::tuple::TupleAttrType;
...
pub trait AnonTargetAttrTypeCoerce {
    fn coerce_item(&self, ctx: &AnonAttrCtx, value: Value) -> slug_error::Result<AnonTargetAttr>;
}
...
pub(crate) enum AnonTargetCoercionError {
    ...
    #[slug(tag = Input)]
    OneOfMany(Vec<slug_error::Error>),
...
impl AnonTargetCoercionError {
    ...
    pub fn one_of_many(mut errs: Vec<slug_error::Error>) -> slug_error::Error {
        if errs.is_empty() {
...
fn to_anon_target_any(value: Value, ctx: &AnonAttrCtx) -> slug_error::Result<AnonTargetAttr> {
    if value.is_none() {
        Ok(AnonTargetAttr::None)
