...
use slug_core::deferred::base_deferred_key::PathResolutionError;
...
use slug_data::action_key_owner::BaseDeferredKeyProto;
...
impl AnonTarget {
    pub(crate) fn as_proto(&self) -> slug_data::AnonTarget {
        slug_data::AnonTarget {
...
impl AnonTargetDyn for AnonTarget {
    ...
    ) -> slug_error::Result<ValueOfUncheckedGeneric<Value<'v>, StructRef<'static>>> {
    ...
    ) -> slug_error::Result<HashMap<PromiseArtifactId, Artifact>> {
