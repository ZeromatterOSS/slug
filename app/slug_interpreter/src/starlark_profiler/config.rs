...
impl ProfileRegex {
    pub fn new(patterns: &[String]) -> slug_error::Result<Self> {
...
impl Key for StarlarkProfilerConfigurationResolvedKey {
    type Value = slug_error::Result<Arc<StarlarkProfilerConfigurationResolved>>;
...
impl ProjectionKey for StarlarkProfileModeForKind {
    ...
    type Value = slug_error::Result<StarlarkProfileMode>;

    fn compute(
        &self,
        configuration: &slug_error::Result<Arc<StarlarkProfilerConfigurationResolved>>,
        _ctx: &DiceProjectionComputations,
    ) -> slug_error::Result<StarlarkProfileMode> {
