...
pub struct ProfilerData {
    ...
    profile_data: Option<slug_error::Result<ProfileData>>,
}
...
impl ProfilerData {
    ...
    pub(crate) fn initialize(&mut self, eval: &mut Evaluator) -> slug_error::Result<bool> {
    ...
    ) -> slug_error::Result<Option<Arc<StarlarkProfileDataAndStats>>> {
