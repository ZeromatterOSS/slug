...
impl XcodeVersionInfo {
    ...
    pub fn new() -> slug_error::Result<Option<Self>> {
    ...
    pub(crate) fn from_plist(plist_path: &Path) -> slug_error::Result<Option<Self>> {
        ...
        let plist = match plist {
            ...
            Err(e) => {
                return Err(from_any_with_tag(e, slug_error::ErrorTag::Tier0)
