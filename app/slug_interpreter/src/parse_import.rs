...
mod tests {
    ...
    #[test]
    fn root_package() -> slug_error::Result<()> {
        assert_eq!(
    ...
    #[test]
    fn cell_package() -> slug_error::Result<()> {
        assert_eq!(
    ...
    #[test]
    fn repository_root_file_shorthand() -> slug_error::Result<()> {
        assert_eq!(
    ...
    #[test]
    fn package_relative() -> slug_error::Result<()> {
        assert_eq!(
            path("cell1", "package/path", "import.bzl"),
            parse_import(
                &resolver(),
    ...
    #[test]
    fn missing_colon() -> slug_error::Result<()> {
    ...
    #[test]
    fn empty_filename() -> slug_error::Result<()> {
    ...
    #[test]
    fn bad_alias() -> slug_error::Result<()> {
    ...
    #[test]
    fn file_relative_import_given_relative_paths_allowed() -> slug_error::Result<()> {
        assert_eq!(
    ...
    #[test]
    fn cell_relative_import_given_relative_paths_allowed() -> slug_error::Result<()> {
    ...
    #[test]
    fn regular_import_given_relative_paths_allowed() -> slug_error::Result<()> {
        assert_eq!(
            path("cell1", "package/path", "import.bzl"),
            parse_import(
                &resolver(),
    ...
    #[test]
    fn allows_non_at_symbols() -> slug_error::Result<()> {
        assert_eq!(
            path("cell1", "package/path", "import.bzl"),
    ...
    #[test]
    fn fails_relative_import_if_disallowed() -> slug_error::Result<()> {
