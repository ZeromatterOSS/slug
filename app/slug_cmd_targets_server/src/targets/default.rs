...
//! Server-side implementation of `slug targets` command
...
use slug_cli_proto::targets_request::TargetHashFileMode;
...
use slug_node::nodes::lookup::ConfiguredTargetNodeLookup;
use slug_node::nodes::lookup::TargetNodeLookup;
    ...
    let target_hashes = dice
        ...
        .with_linear_recompute(|linear_ctx| async move {
            match hash_options.graph_type {
                TargetHashGraphType::Configured => slug_error::Ok(Some(
