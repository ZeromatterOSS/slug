...
impl TargetNode {
    ...
    pub fn visibility(&self) -> slug_error::Result<&VisibilitySpecification> {
    ...
    /// definition's* package, not the BUILD file's. Slug doesn't track dep
    ...
    pub fn attr<'a>(
        ...
        key: &str,
        opts: AttrInspectOptions,
    ) -> slug_error::Result<Option<CoercedAttrFull<'a>>> {
    ...
    pub fn tests(&self) -> impl Iterator<Item = &ProvidersLabel> {
        ...
        impl<'a> CoercedAttrTraversal<'a> for TestCollector<'a> {
            fn input(&mut self, _path: SourcePathRef) -> slug_error::Result<()> {
                Ok(())
            }

            fn dep(&mut self, _dep: &ProvidersLabel) -> slug_error::Result<()> {
                Ok(())
            }

            fn label(&mut self, label: &'a ProvidersLabel) -> slug_error::Result<()> {
    ...
    #[inline]
    pub fn metadata(&self) -> slug_error::Result<Option<&MetadataMap>> {
...
impl<'a> TargetNodeRef<'a> {
    ...
    pub fn metadata(self) -> slug_error::Result<Option<&'a MetadataMap>> {
    ...
    pub fn target_modifiers(self) -> slug_error::Result<Option<&'a TargetModifiersValue>> {
