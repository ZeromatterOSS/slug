...
impl StringWithMacros<ConfiguredProvidersLabel> {
    pub fn concat(
        self,
        items: impl Iterator<Item = slug_error::Result<Self>>,
...
impl StringWithMacros<ProvidersLabel> {
    ...
    ) -> slug_error::Result<ConfiguredStringWithMacros> {
        match self {
...
impl MacroBase<ProvidersLabel> {
    pub fn configure(
        &self,
        ctx: &dyn AttrConfigurationContext,
    ) -> slug_error::Result<ConfiguredMacro> {
        Ok(match self {
...
impl StringWithMacrosPart<ProvidersLabel> {
    pub(crate) fn configure(
        &self,
        ctx: &dyn AttrConfigurationContext,
    ) -> slug_error::Result<ConfiguredStringWithMacrosPart> {
        match self {
