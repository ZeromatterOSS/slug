...
use kuro_node::nodes::eval_result::is_generated_target;
...
impl ServerCommandTemplate for CompleteServerCommand {
    type StartEvent = kuro_data::CompleteCommandStart;
    type EndEvent = kuro_data::CompleteCommandEnd;
    type Response = kuro_cli_proto::new_generic::CompleteResponse;
