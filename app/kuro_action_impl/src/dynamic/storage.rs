...
use kuro_build_api::dynamic::storage::DynamicLambdaParamStorages;
use kuro_build_api::dynamic::storage::DynamicLambdaParamsStorage;
use kuro_build_api::dynamic::storage::FrozenDynamicLambdaParamsStorage;
...
impl<'v> DynamicLambdaParamsStorageImpl<'v> {
    ...
    ) -> kuro_error::Result<&'a mut DynamicLambdaParamsStorageImpl<'v>> {
        storage
            .lambda_params
            .as_any_mut()
            .downcast_mut()
    ...
    pub fn next_dynamic_actions_key(&self) -> kuro_error::Result<DynamicLambdaResultsKey> {
...
impl FrozenDynamicLambdaParamsStorageImpl {
    pub(crate) fn lookup_lambda<'f>(
        ...
        key: &DynamicLambdaResultsKey,
    ) -> kuro_error::Result<OwnedRefFrozenRef<'f, FrozenDynamicLambdaParams>> {
