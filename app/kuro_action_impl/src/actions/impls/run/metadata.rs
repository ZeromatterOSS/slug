...
use kuro_execute::execute::paths_with_digest::PathsWithDigestBlobData;
use kuro_execute::execute::paths_with_digest::PathsWithDigestBuilder;

pub(crate) fn metadata_content(
    fs: &ArtifactFs,
    inputs: &[&ArtifactGroupValues],
    digest_config: DigestConfig,
) -> kuro_error::Result<(PathsWithDigestBlobData, TrackedFileDigest)> {
