...
pub use kuro_test_proto::CasDigest;
pub use kuro_test_proto::ExecutionDetails;
...
pub struct ExecutionResult2 {
    ...
    pub max_memory_used_bytes: Option<u64>,
    /// We don't try to convert this field, mostly because it shares with kuro.data, and that
