...
use slug_cli_proto::UqueryRequest;
use slug_cli_proto::UqueryResponse;
...
Run `slug docs uquery` or
",
        if_else_opensource!(
            "https://slug.build/docs/users/query/uquery/",
            "https://www.internalfb.com/intern/staticdocs/slug/docs/users/query/uquery/",
        ),
        r#"
...
`slug uquery //java/com/example/app:amazing --output-all-attributes

List the deps of a target (special characters in a target will require quotes):
`slug uquery 'deps("//java/com/example/app:amazing+more")'`
