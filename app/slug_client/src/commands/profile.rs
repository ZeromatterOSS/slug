...
use slug_cli_proto::BxlProfile;
use slug_cli_proto::ProfileRequest;
use slug_cli_proto::ProfileResponse;
use slug_cli_proto::TargetProfile;
use slug_cli_proto::profile_request::ProfileOpts;
use slug_cli_proto::target_profile;
...
use slug_client_ctx::common::profiling::BuckProfileMode;
...
impl StreamingCommand for ProfileSubcommand {
    ...
    async fn exec_impl(
        ...
        let elapsed = elapsed
            ...
            .and_then(|d| {
                Duration::try_from(d).map_err(|_| {
                    slug_error::slug_error!(slug_error::ErrorTag::Input, "Duration is negative")
                })
            })
        ...
        slug_client_ctx::println!("Elapsed: {:.3}s", elapsed.as_secs_f64())?;
        slug_client_ctx::println!("Total retained bytes: {}", total_retained_bytes)?;
