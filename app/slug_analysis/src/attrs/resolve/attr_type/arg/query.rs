...
use dupe::Dupe;
use slug_build_api::interpreter::rule_defs::resolve_query_macro::ResolvedQueryMacro;
use slug_build_api::interpreter::rule_defs::resolve_query_macro::ResolvedQueryMacroTargetAndOutputs;
...
pub(crate) trait ConfiguredQueryMacroBaseExt {
    ...
    ) -> slug_error::Result<ResolvedQueryMacro>;
}
