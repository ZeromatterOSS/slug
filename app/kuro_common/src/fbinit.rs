...
fn run_init() -> FacebookInit {
    ...
    #[cfg(fbcode_build)]
    {
        ...
        // There are two sources of log spew when building kuro with Buck and linking against fbcode:
...
///     function is primarily intended for a very early point in kuro's lifecycle where fbinit
