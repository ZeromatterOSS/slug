...
impl<Kind: CasDigestKind> CasDigest<Kind> {
    ...
    pub fn from_reader<R: Read>(reader: R, config: CasDigestConfig) -> kuro_error::Result<Self> {
...
impl<Kind: CasDigestKind> kuro_core::directory_digest::DirectoryDigest for TrackedCasDigest<Kind> {}
