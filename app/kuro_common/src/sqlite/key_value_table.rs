...
impl KeyValueSqliteTable {
    ...
    pub fn create_table(&self) -> kuro_error::Result<()> {
        let sql = format!(
            "CREATE TABLE {} (
    ...
    pub fn insert_all(&self, map: HashMap<String, String>) -> kuro_error::Result<()> {
        let sql = format!(
    ...
    pub fn read_all(&self) -> kuro_error::Result<HashMap<String, String>> {
    ...
    pub fn get(&self, key: &str) -> kuro_error::Result<Option<String>> {
