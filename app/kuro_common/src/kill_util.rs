...
mod unix {
    ...
    enum StoppedWaiting {
        Success,
        UnexpectedError(kuro_error::Error),
    }
...
mod tests {
    ...
    #[tokio::test]
    async fn test_graceful_termination() -> kuro_error::Result<()> {
    ...
    #[tokio::test]
    async fn test_sigkill_when_graceful_termination_fails() -> kuro_error::Result<()> {
        let dir = tempfile::tempdir()?;
