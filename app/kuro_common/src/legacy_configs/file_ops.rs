...
pub trait ConfigParserFileOps: Send + Sync {
    ...
    async fn read_dir(&mut self, path: &ConfigPath) -> kuro_error::Result<Vec<ConfigDirEntry>>;
}
...
mod tests {
    ...
    #[test]
    fn dir_with_file() -> kuro_error::Result<()> {
        let mut v = vec![];
    ...
    #[test]
    fn empty_dir() -> kuro_error::Result<()> {
        let mut v = vec![];
        let dir = tempfile::tempdir()?;
        let dir = AbsPath::new(dir.path())?;
    ...
    #[test]
    fn non_existent_dir() -> kuro_error::Result<()> {
        let mut v = vec![];
        let dir = tempfile::tempdir()?;
    ...
    #[test]
    fn dir_in_dir() -> kuro_error::Result<()> {
        let mut v = vec![];
        let dir = tempfile::tempdir()?;
        let dir = AbsPath::new(dir.path())?;
    ...
    #[test]
    fn dir_with_file_in_dir() -> kuro_error::Result<()> {
        let mut v = vec![];
        let dir = tempfile::tempdir()?;
        let dir = AbsPath::new(dir.path())?;
