...
impl CellsAggregator {
    ...
    pub(crate) fn make_cell_resolver(self) -> kuro_error::Result<CellResolver> {
...
mod tests {
    ...
    #[test]
    fn test_duplicate_paths() -> kuro_error::Result<()> {
