...
impl ResolvedItems {
    fn start_resolving(&mut self, section: &str, key: &str) -> kuro_error::Result<()> {
    ...
    fn drain_to(self, value: &mut BTreeMap<String, SectionBuilder>) -> kuro_error::Result<()> {
...
impl ConfigResolver {
    pub fn resolve(
        values: BTreeMap<String, SectionBuilder>,
    ) -> kuro_error::Result<SortedMap<String, LegacyBuckConfigSection>> {
    ...
    fn resolve_all(&mut self) -> kuro_error::Result<()> {
