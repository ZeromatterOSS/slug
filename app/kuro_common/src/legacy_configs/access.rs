...
impl LegacyBuckConfig {
    ...
    fn parse_impl<T: FromStr>(key: BuckconfigKeyRef, value: &str) -> kuro_error::Result<T>
    where
    ...
    pub fn parse<T: FromStr>(&self, key: BuckconfigKeyRef) -> kuro_error::Result<Option<T>>
    where
        kuro_error::Error: From<<T as FromStr>::Err>,
    {
    ...
    pub fn parse_list<T: FromStr>(
        &self,
        key: BuckconfigKeyRef,
    ) -> kuro_error::Result<Option<Vec<T>>>
    where
        kuro_error::Error: From<<T as FromStr>::Err>,
    {
