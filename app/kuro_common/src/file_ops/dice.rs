...
impl DiceFileComputations {
    ...
    pub async fn is_ignored(
        ctx: &mut DiceComputations<'_>,
        path: CellPathRef<'_>,
    ) -> kuro_error::Result<FileIgnoreResult> {
    ...
    pub async fn buildfiles(
        ctx: &mut DiceComputations<'_>,
        cell: CellName,
    ) -> kuro_error::Result<Arc<[FileNameBuf]>> {
...
impl FileChangeTracker {
    ...
    pub fn write_to_dice(mut self, ctx: &mut DiceTransactionUpdater) -> kuro_error::Result<()> {
...
pub struct ReadFileProxy(
    #[allocative(skip)]
    Arc<dyn Fn() -> BoxFuture<'static, kuro_error::Result<Option<String>>> + Send + Sync>,
);
...
impl ReadFileProxy {
    ...
    where
        ...
        F: Future<Output = kuro_error::Result<Option<String>>> + Send + 'static,
    {
...
impl Key for ReadFileKey {
    type Value = kuro_error::Result<ReadFileProxy>;
    async fn compute(
        &self,
...
impl Key for ReadDirKey {
    type Value = kuro_error::Result<ReadDirOutput>;
    async fn compute(
        &self,
        ctx: &mut DiceComputations,
        _cancellations: &CancellationContext,
...
impl Key for ExistsMatchingExactCaseKey {
    type Value = kuro_error::Result<bool>;
    async fn compute(
        &self,
        ctx: &mut DiceComputations,
        _cancellations: &CancellationContext,
...
impl Key for PathMetadataKey {
    type Value = kuro_error::Result<Option<RawPathMetadata>>;
    async fn compute(
        &self,
        ctx: &mut DiceComputations,
        _cancellations: &CancellationContext,
