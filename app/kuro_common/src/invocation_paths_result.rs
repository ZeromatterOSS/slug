...
pub enum InvocationPathsResult {
    OtherError(kuro_error::Error),
    Paths(InvocationPaths),
    OutsideOfRepo(kuro_error::Error), // this error ignored for creating invocation record for log commands
}

impl InvocationPathsResult {
    pub fn get_result(self) -> kuro_error::Result<InvocationPaths> {
        match self {
