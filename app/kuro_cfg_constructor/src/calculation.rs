...
use kuro_node::cfg_constructor::CfgConstructorCalculationImpl;
...
) -> kuro_error::Result<Option<Arc<dyn CfgConstructorImpl>>> {
...
async fn get_cfg_constructor(
    ...
    impl Key for GetCfgConstructorKey {
        type Value = kuro_error::Result<Option<Arc<dyn CfgConstructorImpl>>>;
