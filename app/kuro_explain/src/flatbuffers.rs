...
) -> kuro_error::Result<FlatBufferBuilder<'static>> {
...
fn target_to_fbs<'a>(
    ...
    data: &'_ TargetData,
) -> kuro_error::Result<WIPOffset<fbs::ConfiguredTargetNode<'a>>> {
    let node = &data.node;
...
mod tests {
    ...
    use kuro_interpreter_for_build::call_stack::StarlarkCallStackWrapper;
    ...
    use kuro_node::call_stack::StarlarkCallStack;
    ...
    fn gen_data(
        attrs: Vec<(
            &str,
            kuro_node::attrs::attr::Attribute,
            kuro_node::attrs::coerced_attr::CoercedAttr,
        )>,
