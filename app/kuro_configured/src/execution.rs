...
use kuro_core::execution_types::execution::ExecutionPlatformError;
use kuro_core::execution_types::execution::ExecutionPlatformIncompatibleReason;
use kuro_core::execution_types::execution::ExecutionPlatformResolution;
use kuro_core::execution_types::execution_platforms::ExecutionPlatformFallback;
use kuro_core::execution_types::execution_platforms::ExecutionPlatforms;
use kuro_core::execution_types::execution_platforms::ExecutionPlatformsData;
...
use kuro_node::attrs::spec::internal::EXEC_COMPATIBLE_WITH_ATTRIBUTE;
...
impl ToolchainExecutionPlatformCompatibilityKey {
    async fn compute_impl(
        &self,
        ctx: &mut DiceComputations<'_>,
    ) -> kuro_error::Result<Result<(), ExecutionPlatformIncompatibleReason>> {
...
impl Key for ToolchainExecutionPlatformCompatibilityKey {
    type Value = kuro_error::Result<Result<(), ExecutionPlatformIncompatibleReason>>;
    async fn compute(
        &self,
...
) -> kuro_error::Result<MaybeCompatible<ExecutionPlatformResolution>> {
...
async fn get_execution_platforms_enabled(
    ctx: &mut DiceComputations<'_>,
) -> kuro_error::Result<ExecutionPlatforms> {
...
impl Key for ExecutionPlatformResolutionKey {
    type Value = kuro_error::Result<ExecutionPlatformResolution>;
...
impl Key for ExecutionPlatformsKey {
    type Value = kuro_error::Result<Option<ExecutionPlatforms>>;
    async fn compute(
        &self,
        ctx: &mut DiceComputations,
        _cancellation: &CancellationContext,
