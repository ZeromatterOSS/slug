...
) -> slug_error::Result<ConfigSectionAndKey> {
...
impl LegacyBuckConfig {
    ...
    pub fn from_overrides_only(
        args: &[slug_cli_proto::ConfigOverride],
...
pub mod testing {
    ...
    pub fn parse(_data: &[(&str, &str)], _path: &str) -> slug_error::Result<LegacyBuckConfig> {
...
pub(crate) mod tests {
    ...
    #[test]
    fn test_config_args_ordering() -> slug_error::Result<()> {
        let config_args = vec![
    ...
    #[test]
    fn test_config_args_empty() -> slug_error::Result<()> {
    ...
    #[test]
    fn test_config_args_cli_flag_wins() -> slug_error::Result<()> {
    ...
    #[test]
    fn test_section_and_key() -> slug_error::Result<()> {
        // Valid Formats
    ...
    #[test]
    fn test_config_args_cell_in_value() -> slug_error::Result<()> {
    ...
    #[test]
    fn test_from_overrides_only_basic() -> slug_error::Result<()> {
        let args = vec![
    ...
    #[test]
    fn test_from_overrides_only_last_wins() -> slug_error::Result<()> {
        let args = vec![
    ...
    #[test]
    fn test_from_overrides_only_empty_value_unsets() -> slug_error::Result<()> {
        let args = vec![
            ConfigOverride::flag_no_cell("section.key=value"),
    ...
    #[test]
    fn test_from_overrides_only_skips_file_args() -> slug_error::Result<()> {
        let args = vec![
            ConfigOverride::flag_no_cell("section.key=value"),
