...
impl LegacyBuckConfig {
    ...
    fn parse_impl<T: FromStr>(key: BuckconfigKeyRef, value: &str) -> slug_error::Result<T>
    where
    ...
    pub fn parse<T: FromStr>(&self, key: BuckconfigKeyRef) -> slug_error::Result<Option<T>>
    where
        slug_error::Error: From<<T as FromStr>::Err>,
    {
    ...
    pub fn parse_list<T: FromStr>(
        &self,
        key: BuckconfigKeyRef,
    ) -> slug_error::Result<Option<Vec<T>>>
    where
        slug_error::Error: From<<T as FromStr>::Err>,
    {
