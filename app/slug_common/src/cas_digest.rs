...
impl<Kind: CasDigestKind> CasDigest<Kind> {
    ...
    pub fn from_reader<R: Read>(reader: R, config: CasDigestConfig) -> slug_error::Result<Self> {
...
impl<Kind: CasDigestKind> slug_core::directory_digest::DirectoryDigest for TrackedCasDigest<Kind> {}
