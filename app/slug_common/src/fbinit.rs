...
fn run_init() -> FacebookInit {
    ...
    #[cfg(fbcode_build)]
    {
        ...
        // There are two sources of log spew when building slug with Buck and linking against fbcode:
...
///     function is primarily intended for a very early point in slug's lifecycle where fbinit
