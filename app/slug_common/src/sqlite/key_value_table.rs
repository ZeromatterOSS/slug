...
impl KeyValueSqliteTable {
    ...
    pub fn create_table(&self) -> slug_error::Result<()> {
        let sql = format!(
            "CREATE TABLE {} (
    ...
    pub fn insert_all(&self, map: HashMap<String, String>) -> slug_error::Result<()> {
        let sql = format!(
    ...
    pub fn read_all(&self) -> slug_error::Result<HashMap<String, String>> {
    ...
    pub fn get(&self, key: &str) -> slug_error::Result<Option<String>> {
