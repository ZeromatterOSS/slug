...
pub enum InvocationPathsResult {
    OtherError(slug_error::Error),
    Paths(InvocationPaths),
    OutsideOfRepo(slug_error::Error), // this error ignored for creating invocation record for log commands
}

impl InvocationPathsResult {
    pub fn get_result(self) -> slug_error::Result<InvocationPaths> {
        match self {
