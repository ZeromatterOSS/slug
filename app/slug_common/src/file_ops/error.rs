...
impl FileReadError {
    pub fn with_package_context_information(self, package_path: String) -> slug_error::Error {
        match self {
    ...
    pub fn without_package_context_information(self) -> slug_error::Error {
        match self {
...
pub trait FileReadErrorContext<T> {
    fn with_package_context_information(self, package_path: String) -> slug_error::Result<T>;
    fn without_package_context_information(self) -> slug_error::Result<T>;
}
