...
pub fn process_exists(pid: Pid) -> kuro_error::Result<bool> {
...
pub fn kill(pid: Pid) -> kuro_error::Result<Option<KilledProcessHandle>> {
    match imp::kill(pid)? {
...
impl KilledProcessHandle {
    pub fn has_exited(&self) -> kuro_error::Result<bool> {
