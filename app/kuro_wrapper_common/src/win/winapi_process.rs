...
impl WinapiProcessHandle {
    ...
    pub(crate) fn terminate(&self) -> kuro_error::Result<()> {
        unsafe {
    ...
    pub(crate) fn process_creation_time(&self) -> kuro_error::Result<Duration> {
    ...
    fn exit_code(&self) -> kuro_error::Result<Option<u32>> {
        let mut exit_code = 0;
    ...
    pub(crate) fn has_exited(&self) -> kuro_error::Result<bool> {
