...
pub trait TargetsServerCommands: Send + Sync + 'static {
    async fn targets(
        ...
        req: kuro_cli_proto::TargetsRequest,
    ) -> kuro_error::Result<kuro_cli_proto::TargetsResponse>;
    async fn targets_show_outputs(
        &self,
        ctx: &dyn ServerCommandContextTrait,
        partial_result_dispatcher: PartialResultDispatcher<NoPartialResult>,
        req: kuro_cli_proto::TargetsRequest,
    ) -> kuro_error::Result<kuro_cli_proto::TargetsShowOutputsResponse>;
    async fn ctargets(
        &self,
        ctx: &dyn ServerCommandContextTrait,
        partial_result_dispatcher: PartialResultDispatcher<NoPartialResult>,
        req: kuro_cli_proto::ConfiguredTargetsRequest,
    ) -> kuro_error::Result<kuro_cli_proto::ConfiguredTargetsResponse>;
}
...
pub trait QueryServerCommands: Send + Sync + 'static {
    async fn uquery(
        ...
        ctx: &dyn ServerCommandContextTrait,
        partial_result_dispatcher: PartialResultDispatcher<kuro_cli_proto::StdoutBytes>,
        req: kuro_cli_proto::UqueryRequest,
    ) -> kuro_error::Result<kuro_cli_proto::UqueryResponse>;
    async fn cquery(
        &self,
        ctx: &dyn ServerCommandContextTrait,
        partial_result_dispatcher: PartialResultDispatcher<kuro_cli_proto::StdoutBytes>,
        req: kuro_cli_proto::CqueryRequest,
    ) -> kuro_error::Result<kuro_cli_proto::CqueryResponse>;
    async fn aquery(
        &self,
        ctx: &dyn ServerCommandContextTrait,
        partial_result_dispatcher: PartialResultDispatcher<kuro_cli_proto::StdoutBytes>,
        req: kuro_cli_proto::AqueryRequest,
    ) -> kuro_error::Result<kuro_cli_proto::AqueryResponse>;
}
...
pub trait DocsServerCommand: Send + Sync + 'static {
    async fn docs(
        ...
        ctx: &dyn ServerCommandContextTrait,
        partial_result_dispatcher: PartialResultDispatcher<NoPartialResult>,
        req: kuro_cli_proto::new_generic::DocsRequest,
    ) -> kuro_error::Result<kuro_cli_proto::new_generic::DocsResponse>;
}
