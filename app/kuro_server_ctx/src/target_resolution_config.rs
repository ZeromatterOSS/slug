...
use kuro_core::pattern::pattern::TargetLabelWithExtra;
...
impl TargetResolutionConfig {
    ...
    ) -> kuro_error::Result<TargetResolutionConfig> {
    ...
    ) -> kuro_error::Result<Vec<ConfiguredTargetLabel>> {
        match self {
    ...
    ) -> kuro_error::Result<Vec<ConfiguredProvidersLabel>> {
        Ok(self
