...
use slug_cmd_audit_client::subtargets::AuditSubtargetsCommand;
...
use slug_server_ctx::pattern_parse_and_resolve::parse_and_resolve_provider_labels_with_modifiers_from_cli_args;
            ...
            Ok(v) => {
                if recursive {
                    if json_format {
                        ...
                        ) -> slug_error::Result<serde_json::Value> {
