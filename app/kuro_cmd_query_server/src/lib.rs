...
use kuro_cli_proto::AqueryRequest;
use kuro_cli_proto::AqueryResponse;
use kuro_cli_proto::CqueryRequest;
use kuro_cli_proto::CqueryResponse;
use kuro_cli_proto::StdoutBytes;
use kuro_cli_proto::UqueryRequest;
use kuro_cli_proto::UqueryResponse;
use kuro_server_ctx::ctx::ServerCommandContextTrait;
use kuro_server_ctx::late_bindings::QueryServerCommands;
...
impl QueryServerCommands for QueryServerCommandsInstance {
    async fn uquery(
        ...
        req: UqueryRequest,
    ) -> kuro_error::Result<UqueryResponse> {
    ...
    async fn aquery(
        ...
        partial_result_dispatcher: PartialResultDispatcher<StdoutBytes>,
        req: AqueryRequest,
    ) -> kuro_error::Result<AqueryResponse> {
        aquery_command(ctx, partial_result_dispatcher, req).await
    }
}

pub fn init_late_bindings() {
    kuro_server_ctx::late_bindings::QUERY_SERVER_COMMANDS.init(&QueryServerCommandsInstance);
