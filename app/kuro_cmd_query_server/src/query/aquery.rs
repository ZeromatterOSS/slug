...
impl ServerCommandTemplate for AqueryServerCommand {
    type StartEvent = kuro_data::AqueryCommandStart;
    type EndEvent = kuro_data::AqueryCommandEnd;
    type Response = kuro_cli_proto::AqueryResponse;
...
async fn aquery(
    ...
    request: &kuro_cli_proto::AqueryRequest,
) -> kuro_error::Result<kuro_cli_proto::AqueryResponse> {
    ...
    let kuro_cli_proto::AqueryRequest {
        query, query_args, ..
    } = request;
    ...
    Ok(kuro_cli_proto::AqueryResponse {})
}
