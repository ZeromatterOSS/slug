...
pub trait TargetsServerCommands: Send + Sync + 'static {
    async fn targets(
        ...
        req: slug_cli_proto::TargetsRequest,
    ) -> slug_error::Result<slug_cli_proto::TargetsResponse>;
    async fn targets_show_outputs(
        &self,
        ctx: &dyn ServerCommandContextTrait,
        partial_result_dispatcher: PartialResultDispatcher<NoPartialResult>,
        req: slug_cli_proto::TargetsRequest,
    ) -> slug_error::Result<slug_cli_proto::TargetsShowOutputsResponse>;
    async fn ctargets(
        &self,
        ctx: &dyn ServerCommandContextTrait,
        partial_result_dispatcher: PartialResultDispatcher<NoPartialResult>,
        req: slug_cli_proto::ConfiguredTargetsRequest,
    ) -> slug_error::Result<slug_cli_proto::ConfiguredTargetsResponse>;
}
...
pub trait QueryServerCommands: Send + Sync + 'static {
    async fn uquery(
        ...
        ctx: &dyn ServerCommandContextTrait,
        partial_result_dispatcher: PartialResultDispatcher<slug_cli_proto::StdoutBytes>,
        req: slug_cli_proto::UqueryRequest,
    ) -> slug_error::Result<slug_cli_proto::UqueryResponse>;
    async fn cquery(
        &self,
        ctx: &dyn ServerCommandContextTrait,
        partial_result_dispatcher: PartialResultDispatcher<slug_cli_proto::StdoutBytes>,
        req: slug_cli_proto::CqueryRequest,
    ) -> slug_error::Result<slug_cli_proto::CqueryResponse>;
    async fn aquery(
        &self,
        ctx: &dyn ServerCommandContextTrait,
        partial_result_dispatcher: PartialResultDispatcher<slug_cli_proto::StdoutBytes>,
        req: slug_cli_proto::AqueryRequest,
    ) -> slug_error::Result<slug_cli_proto::AqueryResponse>;
}
...
pub trait DocsServerCommand: Send + Sync + 'static {
    async fn docs(
        ...
        ctx: &dyn ServerCommandContextTrait,
        partial_result_dispatcher: PartialResultDispatcher<NoPartialResult>,
        req: slug_cli_proto::new_generic::DocsRequest,
    ) -> slug_error::Result<slug_cli_proto::new_generic::DocsResponse>;
}
