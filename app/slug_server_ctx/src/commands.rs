...
pub fn command_end<R, D>(result: &slug_error::Result<R>, data: D) -> slug_data::CommandEnd
where
    D: Into<slug_data::command_end::Data>,
{
...
where
    F: FnOnce(&R) -> Option<slug_data::BuildResult>,
    D: Into<slug_data::command_end::Data>,
{
    slug_data::CommandEnd {
        data: Some(data.into()),
...
pub fn send_target_cfg_event(
    ...
    target_cfg: &Option<slug_cli_proto::TargetCfg>,
) {
    ...
    event_dispatcher.instant_event(slug_data::TargetCfg {
