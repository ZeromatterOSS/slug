...
//! Conversion impls for different error types to 'slug_error::Error'
...
/// Helper function that can be explicitly called to convert `std::error::Error` into `slug_error`.
///
