...
impl From<rusqlite::Error> for crate::Error {
    ...
    fn from(value: rusqlite::Error) -> Self {
        if let rusqlite::Error::FromSqlConversionFailure(_, _, e) = &value {
            if let Some(wrapper) = e.downcast_ref::<SlugErrorAsRusqliteError>() {
...
#[repr(transparent)]
pub struct SlugErrorAsRusqliteError(pub crate::Error);

impl std::error::Error for SlugErrorAsRusqliteError {}
