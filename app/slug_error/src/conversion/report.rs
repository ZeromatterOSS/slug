...
impl From<&crate::Error> for ErrorReport {
    fn from(err: &crate::Error) -> Self {
        ...
        {
            if let Some(slug_data::action_error_diagnostics::Data::SubErrors(sub_errors)) =
        ...
        let string_tags = err
            ...
            .filter_map(|kind| match kind {
                ContextValue::StringTag(val) => Some(slug_data::error_report::StringTag {
                    tag: val.tag.clone(),
                }),
                _ => None,
            })
