...
pub(crate) async fn get_mergebase<D: AsRef<Path>, C: AsRef<str>, M: AsRef<str>>(
    ...
    commit: C,
    mergegase_with: M,
) -> kuro_error::Result<Option<MergebaseDetails>> {
...
fn parse_log_output(output: Vec<u8>) -> kuro_error::Result<Option<MergebaseDetails>> {
...
pub(crate) async fn get_status<D: AsRef<Path>, F: AsRef<str>, S: AsRef<str>>(
    ...
    second: Option<S>,
    limit_results: usize,
) -> kuro_error::Result<SaplingGetStatusResult> {
...
fn process_one_status_line(line: &str) -> kuro_error::Result<Option<(SaplingStatus, String)>> {
...
mod tests {
    ...
    #[test]
    fn test_hg_status_line() -> kuro_error::Result<()> {
        assert_eq!(
            process_one_status_line("M kuro/app/kuro_file_watcher/src/edenfs/sapling.rs")?,
            Some((
                SaplingStatus::Modified,
                "kuro/app/kuro_file_watcher/src/edenfs/sapling.rs".to_owned()
            ))
        );

        assert_eq!(
            process_one_status_line("A kuro/app/kuro_file_watcher/src/edenfs/interface.rs")?,
            Some((
                SaplingStatus::Added,
                "kuro/app/kuro_file_watcher/src/edenfs/interface.rs".to_owned()
            ))
        );

        assert_eq!(
            process_one_status_line("R kuro/app/kuro_file_watcher/src/edenfs/utils.rs")?,
            Some((
                SaplingStatus::Removed,
                "kuro/app/kuro_file_watcher/src/edenfs/utils.rs".to_owned()
            ))
        );

        assert_eq!(
            process_one_status_line("! kuro/app/kuro_file_watcher/src/edenfs/sapling.rs")?,
            Some((
        ...
        assert_eq!(
            process_one_status_line("C kuro/app/kuro_file_watcher/src/edenfs/sapling.rs")?,
            Some((
                SaplingStatus::Clean,
                "kuro/app/kuro_file_watcher/src/edenfs/sapling.rs".to_owned()
            ))
        ...
        assert_eq!(
            process_one_status_line("I kuro/app/kuro_file_watcher/src/edenfs/sapling.rs")?,
            Some((
        ...
        assert!(
            process_one_status_line("Mkuro/app/kuro_file_watcher/src/edenfs/sapling.rs").is_err()
        );
    ...
    #[test]
    fn test_parse_log_output() -> kuro_error::Result<()> {
        // the format is {node}\n{date}\n{global_rev}
        let output =
    ...
    #[test]
    fn test_parse_log_output_no_global_rev() -> kuro_error::Result<()> {
