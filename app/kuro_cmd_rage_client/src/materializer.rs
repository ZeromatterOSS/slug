...
pub async fn upload_materializer_data(
    buckd: Shared<BoxFuture<'_, kuro_error::Result<BootstrapBuckdClient>>>,
    ...
    match outcome {
        ...
        CommandOutcome::Failure(..) => {
            return Err(kuro_error!(kuro_error::ErrorTag::Tier0, "Command failed"));
        }
    }
