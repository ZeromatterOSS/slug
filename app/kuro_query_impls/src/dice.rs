...
impl LiteralParser {
    ...
    fn parse_target_pattern_with_modifiers(
        &self,
        value: &str,
    ) -> kuro_error::Result<ParsedPatternWithModifiers<TargetPatternExtra>> {
    ...
    pub(crate) fn parse_providers_pattern(
        &self,
        value: &str,
    ) -> kuro_error::Result<ParsedPattern<ProvidersPatternExtra>> {
    ...
    pub(crate) fn parse_providers_pattern_with_modifiers(
        &self,
        value: &str,
    ) -> kuro_error::Result<ParsedPatternWithModifiers<ProvidersPatternExtra>> {
    ...
    fn parse_file_literal(&self, literal: &str) -> kuro_error::Result<CellPath> {
...
impl QueryLiterals<TargetNode> for DiceQueryData {
    async fn eval_literals(
        ...
        literals: &[&str],
        ctx: &mut DiceComputations<'_>,
    ) -> kuro_error::Result<TargetSet<TargetNode>> {
...
pub(crate) async fn get_dice_query_delegate<'a, 'c: 'a, 'd>(
    ...
    global_cfg_options: GlobalCfgOptions,
) -> kuro_error::Result<DiceQueryDelegate<'c, 'd>> {
