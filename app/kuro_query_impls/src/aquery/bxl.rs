...
use kuro_build_api::query::bxl::NEW_BXL_AQUERY_FUNCTIONS;
...
impl BxlAqueryFunctionsImpl {
    ...
    ) -> kuro_error::Result<Arc<DiceAqueryDelegate<'c, 'd>>> {
    ...
    ) -> kuro_error::Result<AqueryEnvironment<'c>> {
        ...
        let target_sets = dice
            .try_compute_join(
                ...
                |ctx: &mut DiceComputations,
                 ...
                 -> BoxFuture<
                    kuro_error::Result<Either<ConfiguredTargetLabel, TargetSet<ActionQueryNode>>>,
                > {
                    async move {
