...
use slug_interpreter::factory::ProfileEventListener;
...
impl FileWritingProfileEventListener {
    ...
    pub fn finalize(&self) -> slug_error::Result<()> {
    ...
    fn handle_profile_collected(
        &self,
        eval_kind: slug_interpreter::dice::starlark_provider::StarlarkEvalKind,
        profile_data: &std::sync::Arc<
            slug_interpreter::starlark_profiler::data::StarlarkProfileDataAndStats,
        >,
    ) -> slug_error::Result<()> {
