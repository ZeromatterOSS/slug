...
mod collector {
    ...
    impl SystemNetworkIoCollector {
        ...
        pub fn collect(&self) -> slug_error::Result<Option<HashMap<String, NetworkStat>>> {
...
mod collector {
    ...
    use dupe::Dupe;
    use slug_util::os::win::network_interface_table::NetworkInterfaceTable;
                ...
                counters.insert(
                    ...
                    NetworkStat {
                        ...
                        network_kind: match interface.network_kind() {
                            slug_util::os::win::network_interface::NetworkKind::Ethernet => {
                                NetworkKind::Ethernet
                            }
                            slug_util::os::win::network_interface::NetworkKind::WiFi => {
                                NetworkKind::WiFi
                            }
                            _ => NetworkKind::Unknown,
                        },
