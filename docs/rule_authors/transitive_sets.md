...
```python src=fbcode/kuro/app/kuro_build_api_tests/src/interpreter/transitive_set/tests.rs
...
```python src=fbcode/kuro/app/kuro_build_api_tests/src/interpreter/transitive_set/tests.rs title=fbcode/kuro/app/kuro_build_api_tests/src/interpreter/transitive_set/tests.rs
