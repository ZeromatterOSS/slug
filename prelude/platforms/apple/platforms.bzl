...
load("@prelude//platforms/apple:base.bzl", "apple_build_mode_backed_platform", "get_build_mode_constraints_map", "is_kuro_mac_platform", "is_mobile_platform")
load(
...
def apple_target_platforms(
    ...
    for platform in supported_cxx_platforms:
        ...
        if is_mobile_platform(platform) or is_kuro_mac_platform(platform):
