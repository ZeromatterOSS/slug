...
def link_execution_preference_attr():
    ...
    - any : No preference is set, and the link action will be performed based on kuro's executor configuration.
    - full_hybrid : The link action will execute both locally and remotely, regardless of kuro's executor configuration (if
