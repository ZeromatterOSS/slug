...
applies to all of the following situations:
  ...
  - `arc rust-check` a.k.a. `kuro build :whoa[check]`

  - documentation builds: `kuro build :whoa[doc]`
...
# @oss-disable[end= ]: load("@fbcode//kuro/facebook:autodeps_hacks.bzl", "RustLinkInfo", "prelude")
