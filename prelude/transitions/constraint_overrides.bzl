...
#           * kuro.platforms
#           * kuro.constraints
#           * kuro.passthrough_constraints
#
#       kuro.platforms and kuro.constraints list all possible target platforms and constraint
#       values, and kuro.passthrough_constraints lists constraint settings to preserve when
...
_config = struct(
    platforms = read_root_config("kuro", "platforms", ""),
    constraints = read_root_config("kuro", "constraints", ""),
    passthrough_constraints = read_root_config("kuro", "passthrough_constraints", ""),
...
def _apply(
    ...
    The outgoing target platform is constructed by:
        ...
        2. Applying the constraint values in old_platform whose constraint settings match any of
           those listed in kuro.passthrough_constraints; and
    ...
    are discarded unless:
        ...
        * Their constraint settings are listed in kuro.passthrough_constraints; and
