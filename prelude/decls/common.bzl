...
def _labels_arg():
    ...
    Set of arbitrary strings which allow you to annotate a [build rule](https://kuro.build/docs/concepts/build_rule/) with tags
...
def _licenses_arg():
    return {
        "licenses": attrs.list(attrs.source(), default = [], doc = """
            ...
            all of its dependencies, you can use [buck query](https://kuro.build/docs/users/commands/query/)
        """),
    }
