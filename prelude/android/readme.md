# Kuro Android Prelude

## 1. 🧭 Overview

The Kuro Android Prelude is a comprehensive build system for Android
applications and libraries within Meta's Kuro build system. It provides a
...
- **Language**: Starlark (Kuro's build language), Python (utility tools), Java
  (toolchain components)
- **Framework**: Kuro build system with Android SDK integration
...
- External: Kuro provider framework
...
sequenceDiagram
    ...
    participant Buck as Kuro Engine
...
- **Notes**: Core provider for dependency aggregation using Kuro's transitive
  set system
