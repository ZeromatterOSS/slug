...
def get_android_binary_native_library_info(
    ...
    if native_library_merge_glue:
        ...
        for platform, glue in native_library_merge_glue.items():
            ...
            expect(glue_linkable.preferred_linkage == Linkage("static"), "kuro currently only supports preferred_linkage='static' native_library_merge_glue")
    ...
    if relinker_extra_deps:
        for red_elem in relinker_extra_deps:
            for platform, red in red_elem.items():
                ...
                expect(red_linkable.preferred_linkage == Linkage("static"), "kuro currently only supports preferred_linkage='static' relinker_extra_deps")
