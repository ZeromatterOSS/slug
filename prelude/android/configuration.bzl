...
# Android binaries (APKs or AABs) can be built for one or more different platforms. kuro supports
...
# (https://www.internalfb.com/intern/staticdocs/kuro/docs/rule_authors/configuration_transitions)
