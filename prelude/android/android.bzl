...
FORCE_SINGLE_CPU = read_root_config("kuro", "android_force_single_cpu") in ("True", "true")
FORCE_SINGLE_DEFAULT_CPU = read_root_config("kuro", "android_force_single_default_cpu") in ("True", "true")
