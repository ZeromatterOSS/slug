# Easy slug builds for Facebook projects

This directory contains slug targets designed to simplify slug builds of
Meta open source projects.

The most notable target is `//build/slug/install_deps`, which will attempt to
...
repositories that use `slug`.  Typically this directory is copied
into the open source repositories as `build/slug/`.
