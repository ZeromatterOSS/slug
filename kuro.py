...
# This script builds kuro locally from source and then runs it.
#
# It uses the installed kuro to build the kuro bundle target, then executes
# the freshly built binary with any additional arguments passed to this script.
# This is useful for testing local changes to kuro without a full installation.
#
# Example:
#   ./kuro.py build //my:target
...
def parse_arguments() -> Tuple[argparse.Namespace, List[str]]:
    parser = argparse.ArgumentParser(
        ...
        description="Builds kuro locally and then runs it.",
...
def build_command(
    ...
    cmd = [
        "kuro",
        "run",
        # @oss-disable[end= ]: "fbcode//kuro:kuro_bundle",
        "//:kuro_bundle", # @oss-enable
    ]
