# Kuro Mascot Icon Set — Design Specification

## Purpose
Create an ultra-minimal mascot icon set for the **Kuro build tool** that remains highly legible at **32×32 px** (favicon scale) while also working at **64×64** and **128×128**.
...
## Reference Output
See: `assets/mascot/kuro-mascot-variants.png`
