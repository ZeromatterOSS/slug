...
[WP-4-7A-rules-cc-create-linker-input-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze the authenticated complete 69-line rules_cc linker-input producer over
its accepted child. Prove its full imported/provider/function inventory without
invocation or callable-default inspection.
