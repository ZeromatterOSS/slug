...
| M7: command/ruleset breadth | **active (root-apparent source-input owner implementation)** | owner design `e659b0e3` accepted | implement the private Need-aware five-domain owner | WP-4-5-6-host-root-apparent-repository-source-input-owner-implementation |
...
[WP-4-5-6-host-root-apparent-repository-source-input-owner-implementation](./slug-v2-subplans/current-packet.md).
