...
Implement only `WP-5-m1-terminal-event-execution-oracle`.
...
`fixture.toml`, `expected/oracle.json`, `workspace/MODULE.bazel`, and
`workspace/pkg/{BUILD.bazel,defs.bzl,message.bzl}`. Add no file, symlink,
scaffold, harness, schema, or Slug production change; stop above 350 net fixture
lines or on unstable/cross-channel ordering.
