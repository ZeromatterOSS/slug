...
[`WP-4-6-7A-named-execution-group-runtime-audit-r1`
docs/source audit](./slug-v2-subplans/current-packet.md).
...
Audit the complete generic named-execution-group runtime category under the
existing Stage 6 reservation before changing its pre-publication guard. Do not
erase group names, substitute the default platform, or merely move the guard
to pass loading. No new Rust is authorized by the audit.
