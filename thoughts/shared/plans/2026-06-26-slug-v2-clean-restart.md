...
[WP-4-7A-rules-cc-linkstamp-compile-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze the authenticated complete 111-line rules_cc linkstamp-compile producer
over its six accepted children. Prove all six imported identities and its one
lazy function without invocation.
