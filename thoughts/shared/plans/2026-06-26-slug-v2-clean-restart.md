...
| M7: command/ruleset breadth | **active (materialization-request projection proof correction)** | projection design `9df81032`; production review accepted | complete the frozen proof under a truthful physical ceiling before Rust resumes | WP-4-5-host-repository-source-capability-materialization-request-projection-r2-proof-design |
...
[WP-4-5-host-repository-source-capability-materialization-request-projection-r2-proof-design](./slug-v2-subplans/current-packet.md).
