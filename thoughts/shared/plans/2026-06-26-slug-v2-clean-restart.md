...
| M7: command/ruleset breadth | **active (selected module route owner implementation)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite run, complete Host discovered leaves, normalized/effective overrides, exact shared versions, accepted callerless selected graph in 216a0be8, accepted selected registry RepoSpec owner in e8ad58dd, and accepted two-file selected-route design | implement the callerless selected-route aggregate under 420/700/1,120 caps without a consumer | WP-5-host-selected-module-route-owner-implementation |
...
[WP-5-host-selected-module-route-owner-implementation](./slug-v2-subplans/current-packet.md).
