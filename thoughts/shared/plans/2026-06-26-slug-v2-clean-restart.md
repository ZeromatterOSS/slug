...
[WP-4-7A-rules-cc-compile-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze the authenticated complete 2,295-line rules_cc compile producer over its
eleven accepted children. Prove its full imported/eager/function inventory
without invoking any callable.
