...
[WP-6-7A-host-canonical-selected-module-definition-observation-carrier-promotion-identity-test-layout-correction-implementation](./slug-v2-subplans/current-packet.md).
