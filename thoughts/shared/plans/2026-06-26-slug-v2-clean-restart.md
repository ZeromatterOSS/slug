...
| M7: command/ruleset breadth | **partial; generated route capability promoted in `b42b004c`** | accepted M7A repository-observation chain through `597df31b`; `846ef196` same-crate handoff; 2026-08-24 audit + design + `b42b004c` promotion expose the doc-hidden Generated route reusing all routed package owners | generated package source/load caller and public publication remain separate later owners; one stale absence-scan correction pending | audit only `WP-6-7A-generated-repository-package-publication-frontier-audit-2`; preserve M7A -> M8 -> M7B |
...
[WP-6-7A-generated-repository-package-publication-frontier-audit-2](./slug-v2-subplans/current-packet.md).

The prior packet (route-capability promotion) is accepted in `b42b004c`.
