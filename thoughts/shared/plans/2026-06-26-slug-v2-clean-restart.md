...
| M7: command/ruleset breadth | **active (selected extension definition-load request implementation r2)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite run, complete Host discovered leaves, normalized/effective overrides, exact shared versions, accepted callerless selected graph in `216a0be8`, selected registry RepoSpecs in `e8ad58dd`, selected routes in `6f72baaf`, root extension usages in `11be92b9`, corrected root overrides in `2644f091`, and selected extension mappings in `75a431d6` | finish the retained hidden Bzlmod-to-loading projection under corrected 220/260/480 caps | WP-5-host-selected-extension-definition-load-request-owner-implementation-r2 |
...
[WP-5-host-selected-extension-definition-load-request-owner-implementation-r2](./slug-v2-subplans/current-packet.md).
