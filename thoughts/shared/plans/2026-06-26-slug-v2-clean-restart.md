...
[WP-4-5-7A-effective-repository-host-input-architecture-r5](./slug-v2-subplans/current-packet.md).
...
packets. No Host implementation/effect or selected-context Rust change resumes
before its independent architecture review.
