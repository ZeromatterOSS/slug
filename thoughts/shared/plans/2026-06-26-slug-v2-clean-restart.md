...
| M7: command/ruleset breadth | **active (nonregistry-package prerequisite)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite `run`, immutable embedded source/module owners, and the embedded/registry Host discovered-module leaf in `e7e4a772` | decouple nonregistry package preflight from repository routing before MODULE closure | `WP-5-host-nonregistry-package-preflight-design` |
...
[`WP-5-host-nonregistry-package-preflight-design`](./slug-v2-subplans/current-packet.md).
