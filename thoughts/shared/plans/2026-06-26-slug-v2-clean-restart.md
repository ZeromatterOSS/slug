...
| M7: command/ruleset breadth | **active (effective module override implementation)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite run, complete callerless Host discovered-module leaves through 6b2967c7, and normalized command overrides in b319b551 | implement the sole effective root/command/default source classification before selected-graph discovery | WP-5-host-effective-module-override-owner-implementation |
...
[WP-5-host-effective-module-override-owner-implementation](./slug-v2-subplans/current-packet.md).
