...
[Implement the complete repository-rule file-admissibility category](./slug-v2-subplans/current-packet.md).

Commit `75fad534c` terminally accepts the shared root repository route. The
authentic rules_rust replay now reaches verbatim Bazel-tools `git.bzl` and
