...
| M7: command/ruleset breadth | **active (command-override owner design)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite run, route-independent package preflight/closure, and the complete callerless Host discovered-module leaf through 6b2967c7; selected-graph owner design REPLAN found command overrides absent from semantic input | freeze one normalized command-module-override owner from request parsing through DICE | WP-5-host-command-module-override-owner-design |
...
[WP-5-host-command-module-override-owner-design](./slug-v2-subplans/current-packet.md).
