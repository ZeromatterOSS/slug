...
| M7: command/ruleset breadth | **active (root-apparent source-input owner design)** | source-input implementation `f7566280` accepted | design the private Need-aware five-domain owner | WP-4-5-6-host-root-apparent-repository-source-input-owner-design |
...
[WP-4-5-6-host-root-apparent-repository-source-input-owner-design](./slug-v2-subplans/current-packet.md).
