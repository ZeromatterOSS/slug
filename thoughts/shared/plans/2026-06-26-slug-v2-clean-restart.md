...
[WP-4-7A-rules-cc-target-types-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze the authenticated complete 131-line rules_cc link target-type producer
over its two accepted children. Prove its full imported/string/nested-struct/
function inventory without invocation.
