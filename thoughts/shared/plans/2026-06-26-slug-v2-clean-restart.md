...
| M7: command/ruleset breadth | **active (canonical repository-definition composition implementation)** | composition design `e05a0dfc` accepted | implement only the private one-file core key under 260/520/780 | WP-4-5-6-host-canonical-repository-definition-composition-owner-implementation |
...
[WP-4-5-6-host-canonical-repository-definition-composition-owner-implementation](./slug-v2-subplans/current-packet.md).
