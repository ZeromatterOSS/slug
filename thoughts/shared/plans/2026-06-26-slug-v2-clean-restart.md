...
| M7: command/ruleset breadth | **active (repository source input certificate implementation)** | source-input design `b9cffe52` accepted | implement the computation-free capability/disposition owner | WP-4-5-host-repository-source-input-certificate-implementation |
...
[WP-4-5-host-repository-source-input-certificate-implementation](./slug-v2-subplans/current-packet.md).
