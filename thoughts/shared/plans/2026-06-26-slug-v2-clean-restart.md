...
| M7: command/ruleset breadth | **active (canonical selected-module lookup implementation)** | selected-module lookup design `dd8ca159` accepted | implement only the private one-file Bzlmod lookup under 220/500/720 | WP-5-host-canonical-selected-module-definition-owner-implementation |
...
[WP-5-host-canonical-selected-module-definition-owner-implementation](./slug-v2-subplans/current-packet.md).
