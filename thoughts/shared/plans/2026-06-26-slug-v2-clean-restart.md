...
[WP-4-5-7A-native-toolchain-declaration-semantics](./slug-v2-subplans/current-packet.md).
...
identity and matching follow, then contextual command build-setting and
