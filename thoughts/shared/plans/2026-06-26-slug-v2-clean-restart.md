...
| M7: command/ruleset breadth | **partial; corrected generated package bridge implementation retry active** | accepted M7A chain through `597df31b`; `846ef196` handoff; `b42b004c` Generated route promotion; corrected bridge design plus refreshed Bazel 9.2 `module-extension-use-repo` generated-build evidence; proof/cap correction independently accepts +531 retained production, test-only success-kind-aware materialization and one production-used opaque-outer finisher | the retained bridge still needs mapped non-Generated exact fallback, opaque-outer prefix and Slug generated-build permanence proof; query/public publication and other platforms remain deferred | implement only `WP-6-7A-generated-package-load-bridge-proof-cap-correction-implementation`; preserve M7A -> M8 -> M7B |
...
[WP-6-7A-generated-package-load-bridge-proof-cap-correction-implementation](./slug-v2-subplans/current-packet.md).

The proof/cap correction design is accepted. Preserve the retained five-file
production candidate and implement only the test-only success-kind-aware
materialization, production-used opaque-outer finisher and two command proofs
authorized by the current packet.
