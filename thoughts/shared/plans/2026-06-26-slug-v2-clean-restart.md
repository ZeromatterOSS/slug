...
[WP-4-7A-rules-cc-lto-backends-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze the authenticated complete 540-line rules_cc LTO-backends producer over
its four accepted children. Prove its full imported/provider/function inventory
without invocation.
