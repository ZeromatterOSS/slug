...
| M7: command/ruleset breadth | **active (selected-module graph cap correction)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite run, complete callerless Host discovered-module leaves through 6b2967c7, normalized command overrides in b319b551, effective override/source ownership in dbeb1fb9, exact shared module versions in c997f7e7, and an independently accepted selected-graph design | correct the triggered implementation cap and typed leaf-error retention before resuming Rust | WP-5-host-selected-module-graph-owner-implementation-r2-cap-design |
...
[WP-5-host-selected-module-graph-owner-implementation-r2-cap-design](./slug-v2-subplans/current-packet.md).
