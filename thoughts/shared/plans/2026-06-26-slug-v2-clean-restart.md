...
| M7: command/ruleset breadth | **active (root repository-mapping publication design)** | canonical apparent mapping `fd8a7582` accepted | publish the sole complete post-extension root mapping before core routing | WP-5-host-root-repository-mapping-publication-design |
...
[WP-5-host-root-repository-mapping-publication-design](./slug-v2-subplans/current-packet.md).
