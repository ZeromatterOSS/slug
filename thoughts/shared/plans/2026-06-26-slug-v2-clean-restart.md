...
| M7: command/ruleset breadth | **active (selected validation-request prerequisite design)** | instantiation is accepted in `d50f02a2`; pinned post-eval validation needs ordered import names/locations and override locations not exposed by the hidden request | design the existing-request projection only | WP-5-host-selected-extension-validation-request-projection-design |
...
[WP-5-host-selected-extension-validation-request-projection-design](./slug-v2-subplans/current-packet.md).
