...
| M7: command/ruleset breadth | **active (generated-repository validation design)** | design `f14d3d7a` is accepted | freeze loading-owned import-before-polarity validation without routes or materialization | WP-4-5-host-module-extension-generated-repository-validation-owner-design |
...
[WP-4-5-host-module-extension-generated-repository-validation-owner-design](./slug-v2-subplans/current-packet.md).
