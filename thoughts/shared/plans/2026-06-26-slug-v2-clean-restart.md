...
| M7: command/ruleset breadth | **active (custom string protocol implementation r2)** | six-file implementation independently accepted; focused and dependent suites pass with only unrelated vendored golden baselines | commit the isolated runtime prerequisite, then resume invocation | WP-4-starlark-custom-string-protocol-implementation-r2 |
...
[WP-4-starlark-custom-string-protocol-implementation-r2](./slug-v2-subplans/current-packet.md).
