...
[WP-4-7A-rules-cc-semantics-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Prove exact complete dependency-free `cc/common/semantics.bzl` freezes its
eager constants/label, all 30 lazy functions and exact 43-field captured-function
struct. Add no production behavior and invoke nothing.
