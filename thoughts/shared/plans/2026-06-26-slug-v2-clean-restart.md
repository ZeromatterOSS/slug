...
| M7: command/ruleset breadth | **active (selected registry RepoSpec implementation r2)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite run, complete Host discovered leaves, normalized/effective overrides, exact shared versions, accepted callerless selected graph in 216a0be8, accepted selected RepoSpec design in 1b4b4996, and accepted cap/semantic correction in 84bba7cf | resume the retained two-file implementation under corrected caps and prove exact selected-only registry RepoSpecs | WP-5-host-selected-registry-repo-spec-owner-implementation-r2 |
...
[WP-5-host-selected-registry-repo-spec-owner-implementation-r2](./slug-v2-subplans/current-packet.md).
