...
`WP-5-m1-direct-local-module-file-handoff-corrected-implementation`.
...
440 test/540 total cap is accepted; the current packet retries the exact
one-file dormant implementation without semantic widening.
