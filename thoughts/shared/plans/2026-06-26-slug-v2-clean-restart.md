...
| M7: command/ruleset breadth | **active (root apparent-mapping composition implementation)** | design `57ef6bf1` accepted; root mapping publication `927c00af` | complete the one-file in-place Root consumer under 180/420/600 | WP-4-5-6-host-root-apparent-mapping-composition-owner-implementation |
...
[WP-4-5-6-host-root-apparent-mapping-composition-owner-implementation](./slug-v2-subplans/current-packet.md).
