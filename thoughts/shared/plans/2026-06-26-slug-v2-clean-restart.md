...
[WP-4-5-7A-canonical-repository-load-route-implementation](./slug-v2-subplans/current-packet.md).
...
Activate only `WP-4-5-7A-canonical-repository-load-route-implementation`.
