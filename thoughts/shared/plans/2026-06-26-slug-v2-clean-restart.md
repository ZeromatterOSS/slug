...
[WP-4-7A-rules-cc-create-library-to-link-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze the authenticated complete 291-line rules_cc create-library producer
over its five accepted children. Prove its full imported/eager/provider/function
