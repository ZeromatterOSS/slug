...
| M7: command/ruleset breadth | **partial; selected-extension demand-owner design active** | accepted M7A chain through `597df31b`; `846ef196` handoff; `b42b004c` Generated route promotion; refreshed Bazel 9.2 generated-build evidence; retained +566/+508/+1,074 bridge/input candidate; protected external lifecycle and full Bzlmod pass; Zabel-guided request input ownership is implemented and validated in retained state | the rebuilt fixture proves workspace-wide extension validation is poisoned by unrelated unsupported `@bazel_tools` extensions before the requested root extension is selected; query/public publication and other platforms remain deferred | design only `WP-6-7A-generated-package-selected-extension-demand-owner-design`; preserve M7A -> M8 -> M7B |
...
[WP-6-7A-generated-package-selected-extension-demand-owner-design](./slug-v2-subplans/current-packet.md).
...
candidate and design a producer-authenticated selected-extension demand before
loading/evaluation. Bazel 9 keys evaluation by one `ModuleExtensionId`; Zabel
likewise derives canonical-repository demand seeds and an owner index before
execution. Do not make the existing complete workspace-wide carriers best-
effort and do not parse `+`-delimited canonical repository strings.
