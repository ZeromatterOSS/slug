...
| M7: command/ruleset breadth | **active (root apparent-definition proof correction)** | design `512e40ed`; implementation review REPLAN | correct only the proof boundary before Rust resumes | WP-4-5-6-host-root-apparent-repository-definition-owner-r2-proof-design |
...
[WP-4-5-6-host-root-apparent-repository-definition-owner-r2-proof-design](./slug-v2-subplans/current-packet.md).
