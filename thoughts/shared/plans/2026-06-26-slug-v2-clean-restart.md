...
| M7: command/ruleset breadth | **partial; root generated-repository observation-frontier design active** | `53152727` accepts the first private core source consumer; M1 supplies the shared publication spine; bounded FileWrite aquery/REAPI, generated Bazel 9.2 owner evidence, `cb5073e0`'s immutable configured-action row, and `b7390392`'s exact rules_rust 0.73 generated-registration/provider/action evidence are accepted | extension-generated root apparent-to-canonical mapping, route/source and generated package loading still cross carrierless lower owners, so the external rules_rust analysis owner cannot yet retain a complete observation epoch | design only the bounded root generated-repository observation frontier, then return to the external rules_rust toolchain owner and preserve M7A -> M8 -> M7B |
...
[WP-6-7A-root-generated-repository-observation-frontier-design](./slug-v2-subplans/current-packet.md).
