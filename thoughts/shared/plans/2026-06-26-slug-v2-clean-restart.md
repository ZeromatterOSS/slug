...
| M7: command/ruleset breadth | **active (root apparent repository carrier implementation)** | carrier design `0c0c2402` accepted | implement the private five-domain carrier before owned route/source work | WP-4-5-6-host-root-apparent-repository-route-carrier-owner-implementation |
...
[WP-4-5-6-host-root-apparent-repository-route-carrier-owner-implementation](./slug-v2-subplans/current-packet.md).
