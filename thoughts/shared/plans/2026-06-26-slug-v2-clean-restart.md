...
| M7: command/ruleset breadth | **partial; generated package load bridge design active** | accepted M7A chain through `597df31b`; `846ef196` handoff; `b42b004c` Generated route promotion; audit-2 selects the core build branch as first activated consumer via one bridge child | query-path activation, public publication and other platforms deferred | design only `WP-6-7A-generated-package-load-bridge-design`; preserve M7A -> M8 -> M7B |
...
[WP-6-7A-generated-package-load-bridge-design](./slug-v2-subplans/current-packet.md).

The prior packet (frontier-audit-2) is accepted in the 2026-08-24 record of
