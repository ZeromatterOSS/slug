...
| M7: command/ruleset breadth | **partial; generated route-capability design accepted** | accepted M7A repository-observation chain through `597df31b`; `846ef196` implements the same-crate `pub(super)` handoff; 2026-08-24 audit + design select the doc-hidden `RootRepositorySource::Generated` capability promotion reusing all routed package owners unchanged | generated package policy/lookup/source/load and public publication remain separate later owners | implement only `WP-6-7A-generated-repository-route-capability-promotion-implementation`; preserve M7A -> M8 -> M7B |
...
[WP-6-7A-generated-repository-route-capability-promotion-implementation](./slug-v2-subplans/current-packet.md).

The prior packets (frontier audit, package-policy-lookup design) are accepted
in the 2026-08-24 records of the Stage 6 owner plan.
