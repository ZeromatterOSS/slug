...
[WP-4-7A-rules-cc-cpp-link-action-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze the authenticated complete 273-line rules_cc C++ link-action producer
