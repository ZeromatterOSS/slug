...
| M7: command/ruleset breadth | **active (repository route consumer-boundary design)** | private five-domain carrier accepted | freeze a dependency-safe consumer seam before route/source work | WP-4-5-6-host-repository-route-consumer-boundary-design |
...
[WP-4-5-6-host-repository-route-consumer-boundary-design](./slug-v2-subplans/current-packet.md).
