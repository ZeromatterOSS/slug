...
[WP-4-5-7A-module-bzl-native-context-architecture](./slug-v2-subplans/current-packet.md).
...
Freeze the general module-loaded native-context architecture before adding the
next value: carry a private BUILD/Bzlmod context in root and external `.bzl`
evaluation, observation, and cycle keys; inherit it recursively; and expose two
