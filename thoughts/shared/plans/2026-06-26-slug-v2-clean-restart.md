...
| M4: `cquery` | **replan (toolchain topology accepted)** | projected label/Starlark-label output, direct retained-state functions, and exact toolchain/platform/constraint graph evidence | pin alias/output/file/package-group delegation topology before configured-node ownership | `WP-6-m4-configured-query-delegation-topology-oracle` |
...
[`WP-6-m4-configured-query-delegation-topology-oracle`](./slug-v2-subplans/current-packet.md).
