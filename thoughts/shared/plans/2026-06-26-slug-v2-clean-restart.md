...
[WP-4-7A-rules-cc-link-build-variables-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze the authenticated complete 392-line rules_cc link-build-variable
producer over its two accepted children. Prove its full
imported/struct/dictionary/function inventory without invocation.
