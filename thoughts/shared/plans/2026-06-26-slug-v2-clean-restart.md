...
| M7: command/ruleset breadth | **active (repository-rule definition owner design)** | pure invocation accepted in `986ccebd`; generated repositories require repository-rule call side effects, but shared loading omits the definition global | audit the bounded definition/load/export owner before call capture | WP-4-5-host-repository-rule-definition-owner-design |
...
[WP-4-5-host-repository-rule-definition-owner-design](./slug-v2-subplans/current-packet.md).
