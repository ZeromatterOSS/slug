...
| M7: command/ruleset breadth | **active (canonical definition composition r2 implementation)** | design `e05a0dfc`; proof correction `63fedad6` accepted | implement the corrected one-file core key under 260/520/780 | WP-4-5-6-host-canonical-repository-definition-composition-owner-implementation-r2 |
...
[WP-4-5-6-host-canonical-repository-definition-composition-owner-implementation-r2](./slug-v2-subplans/current-packet.md).
