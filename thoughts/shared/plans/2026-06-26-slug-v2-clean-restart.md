...
`WP-5-m1-direct-local-package-preflight-helper-refactor`.
...
approval of that product-visible limitation. The current prerequisite extracts
the accepted route-plus-requests package preflight without behavior change;
support-gated acyclic acquisition and corrected evaluation/event ownership
remain serial after it.
