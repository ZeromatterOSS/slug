...
`WP-5-m1-direct-local-nonregistry-route-package-horizon-design`.
...
accepted in `9b5246af` at 211 production/368 test/579 total lines. The current
packet designs only one route-aware breadth-first package-preflight horizon.
Fragment reads, occurrence-preserving closure, and corrected evaluation/event
