...
`WP-6-m2-native-toolchain-declaration-loading-design`.
...
loading before any DICE selection or prepared `ctx.toolchains`; invalid
transition and toolchain failure diagnostics remain deferred.
