...
| M7: command/ruleset breadth | **active (root apparent-definition composition implementation)** | design `512e40ed` accepted; root apparent mapping `59493b95` | implement the cohesive private mapping-to-definition owner under 340/700/1,040 | WP-4-5-6-host-root-apparent-repository-definition-owner-implementation |
...
[WP-4-5-6-host-root-apparent-repository-definition-owner-implementation](./slug-v2-subplans/current-packet.md).
