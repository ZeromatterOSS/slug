...
| M7: command/ruleset breadth | **active (selected extension evaluation-input cap correction)** | accepted input-owner design in `a31cf3d9`; retained unaccepted Rust needs structural post-request error identity | independently accept 280/360/640 with unchanged two-file scope before r2 | WP-5-host-selected-extension-evaluation-input-requests-r2-cap-design |
...
[WP-5-host-selected-extension-evaluation-input-requests-r2-cap-design](./slug-v2-subplans/current-packet.md).
