...
| M7: command/ruleset breadth | **active (run fixture-boundary replan)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, plus accepted client-launch/daemon-wire and oracle-endpoint designs | freeze the complete POSIX `run-basic` source on admitted Slug Starlark before resuming implementation | `WP-8-m7-filewrite-run-fixture-admission-design` |
...
[`WP-8-m7-filewrite-run-fixture-admission-design`](./slug-v2-subplans/current-packet.md).
