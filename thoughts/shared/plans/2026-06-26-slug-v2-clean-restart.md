...
| M7: command/ruleset breadth | **active (selected-module definition publication implementation)** | publication design `1d8758d5` accepted | implement only the hidden two-file ABI under 180/380/560 | WP-5-host-canonical-selected-module-definition-publication-implementation |
...
[WP-5-host-canonical-selected-module-definition-publication-implementation](./slug-v2-subplans/current-packet.md).
