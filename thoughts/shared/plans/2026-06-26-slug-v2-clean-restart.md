...
| M2: analysis graph | **active** | recursive configured analysis, bounded root cquery in `135b0567`, implicit empty-default normalization in `7c6eeae5`, internal string build-setting transitions in `dfc1705e`, first-compatible toolchain evidence in `ed4baf08`, root registration retention in `4a3af8df`, native targets in `6a457406`, and rule requirements/load-only ToolchainInfo in `1d6106bd` | real DICE selection/context ownership, then general identity and action gates | design `WP-6-m2-integrated-toolchain-resolution-context-design` |
...
`WP-6-m2-integrated-toolchain-resolution-context-design`.
