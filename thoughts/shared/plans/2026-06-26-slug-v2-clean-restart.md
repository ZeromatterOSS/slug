...
[Apple-common fail-closed declaration-provider implementation
...
The first three-member facade audit was rejected because an ordinary
...
Commit `94738a9a2` accepts the corrected cross-stage design. Implement only
`WP-4-6-7A-apple-common-declaration-provider-fail-closed-implementation-r1`
under its frozen five-file allowlist and caps.
