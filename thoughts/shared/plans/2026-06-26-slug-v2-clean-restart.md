...
| M7: command/ruleset breadth | **partial; generated repository file-effect owner design active** | accepted owner-first design `b97d6372`; retained passing selected-owner and source-preflight candidates; rebuilt fixture reaches custom repository-rule materialization | Slug has no selected-call execution owner or `repository_ctx.file` effect/materialization protocol for user-defined repository rules | design only `WP-4-5-6-generated-repository-file-effect-owner-design`; preserve M7A -> M8 -> M7B |
...
[WP-4-5-6-generated-repository-file-effect-owner-design](./slug-v2-subplans/current-packet.md).

Preserve the retained selected-owner and route-polarity candidates plus the
accepted fixture. Design the selected-call reload/effect owner, compact
`repository_ctx.file` plan and one-way handoff into generated repository
materialization. Do not retain Starlark heaps or admit any other
`repository_ctx` API.
