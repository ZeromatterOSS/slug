...
| M7: command/ruleset breadth | **active (repository source input certificate)** | consumer audit accepted after projection `06a5aa99` | freeze the computation-free capability/disposition owner before consumer migration | WP-4-5-host-repository-source-input-certificate-design |
...
[WP-4-5-host-repository-source-input-certificate-design](./slug-v2-subplans/current-packet.md).
