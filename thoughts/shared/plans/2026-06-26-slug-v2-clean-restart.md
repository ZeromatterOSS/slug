...
| M7: command/ruleset breadth | **partial; generated package publication frontier audited** | accepted M7A repository-observation chain through `597df31b`; `b3eba6df` accepts the private terminal source-observation owner; `846ef196` implements the same-crate `pub(super)` handoff with the sibling smoke; 2026-08-24 audit selects the generated package policy/lookup design | generated package policy/lookup/source/load and public publication remain separate later owners | design only `WP-6-7A-generated-repository-package-policy-lookup-design`; preserve M7A -> M8 -> M7B |
...
[WP-6-7A-generated-repository-package-policy-lookup-design](./slug-v2-subplans/current-packet.md).

The prior packet
`WP-6-7A-generated-repository-package-publication-frontier-audit` is accepted
(2026-08-24 record in the Stage 6 owner plan).
