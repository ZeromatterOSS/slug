...
| M7: command/ruleset breadth | **active (repository relative-path owner design)** | private five-domain source-input owner `e4292de7` and consumer audit accepted | freeze the shared path-first validation prerequisite | WP-4-5-host-repository-relative-path-owner-design |
...
[WP-4-5-host-repository-relative-path-owner-design](./slug-v2-subplans/current-packet.md).
