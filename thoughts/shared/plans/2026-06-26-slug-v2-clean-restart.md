...
| M7: command/ruleset breadth | **active (root source-observation consumer design)** | hidden Bzlmod observation owner `cbc44e43` accepted; dependency/ownership audit selected the compact private core carrier with no prerequisite replan | freeze and independently accept the first private core caller and owned-certificate boundary | WP-4-5-6-host-root-repository-source-observation-consumer-design |
...
[WP-4-5-6-host-root-repository-source-observation-consumer-design](./slug-v2-subplans/current-packet.md).
