...
| M7: command/ruleset breadth | **active (selected-module definition publication design)** | private selected-module lookup `bd3ab8ee` accepted | freeze a hidden no-copy ABI over the existing key before core domain composition | WP-5-host-canonical-selected-module-definition-publication-design |
...
[WP-5-host-canonical-selected-module-definition-publication-design](./slug-v2-subplans/current-packet.md).
