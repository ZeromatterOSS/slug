...
| M7: command/ruleset breadth | **active (generated-namespace request prerequisite design)** | repository-rule raw capture is accepted in `b7c70a1b`; root extension usages aggregate in `f5d64085`; exact instantiation still lacks the selected extension prefix and ordered override namespace | design the narrow existing-request projection before RepoSpec/schema work | WP-5-host-selected-extension-generated-namespace-request-design |
...
[WP-5-host-selected-extension-generated-namespace-request-design](./slug-v2-subplans/current-packet.md).
