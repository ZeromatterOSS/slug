...
| M7: command/ruleset breadth | **active (canonical generated-definition lookup design)** | mapping publication `b9a4a3fc` accepted | freeze only the private core canonical definition lookup; no Rust yet | WP-4-5-6-host-generated-repository-definition-lookup-owner-design |
...
[WP-4-5-6-host-generated-repository-definition-lookup-owner-design](./slug-v2-subplans/current-packet.md).
