...
| M7: command/ruleset breadth | **active (selected local-path policy retention implementation)** | design `fda0032e` accepted | implement the three-file Bzlmod retention seam | WP-5-host-selected-nonregistry-local-path-policy-retention-implementation |
...
[WP-5-host-selected-nonregistry-local-path-policy-retention-implementation](./slug-v2-subplans/current-packet.md).
