...
| M7: command/ruleset breadth | **active (repository-rule instantiation proof-cap correction)** | the 474/572/1,046 retained diff needs the frozen join/namespace/lifecycle/A-B-A proof before acceptance; repository implementation and I/O remain deferred | accept a docs-only 480/900/1,380 r2 cap correction, then explicitly reactivate | WP-4-5-host-module-extension-repository-rule-instantiation-owner-r2-cap-design |
...
[WP-4-5-host-module-extension-repository-rule-instantiation-owner-r2-cap-design](./slug-v2-subplans/current-packet.md).
