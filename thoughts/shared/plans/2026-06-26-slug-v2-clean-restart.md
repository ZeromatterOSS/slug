...
| M7: command/ruleset breadth | **active (root repository-mapping publication implementation)** | design `d624dc5b` accepted | implement the hidden borrowed projection under 180/420/600 | WP-5-host-root-repository-mapping-publication-implementation |
...
[WP-5-host-root-repository-mapping-publication-implementation](./slug-v2-subplans/current-packet.md).
