...
| M7: command/ruleset breadth | **active (canonical generated-definition lookup implementation)** | design `6678f54f` accepted | implement only the private two-file core lookup under 260/480/740 | WP-4-5-6-host-generated-repository-definition-lookup-owner-implementation |
...
[WP-4-5-6-host-generated-repository-definition-lookup-owner-implementation](./slug-v2-subplans/current-packet.md).
