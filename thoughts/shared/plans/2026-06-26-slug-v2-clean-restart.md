...
| M7: command/ruleset breadth | **active (custom string implementation scope correction)** | implementation review found the two app paths inseparable from the retained unaccepted invocation owner | freeze a six-file shared-runtime successor before Rust resumes | WP-4-starlark-custom-string-protocol-implementation-r2-scope-design |
...
[WP-4-starlark-custom-string-protocol-implementation-r2-scope-design](./slug-v2-subplans/current-packet.md).
