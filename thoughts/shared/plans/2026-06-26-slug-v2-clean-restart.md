...
| M7: command/ruleset breadth | **active (pure invocation final cap correction)** | complete passing four-path diff measures about 724/846/1,570, exceeding only the frozen estimates | accept a cap-only 730/850/1,580 correction before Rust resumes | WP-4-5-host-pure-module-extension-invocation-owner-r3-cap-design |
...
[WP-4-5-host-pure-module-extension-invocation-owner-r3-cap-design](./slug-v2-subplans/current-packet.md).
