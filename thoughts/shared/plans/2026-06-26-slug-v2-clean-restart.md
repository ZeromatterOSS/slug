...
| M7: command/ruleset breadth | **active (canonical selected-module lookup design)** | generated apparent mapping `f468fa30` accepted | freeze the Bzlmod canonical selected-route lookup before core domain composition | WP-5-host-canonical-selected-module-definition-owner-design |
...
[WP-5-host-canonical-selected-module-definition-owner-design](./slug-v2-subplans/current-packet.md).
