...
| M7: command/ruleset breadth | **active (module-version owner implementation)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite run, complete callerless Host discovered-module leaves through 6b2967c7, normalized command overrides in b319b551, and the effective override/source seam in dbeb1fb9 | implement the reviewed exact Bazel 9.2 version domain before selected discovery/MVS | WP-5-host-module-version-owner-implementation |
...
[WP-5-host-module-version-owner-implementation](./slug-v2-subplans/current-packet.md).
