...
| M7: command/ruleset breadth | **partial; generated package load bridge implementation active** | accepted M7A chain through `597df31b`; `846ef196` handoff; `b42b004c` Generated route promotion; bridge design accepted selecting the core build branch as first consumer | query-path activation, public publication and other platforms deferred | implement only `WP-6-7A-generated-package-load-bridge-implementation`; preserve M7A -> M8 -> M7B |
...
[WP-6-7A-generated-package-load-bridge-implementation](./slug-v2-subplans/current-packet.md).

The prior packet (bridge design) is accepted in the 2026-08-24 record of the
Stage 6 owner plan.
