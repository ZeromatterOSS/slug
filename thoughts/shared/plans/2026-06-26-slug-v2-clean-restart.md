...
| M7: command/ruleset breadth | **active (repository-rule instantiation implementation)** | the loading-owned semantic RepoSpec design is accepted in `7616136f`; repository implementation and I/O remain deferred | implement the exact three-file heap-free projection | WP-4-5-host-module-extension-repository-rule-instantiation-owner-implementation |
...
[WP-4-5-host-module-extension-repository-rule-instantiation-owner-implementation](./slug-v2-subplans/current-packet.md).
