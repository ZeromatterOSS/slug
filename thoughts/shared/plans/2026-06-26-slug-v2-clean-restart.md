...
[Audit complete recursive glob semantics](./slug-v2-subplans/current-packet.md).
...
Activate only `WP-6-7A-recursive-build-glob-category-design-r1`, a docs-only
audit of the complete recursive pattern, include/exclude, package-boundary,
file/directory, ordering, error and invalidation category across both Slug glob
owners. The platforms file is a discriminator only.
