...
| M7: command/ruleset breadth | **active (canonical apparent-mapping composition design)** | canonical definition composition `7ab6c615` accepted | replace the callerless generated-only mapping key with one canonical-domain owner | WP-4-5-6-host-canonical-repository-apparent-mapping-composition-owner-design |
...
[WP-4-5-6-host-canonical-repository-apparent-mapping-composition-owner-design](./slug-v2-subplans/current-packet.md).
