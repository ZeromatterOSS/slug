...
| M7: command/ruleset breadth | **active (nonregistry-discovery prerequisite)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite run, immutable embedded source/module owners, the embedded/registry Host discovered-module leaf in e7e4a772, route-independent package preflight in 411af144, and the accepted nonregistry closure in 0231936f | compose the accepted nonregistry closure into the callerless Host discovered-module leaf | WP-5-host-nonregistry-discovered-module-implementation |
...
[WP-5-host-nonregistry-discovered-module-implementation](./slug-v2-subplans/current-packet.md).
