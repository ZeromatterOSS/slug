...
[WP-4-7A-rules-cc-linking-helper-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze the authenticated complete 675-line rules_cc C++ linking-helper producer
over its eight accepted children. Prove its full imported/function inventory
without invocation.
