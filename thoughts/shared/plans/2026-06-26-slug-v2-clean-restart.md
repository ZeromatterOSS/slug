...
| M7: command/ruleset breadth | **partial; file-effect producer proof correction active** | independently accepted lawful/composed proof contract over retained +901/+562/+1,463 candidate | five lawful upper-key rows remain | implement only `WP-4-5-selected-repository-file-effect-producer-proof-contract-correction-implementation`; preserve M7A -> M8 -> M7B |
...
[WP-4-5-selected-repository-file-effect-producer-proof-contract-correction-implementation](./slug-v2-subplans/current-packet.md).

Complete the five lawful upper-key rows and exact source-shape composition under
the unchanged caps; add no injection surface or production semantics.
