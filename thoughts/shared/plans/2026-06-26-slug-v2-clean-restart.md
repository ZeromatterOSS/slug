...
| M7: command/ruleset breadth | **active (materialization-request projection r2)** | proof correction `6a8353d7` over design `9df81032` accepted | complete the retained two-file projection and corrected proof | WP-4-5-host-repository-source-capability-materialization-request-projection-r2-implementation |
...
[WP-4-5-host-repository-source-capability-materialization-request-projection-r2-implementation](./slug-v2-subplans/current-packet.md).
