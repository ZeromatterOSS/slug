...
| M7: command/ruleset breadth | **partial; generated package bridge proof/cap correction design active** | accepted M7A chain through `597df31b`; `846ef196` handoff; `b42b004c` Generated route promotion; corrected bridge design plus refreshed Bazel 9.2 `module-extension-use-repo` generated-build evidence | the retained bridge candidate exceeds its production cap and lacks mapped non-Generated plus opaque-outer command proof; query/public publication and other platforms remain deferred | design only `WP-6-7A-generated-package-load-bridge-proof-cap-correction-design`; preserve the retained Rust candidate non-writable and M7A -> M8 -> M7B |
...
[WP-6-7A-generated-package-load-bridge-proof-cap-correction-design](./slug-v2-subplans/current-packet.md).

The Bazel 9.2 generated external-build evidence is accepted. Keep the retained
bridge candidate non-writable while designing only its measured cap correction,
lawful mapped non-Generated fallback proof, fixture consumption and opaque-
outer command-glue proof.
