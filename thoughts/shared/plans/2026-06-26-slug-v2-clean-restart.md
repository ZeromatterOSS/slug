...
| M7: command/ruleset breadth | **active (repository-rule call-protocol design)** | pure invocation accepted in `986ccebd`; pinned Bazel 9.2 makes an exported `repository_rule` a callable whose module-extension call first captures a generated-repository request | design the bounded shared definition/export plus invocation-local capture protocol before RepoSpec construction | WP-4-5-host-module-extension-repository-rule-call-protocol-design |
...
[WP-4-5-host-module-extension-repository-rule-call-protocol-design](./slug-v2-subplans/current-packet.md).
