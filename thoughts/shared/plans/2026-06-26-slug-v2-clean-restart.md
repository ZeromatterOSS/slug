...
[WP-6-7A-host-canonical-selected-module-definition-observation-carrier-promotion-formatting-correction-implementation](./slug-v2-subplans/current-packet.md).
