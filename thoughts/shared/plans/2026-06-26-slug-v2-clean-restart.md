...
| M7: command/ruleset breadth | **active (pure invocation event-contract correction)** | DICE evaluated activations own batches; reused activations intentionally have none and command lineage owns later selection | correct the replay claim before final Rust activation | WP-4-5-host-pure-module-extension-invocation-event-contract-r4-design |
...
[WP-4-5-host-pure-module-extension-invocation-event-contract-r4-design](./slug-v2-subplans/current-packet.md).
