...
| M7: command/ruleset breadth | **active (Bzlmod source-observation owner design)** | consumer audit `b6a90390` accepted | freeze the hidden Builtin/request observation key | WP-4-5-host-repository-source-observation-owner-design |
...
[WP-4-5-host-repository-source-observation-owner-design](./slug-v2-subplans/current-packet.md).
