...
| M7: command/ruleset breadth | **active (root mapping publication cap correction)** | design `d624dc5b`; retained 211-production-line diff | accept bounded 240/420/660 successor before Rust resumes | WP-5-host-root-repository-mapping-publication-r2-cap-design |
...
[WP-5-host-root-repository-mapping-publication-r2-cap-design](./slug-v2-subplans/current-packet.md).
