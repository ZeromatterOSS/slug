...
| M7: command/ruleset breadth | **active (repository source-capability publication implementation)** | design `7b6484ee` accepted over capability `3faa90dd` | implement the one-file core projection before materialization or consumer migration | WP-4-5-6-host-repository-source-capability-publication-implementation |
...
[WP-4-5-6-host-repository-source-capability-publication-implementation](./slug-v2-subplans/current-packet.md).
