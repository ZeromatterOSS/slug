...
| M7: command/ruleset breadth | **partial; generated file-effect handoff design active** | selected-call producer accepted at +901/+747/+1,648 with full Bzlmod/loading baselines and dependent core check | no demand-only route/request handoff or immutable-root effect application | design only `WP-4-5-6-generated-repository-file-effect-handoff-application-design`; preserve M7A -> M8 -> M7B |
...
[WP-4-5-6-generated-repository-file-effect-handoff-application-design](./slug-v2-subplans/current-packet.md).

Design only the demand-owned handoff from the accepted selected-call producer
through generated routing to secure immutable-root application. Activate no
caller, materializer or fixture before independent design acceptance.
