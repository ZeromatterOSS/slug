...
| M7: command/ruleset breadth | **active (generated-repository mapping-retention design)** | route audit REPLANs at discarded exact mapping/internal-name identity | freeze only the loading-owned shared mapping-retention/publication prerequisite; no Rust yet | WP-4-5-host-generated-repository-mapping-retention-design |
...
[WP-4-5-host-generated-repository-mapping-retention-design](./slug-v2-subplans/current-packet.md).
