...
| M7: command/ruleset breadth | **active (pure module-extension invocation r4)** | complete four-path implementation independently accepted at about 724/846/1,570; full loading and Bzlmod suites pass | commit the accepted callerless owner and select the next bounded packet | WP-4-5-host-pure-module-extension-invocation-owner-implementation-r4 |
...
[WP-4-5-host-pure-module-extension-invocation-owner-implementation-r4](./slug-v2-subplans/current-packet.md).
