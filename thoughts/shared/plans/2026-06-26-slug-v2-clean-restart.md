...
| M7: command/ruleset breadth | **active (repository-rule call-protocol implementation)** | pinned 9.2 definition/export/capture design accepted in `7a49b5cd`; it extends the sole pure-invocation owner with ordered heap-free raw calls and stops before RepoSpec construction | implement the accepted four-path loading-owned protocol | WP-4-5-host-module-extension-repository-rule-call-protocol-implementation |
...
[WP-4-5-host-module-extension-repository-rule-call-protocol-implementation](./slug-v2-subplans/current-packet.md).
