...
| M7: command/ruleset breadth | **active (module-extension input composition design)** | accepted loading-owned heap-free definitions plus accepted Bzlmod-owned raw root module/tag inputs | freeze one loading-owned pre-execution schema/type-check composition seam without exposing a callable or executing the extension | WP-4-5-host-module-extension-evaluation-input-composition-design |
...
[WP-4-5-host-module-extension-evaluation-input-composition-design](./slug-v2-subplans/current-packet.md).
