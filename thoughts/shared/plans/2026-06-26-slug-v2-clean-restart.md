...
| M7: command/ruleset breadth | **active (extension import-order identity REPLAN)** | the retained request diff proves `SmallMap` equality prunes import-order-only edits before projection | design the compact shared import order spine, then resume request projection | WP-5-extension-import-order-identity-owner-design |
...
[WP-5-extension-import-order-identity-owner-design](./slug-v2-subplans/current-packet.md).
