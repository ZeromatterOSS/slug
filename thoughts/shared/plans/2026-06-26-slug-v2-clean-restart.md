...
| M7: command/ruleset breadth | **active (validated generated-spec publication implementation)** | design `433badeb` is accepted | implement only the hidden sole-key borrowed publication ABI under 220/420/640 | WP-4-5-host-validated-generated-repository-spec-publication-implementation |
...
[WP-4-5-host-validated-generated-repository-spec-publication-implementation](./slug-v2-subplans/current-packet.md).
