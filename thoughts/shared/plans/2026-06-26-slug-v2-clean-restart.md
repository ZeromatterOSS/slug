...
| M7: command/ruleset breadth | **active (repository source-capability publication design)** | owned capability `3faa90dd` accepted | freeze the core carrier projection before materialization or consumer migration | WP-4-5-6-host-repository-source-capability-publication-design |
...
[WP-4-5-6-host-repository-source-capability-publication-design](./slug-v2-subplans/current-packet.md).
