...
[WP-4-7A-rules-cc-create-libraries-to-link-values-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze the authenticated complete 363-line rules_cc link-value producer over
its accepted child. Prove its full imported/struct/provider/function inventory
without invocation.
