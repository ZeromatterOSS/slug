...
| M7: command/ruleset breadth | **active (selected-module absence-signal design)** | hidden selected-module publication `bc822520` accepted | distinguish only selected-domain `Missing` from opaque terminals before core composition | WP-5-host-canonical-selected-module-definition-absence-signal-design |
...
[WP-5-host-canonical-selected-module-definition-absence-signal-design](./slug-v2-subplans/current-packet.md).
