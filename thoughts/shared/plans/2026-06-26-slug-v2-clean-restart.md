...
| M7: command/ruleset breadth | **active (canonical apparent-mapping composition implementation)** | design `706da25d` accepted | implement the one-file replacement under 240/520/760 | WP-4-5-6-host-canonical-repository-apparent-mapping-composition-owner-implementation |
...
[WP-4-5-6-host-canonical-repository-apparent-mapping-composition-owner-implementation](./slug-v2-subplans/current-packet.md).
