...
| M7: command/ruleset breadth | **active (extension import-order identity implementation)** | design `f14d3d7a` is accepted | implement the compact order spine and corrected request projection under 260/450/710 | WP-5-extension-import-order-identity-owner-implementation |
...
[WP-5-extension-import-order-identity-owner-implementation](./slug-v2-subplans/current-packet.md).
