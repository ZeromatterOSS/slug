...
[WP-4-7A-rules-cc-create-linking-context-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze the authenticated complete 137-line rules_cc linking-context producer
over its five accepted children. Prove its full imported/function inventory
without invocation.
