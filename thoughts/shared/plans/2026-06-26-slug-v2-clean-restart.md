...
| M7: command/ruleset breadth | **active (generated-namespace request implementation)** | the selected request design is accepted in `fff82ecd`; it retains pre-substitution mappings and projects the exact extension prefix plus ordered override namespace | implement only the accepted two-file hidden request widening | WP-5-host-selected-extension-generated-namespace-request-implementation |
...
[WP-5-host-selected-extension-generated-namespace-request-implementation](./slug-v2-subplans/current-packet.md).
