...
| M7: command/ruleset breadth | **active (repository capability consumer-order audit)** | core publication `0cba8fb8` accepted | choose the first dependency-safe computation-free consumer prerequisite | WP-4-5-host-repository-source-capability-consumer-order-design |
...
[WP-4-5-host-repository-source-capability-consumer-order-design](./slug-v2-subplans/current-packet.md).
