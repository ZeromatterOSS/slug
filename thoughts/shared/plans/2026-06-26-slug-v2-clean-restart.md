...
| M7: command/ruleset breadth | **active (repository source-capability input design)** | consumer audit `5cd3c4ab` accepted | freeze the owned lower-layer input before consumer migration | WP-4-5-host-repository-source-capability-input-design |
...
[WP-4-5-host-repository-source-capability-input-design](./slug-v2-subplans/current-packet.md).
