...
| M7: command/ruleset breadth | **active (nonregistry-closure prerequisite)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite `run`, immutable embedded source/module owners, and the embedded/registry Host discovered-module leaf in `e7e4a772` | decouple nonregistry MODULE/include preparation from root apparent routing | `WP-5-host-nonregistry-module-closure-design` |
...
[`WP-5-host-nonregistry-module-closure-design`](./slug-v2-subplans/current-packet.md).
