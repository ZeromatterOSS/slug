...
| M7: command/ruleset breadth | **active (command-override owner implementation)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite run, route-independent package preflight/closure, complete callerless Host discovered-module leaf through 6b2967c7, and accepted command-override owner design | implement one normalized command-module-override owner from request parsing through DICE | WP-5-host-command-module-override-owner-implementation |
...
[WP-5-host-command-module-override-owner-implementation](./slug-v2-subplans/current-packet.md).
