...
input ownership after terminal correction review. The active packet adds only
generic canonical repository Host capabilities, staged effects and non-Windows
winsdk realization. Registration proof and selected-context Rust remain
stopped.
