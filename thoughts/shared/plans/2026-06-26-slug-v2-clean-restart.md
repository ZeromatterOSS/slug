...
[Implement repository declaration documentation-category closure](./slug-v2-subplans/current-packet.md).
...
`WP-6-7A-repository-declaration-documentation-category-design-r1`. Implement
only its bounded `repository_rule(doc = ...)` loading closure and exact
already-exposed declaration-builtin audit.
