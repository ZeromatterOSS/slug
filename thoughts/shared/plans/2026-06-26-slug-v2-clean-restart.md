...
| M7: command/ruleset breadth | **partial; terminal source-carrier visibility accepted in `846ef196`** | accepted M7A repository-observation chain through `597df31b`; `b3eba6df` accepts the private terminal source-observation owner; `846ef196` implements the same-crate `pub(super)` handoff with the sibling smoke | generated package policy/lookup/source/load and public publication remain separate later owners | audit only `WP-6-7A-generated-repository-package-publication-frontier-audit`; preserve M7A -> M8 -> M7B |
...
[WP-6-7A-generated-repository-package-publication-frontier-audit](./slug-v2-subplans/current-packet.md).

The prior packet
`WP-6-7A-host-root-apparent-repository-source-observation-observation-carrier-visibility-implementation`
is accepted in `846ef196`.
