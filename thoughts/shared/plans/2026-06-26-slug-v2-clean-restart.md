...
| M7: command/ruleset breadth | **active (root apparent repository carrier design)** | root apparent-to-definition composition `7c0c0e48` accepted at 327/610/937 | freeze the dependency-safe carrier boundary before route/source work | WP-4-5-6-host-root-apparent-repository-route-carrier-owner-design |
...
[WP-4-5-6-host-root-apparent-repository-route-carrier-owner-design](./slug-v2-subplans/current-packet.md).
