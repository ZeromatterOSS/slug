...
| M7: command/ruleset breadth | **active (Bzlmod source-observation owner implementation)** | owner design `7ef0c353` accepted | implement the hidden Builtin/request observation key | WP-4-5-host-repository-source-observation-owner-implementation |
...
[WP-4-5-host-repository-source-observation-owner-implementation](./slug-v2-subplans/current-packet.md).
