...
| M7: command/ruleset breadth | **active (nonregistry-package prerequisite)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite `run`, immutable embedded source/module owners, and the embedded/registry Host discovered-module leaf in `e7e4a772` | finish the route-independent nonregistry package preflight under corrected measured bounds | `WP-5-host-nonregistry-package-preflight-implementation-r2` |
...
[`WP-5-host-nonregistry-package-preflight-implementation-r2`](./slug-v2-subplans/current-packet.md).
