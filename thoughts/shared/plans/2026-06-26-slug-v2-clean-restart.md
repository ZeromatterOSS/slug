...
| M7: command/ruleset breadth | **active (selected extension evaluation-input implementation)** | selected graph/routes/extension mappings, hidden definition-load requests in `d0d7bde7`, loading-owned definitions in `bf2c36e9`, and accepted input-owner design in `a31cf3d9` | implement the bounded Bzlmod-owned ordered root module/tag projection | WP-5-host-selected-extension-evaluation-input-requests-implementation |
...
[WP-5-host-selected-extension-evaluation-input-requests-implementation](./slug-v2-subplans/current-packet.md).
