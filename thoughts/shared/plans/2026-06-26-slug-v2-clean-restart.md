...
| M7: command/ruleset breadth | **active (repository-rule instantiation implementation r2)** | cap correction `7cf2e45f` is accepted; repository implementation and I/O remain deferred | complete the frozen join/namespace/lifecycle/A-B-A proof under 480/900/1,380 | WP-4-5-host-module-extension-repository-rule-instantiation-owner-implementation-r2 |
...
[WP-4-5-host-module-extension-repository-rule-instantiation-owner-implementation-r2](./slug-v2-subplans/current-packet.md).
