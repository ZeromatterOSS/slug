...
| M7: command/ruleset breadth | **active (materialization-request projection implementation)** | projection design `9df81032` accepted | implement the pure two-file capability-to-request projection | WP-4-5-host-repository-source-capability-materialization-request-projection-implementation |
...
[WP-4-5-host-repository-source-capability-materialization-request-projection-implementation](./slug-v2-subplans/current-packet.md).
