...
| M7: command/ruleset breadth | **active (selected-module graph owner design r4)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite run, complete callerless Host discovered-module leaves through 6b2967c7, normalized command overrides in b319b551, effective override/source ownership in dbeb1fb9, and exact shared module versions in c997f7e7 | freeze the sole discovery-to-MVS owner or identify the first missing prerequisite | WP-5-host-selected-module-graph-owner-design-r4 |
...
[WP-5-host-selected-module-graph-owner-design-r4](./slug-v2-subplans/current-packet.md).
