...
| M7: command/ruleset breadth | **partial; generated file-effect handoff implementation active** | selected-call producer accepted; independently accepted seven-file route/request/immutable-root design | no demand-only route/request handoff or immutable-root effect application yet | implement only `WP-4-5-6-generated-repository-file-effect-handoff-application-implementation`; preserve M7A -> M8 -> M7B |
...
[WP-4-5-6-generated-repository-file-effect-handoff-application-implementation](./slug-v2-subplans/current-packet.md).

Implement only the accepted demand-owned handoff from selected-call producer
through generated routing to secure immutable-root application.
