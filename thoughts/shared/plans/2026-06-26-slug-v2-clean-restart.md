...
| M7: command/ruleset breadth | **active (repository source-capability input implementation)** | design `538b5231` accepted | implement the owned lower-layer input before consumer migration | WP-4-5-host-repository-source-capability-input-implementation |
...
[WP-4-5-host-repository-source-capability-input-implementation](./slug-v2-subplans/current-packet.md).
