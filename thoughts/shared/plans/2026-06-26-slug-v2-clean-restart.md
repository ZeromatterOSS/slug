...
| M7: command/ruleset breadth | **active (selected local-path policy retention design)** | policy-owner audit `980654c8` accepted | retain and publish selected root-vs-command provenance inside Bzlmod | WP-5-host-selected-nonregistry-local-path-policy-retention-design |
...
[WP-5-host-selected-nonregistry-local-path-policy-retention-design](./slug-v2-subplans/current-packet.md).
