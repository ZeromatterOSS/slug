...
| M7: command/ruleset breadth | **active (nonregistry-package cap REPLAN)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite `run`, immutable embedded source/module owners, and the embedded/registry Host discovered-module leaf in `e7e4a772` | correct the underestimated package-preflight implementation cap without semantic widening | `WP-5-host-nonregistry-package-preflight-cap-replan` |
...
[`WP-5-host-nonregistry-package-preflight-cap-replan`](./slug-v2-subplans/current-packet.md).
