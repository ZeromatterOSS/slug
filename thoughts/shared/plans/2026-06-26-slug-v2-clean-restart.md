...
| M7: command/ruleset breadth | **partial; selected-extension final Phase 2 active** | accepted owner-first design `b97d6372`; nested-child correction `1d71320f`; retained corrected passing +779/+397/+1,176 Bzlmod Phase 1; final 1,300/700/2,000 correction accepted | exactly two loading keys, demand-first core and rebuilt fixture proof remain | implement only `WP-6-7A-generated-package-selected-extension-demand-owner-phase-2-final-cap-correction-implementation`; preserve M7A -> M8 -> M7B |
...
[WP-6-7A-generated-package-selected-extension-demand-owner-phase-2-final-cap-correction-implementation](./slug-v2-subplans/current-packet.md).
...
candidate and corrected passing nested Bzlmod Phase 1. Implement exactly two
loading keys and demand-first core under final caps; preserve physical ceilings,
global carriers, child ownership and the unchanged fixture.
