...
| M7: command/ruleset breadth | **partial; generated-package source-preflight correction active** | accepted owner-first design `b97d6372`; retained passing selected-owner candidate; independent source-preflight polarity design acceptance | generated routes must skip the pre-existing direct-local MODULE preflight before the retained candidate can pass its rebuilt fixture | implement only `WP-6-7A-generated-package-source-preflight-polarity-correction-implementation`; preserve M7A -> M8 -> M7B |
...
[WP-6-7A-generated-package-source-preflight-polarity-correction-implementation](./slug-v2-subplans/current-packet.md).

Preserve the retained selected-owner candidate and accepted fixture. Correct
only `RepositoryPackageSourceKey`'s route-source polarity so a Generated route
does not reconstruct an absent direct-local root route before its existing
lookup/materialization path.
