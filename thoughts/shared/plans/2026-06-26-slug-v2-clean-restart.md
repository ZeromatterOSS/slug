...
| M7: command/ruleset breadth | **active (nonregistry-discovery prerequisite)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite `run`, immutable embedded source/module owners, and the embedded/registry Host discovered-module leaf in `e7e4a772` | freeze general nonregistry module discovery before recursive selection | `WP-5-host-nonregistry-discovered-module-owner-design` |
...
[`WP-5-host-nonregistry-discovered-module-owner-design`](./slug-v2-subplans/current-packet.md).
