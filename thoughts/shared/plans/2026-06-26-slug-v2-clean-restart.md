...
| M7: command/ruleset breadth | **active (validated generated-spec publication design)** | loading-owned generated-repository validation is accepted in `b2a153aa` | expose the validated canonical-name/`RepoSpec` certificate across the loading boundary without a Bzlmod reverse edge or copied semantic store | WP-4-5-host-validated-generated-repository-spec-publication-design |
...
[WP-4-5-host-validated-generated-repository-spec-publication-design](./slug-v2-subplans/current-packet.md).
