...
| M7: command/ruleset breadth | **active (repository source consumer ownership)** | capability-to-request projection `06a5aa99` accepted | choose one dependency-safe first materialization/source consumer boundary | WP-4-5-host-repository-source-consumer-boundary-design |
...
[WP-4-5-host-repository-source-consumer-boundary-design](./slug-v2-subplans/current-packet.md).
