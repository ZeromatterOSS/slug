...
| M7: command/ruleset breadth | **active (canonical repository-definition composition design)** | selected absence signal `35ff14f7` accepted | freeze core selected-first, Missing-only generated fallback before routes | WP-4-5-6-host-canonical-repository-definition-composition-owner-design |
...
[WP-4-5-6-host-canonical-repository-definition-composition-owner-design](./slug-v2-subplans/current-packet.md).
