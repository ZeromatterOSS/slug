...
| M7: command/ruleset breadth | **partial; generated bridge command-input implementation active** | accepted M7A chain through `597df31b`; `846ef196` handoff; `b42b004c` Generated route promotion; refreshed Bazel 9.2 generated-build evidence; retained +539/+332/+871 bridge; independently accepted Zabel-guided producer/request input design | the Bzlmod facade still needs private Host URL/empty-mirror/refresh injection before the protected unknown diagnostic and generated fixture can pass; query/public publication and other platforms remain deferred | implement only `WP-6-7A-generated-package-host-registry-input-ownership-implementation`; preserve M7A -> M8 -> M7B |
...
[WP-6-7A-generated-package-host-registry-input-ownership-implementation](./slug-v2-subplans/current-packet.md).

The Zabel-guided producer/request input design is accepted. Preserve the
retained bridge and implement only the two-file private Bzlmod injection facade,
one core default-normalization line and its bounded proof. No private Host input
key or value becomes public.
