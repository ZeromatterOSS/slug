...
| M7: command/ruleset breadth | **active (materialization-request projection design)** | policy-threading implementation `65b1dd89` accepted | freeze the pure capability-to-request projection before consumer migration | WP-4-5-host-repository-source-capability-materialization-request-projection-design |
...
[WP-4-5-host-repository-source-capability-materialization-request-projection-design](./slug-v2-subplans/current-packet.md).
