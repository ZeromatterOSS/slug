...
[WP-4-7A-rules-cc-lto-indexing-action-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze the authenticated complete 288-line rules_cc LTO-indexing-action
producer over its seven accepted children. Prove its full imported/function
inventory without invocation.
