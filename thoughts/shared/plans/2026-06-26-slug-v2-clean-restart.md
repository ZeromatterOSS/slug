...
[WP-4-7A-rules-cc-find-cc-toolchain-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze exact rules_cc 0.2.17 `cc/find_cc_toolchain.bzl`, prove its eager
label/attribute constants and function bindings survive module freeze, and
