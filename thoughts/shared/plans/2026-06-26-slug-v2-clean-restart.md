...
| M7: command/ruleset breadth | **active (root apparent-definition composition design)** | root apparent mapping `59493b95` accepted | freeze the private mapping-to-definition owner before route/source work | WP-4-5-6-host-root-apparent-repository-definition-owner-design |
...
[WP-4-5-6-host-root-apparent-repository-definition-owner-design](./slug-v2-subplans/current-packet.md).
