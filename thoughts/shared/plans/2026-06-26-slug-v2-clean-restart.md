...
| M7: command/ruleset breadth | **active (repository source-capability policy threading design)** | selected policy retention `63de458b` accepted | freeze one compile-safe Bzlmod-to-core policy chain without consumer or materialization work | WP-4-5-6-host-repository-source-capability-policy-threading-design |
...
[WP-4-5-6-host-repository-source-capability-policy-threading-design](./slug-v2-subplans/current-packet.md).
