...
| M7: command/ruleset breadth | **active (canonical definition composition proof correction)** | design `e05a0dfc`; retained one-file Rust is unaccepted | correct the infeasible registry-fixture proof without widening the hidden ABI | WP-4-5-6-host-canonical-repository-definition-composition-proof-correction-design |
...
[WP-4-5-6-host-canonical-repository-definition-composition-proof-correction-design](./slug-v2-subplans/current-packet.md).
