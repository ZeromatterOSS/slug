...
| M7: command/ruleset breadth | **active (selected module route owner design r2)** | early command/ruleset scaffolding, accepted query/cquery/aquery and FileWrite execution, accepted POSIX executable FileWrite run, complete Host discovered leaves, normalized/effective overrides, exact shared versions, accepted callerless selected graph in 216a0be8, and accepted selected registry RepoSpec owner in e8ad58dd (1,010/844/1,854; full owner/loading suites and independent review pass) | audit canonical identity, contextual mapping, and route composition now that selected registry RepoSpecs exist | WP-5-host-selected-module-route-owner-design-r2 |
...
[WP-5-host-selected-module-route-owner-design-r2](./slug-v2-subplans/current-packet.md).
