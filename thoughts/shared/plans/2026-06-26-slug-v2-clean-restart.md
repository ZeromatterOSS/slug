...
| M7: command/ruleset breadth | **active (selected-module absence-signal implementation)** | absence-signal design `c466d864` accepted | implement only the hidden two-file disposition accessor under 50/120/170 | WP-5-host-canonical-selected-module-definition-absence-signal-implementation |
...
[WP-5-host-canonical-selected-module-definition-absence-signal-implementation](./slug-v2-subplans/current-packet.md).
