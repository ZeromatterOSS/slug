...
| M7: command/ruleset breadth | **active (repository-rule instantiation owner design)** | raw calls are accepted in `b7c70a1b`; exact selected namespaces are accepted in `c7c55b17`; neither constructs a RepoSpec or executes a repository implementation | design the loading-owned heap-free instantiation projection | WP-4-5-host-module-extension-repository-rule-instantiation-owner-design |
...
[WP-4-5-host-module-extension-repository-rule-instantiation-owner-design](./slug-v2-subplans/current-packet.md).
