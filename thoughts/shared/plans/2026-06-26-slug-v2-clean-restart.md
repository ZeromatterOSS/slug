...
| M7: command/ruleset breadth | **active (root apparent-definition implementation r2)** | proof correction `dfe5cad0`; design `512e40ed` | complete the retained cohesive implementation under corrected proof | WP-4-5-6-host-root-apparent-repository-definition-owner-implementation-r2 |
...
[WP-4-5-6-host-root-apparent-repository-definition-owner-implementation-r2](./slug-v2-subplans/current-packet.md).
