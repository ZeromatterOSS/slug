...
| M7: command/ruleset breadth | **active (custom string prerequisite design)** | the retained pure-invocation owner compiles under the corrected cap and its fail-closed branches are covered; exact Label str/repr proof exposed a shared runtime gap | freeze one reusable Starlark custom-string protocol before invocation resumes | WP-4-starlark-custom-string-protocol-design |
...
[WP-4-starlark-custom-string-protocol-design](./slug-v2-subplans/current-packet.md).
