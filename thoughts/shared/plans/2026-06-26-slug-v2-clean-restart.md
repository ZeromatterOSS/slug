...
| M7: command/ruleset breadth | **active (repository source-capability policy threading implementation)** | design `c5853ecf` accepted | implement the exact four-file hidden policy chain | WP-4-5-6-host-repository-source-capability-policy-threading-implementation |
...
[WP-4-5-6-host-repository-source-capability-policy-threading-implementation](./slug-v2-subplans/current-packet.md).
