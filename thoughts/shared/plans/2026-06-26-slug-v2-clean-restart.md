...
| M7: command/ruleset breadth | **active (source-path consumer ownership audit)** | private five-domain source-input owner `e4292de7` accepted | select the first dependency-safe path/source consumer prerequisite | WP-4-5-6-host-repository-source-path-consumer-owner-audit |
...
[WP-4-5-6-host-repository-source-path-consumer-owner-audit](./slug-v2-subplans/current-packet.md).
