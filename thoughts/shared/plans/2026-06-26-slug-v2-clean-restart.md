...
[WP-4-7A-rules-cc-collect-solib-dirs-complete-loading-proof](./slug-v2-subplans/current-packet.md).

Freeze the authenticated complete 479-line rules_cc solib-directory producer
over its three accepted children. Prove its full imported/function inventory
without invocation.
