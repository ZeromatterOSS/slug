...
| M7: command/ruleset breadth | **active (generated-repository route-boundary design)** | hidden validated spec publication `d2ed6ad3` accepted | audit and freeze only the dependency-safe post-validation generated-route owner; no Rust yet | WP-4-5-host-generated-repository-route-boundary-design |
...
[WP-4-5-host-generated-repository-route-boundary-design](./slug-v2-subplans/current-packet.md).
