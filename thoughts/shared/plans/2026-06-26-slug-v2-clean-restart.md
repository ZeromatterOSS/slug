...
| M7: command/ruleset breadth | **partial; selected-extension owner-pure implementation active** | accepted owner-first design `b97d6372`; retained corrected passing +779/+397/+1,176 Bzlmod Phase 1; owner-pure representation correction independently accepted | exactly two scratch-only loading keys, demand-first core and rebuilt fixture proof remain | implement only `WP-6-7A-generated-package-selected-extension-owner-pure-representation-correction-implementation`; preserve M7A -> M8 -> M7B |
...
[WP-6-7A-generated-package-selected-extension-owner-pure-representation-correction-implementation](./slug-v2-subplans/current-packet.md).
...
candidate and corrected passing nested Bzlmod Phase 1. Implement the accepted
scratch-only owner-pure/final-certificate representation under unchanged
physical ceilings and 1,500/800/2,300 semantic caps.
