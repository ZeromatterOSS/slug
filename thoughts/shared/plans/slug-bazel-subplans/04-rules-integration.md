...
- [ ] `slug build //:main` compiles and links successfully
...
- [ ] `slug test //:rust_test` runs tests
...
- [ ] `slug run //:py_main` executes Python
- [ ] `slug test //:py_test` runs pytest
...
- [ ] `slug build //:image` creates OCI image
