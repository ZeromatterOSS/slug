...
- [x] `slug query "deps(//...)"` returns dependencies (23 tests in test_bazel_compat_query.py)
- [x] `slug cquery` shows configured targets (71 pass in tests/core/query/)
- [x] `slug aquery` shows actions (functional via aquery/ tests)
