...
The current implementation in `app/slug_build_api/src/interpreter/rule_defs/proto_common.rs` creates:
...
- `app/slug_build_api/src/interpreter/rule_defs/proto_common.rs` - Evaluate approach
- `app/slug_build_api/src/interpreter/more.rs` - Update registration if needed
