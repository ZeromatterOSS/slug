...
**File**: `app/slug_build_api/src/interpreter/rule_defs/artifact/methods.rs`
...
**File**: `app/slug_interpreter_for_build/src/rule.rs`
...
**File**: `app/slug_interpreter_for_build/src/rule.rs` (line ~998-1012)
...
**File**: `app/slug_interpreter_for_build/src/rule.rs` (exec_group function, line ~1260)
...
(derived from `exec_group_defs`), since callers in `slug_node` use it.

#### 5. Thread through RuleData and TargetNode
**Files**: `app/slug_node/src/rule.rs`, `app/slug_node/src/nodes/unconfigured.rs`,
`app/slug_node/src/nodes/configured.rs`
...
- Toolchain resolution: `app/slug_analysis/src/analysis/toolchain_resolution.rs`
- Rule definition: `app/slug_interpreter_for_build/src/rule.rs`
- Analysis pipeline: `app/slug_analysis/src/analysis/env.rs`
