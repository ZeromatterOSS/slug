...
**Finding**: The Bazel compatibility modules **cannot be migrated to pure Starlark** due to Slug/Buck2's global injection architecture.
...
1. **`REGISTER_BUCK2_BUILD_API_GLOBALS` (Native Registration)**
   ...
   - **Code**: `app/slug_build_api/src/interpreter/more.rs`
...
Located in `app/slug_build_api/src/interpreter/rule_defs/`:
- `apple_common.rs`
- `config_common.rs`
- `coverage_common.rs`
- `platform_common.rs`
