...
- [x] `cargo check -p slug_analysis` compiles
- [x] `cargo test -p slug_analysis` passes
...
**Expected behavior:**
```
./slug.py build //tests/manual_test:top
...
- [x] `./target/release/slug build //tests/manual_test:top_8e` succeeds
...
./target/release/slug build //tests/manual_test:top_8e
[2026-01-31T20:54:42.309-08:00] Aspect visiting: gh_facebook_slug//tests/manual_test:has_info (<unspecified>)
...
./target/release/slug build //tests/manual_test:top_chain_8e (after clean)
[2026-01-31T20:54:56.837-08:00] Aspect visiting: gh_facebook_slug//tests/manual_test:has_info (<unspecified>)
[2026-01-31T20:54:56.837-08:00]   Rule kind: rule_with_test_info
[2026-01-31T20:54:56.837-08:00] Aspect visiting: gh_facebook_slug//tests/manual_test:has_info2 (<unspecified>)
[2026-01-31T20:54:56.837-08:00]   Rule kind: rule_with_test_info
BUILD SUCCEEDED
```
...
| File | Changes |
|------|---------|
| `app/slug_analysis/src/analysis/aspect_calculation.rs` | Add required_aspect_providers check to aspect_applies_to_target() |
...
- `app/slug_analysis/src/analysis/aspect_calculation.rs:138-176` - Current aspect_applies_to_target()
- `app/slug_interpreter_for_build/src/aspect.rs:424-427` - required_aspect_providers() getter
