...
../../target/release/slug audit cell          # Check cell resolution
../../target/release/slug targets root//:     # Parse BUILD files, run tests
...
- BCR modules fetched to `~/.cache/slug/` and extracted to `bazel-external/`
