...
>
> See the parent plan's [Native → Starlark Migration Architecture](../2026-01-21-slug-bazel-compatible-build-tool.md#native--starlark-migration-architecture) for details.
...
> their respective `rules_*` repositories. Slug's job is to make the native
...
These rules exist as native Rust implementations in Slug due to Buck2 heritage.
...
> Making this module complete and correct is how Slug supports C++ builds.
...
> Improving these stubs is how Slug will support Java builds — NOT by adding
