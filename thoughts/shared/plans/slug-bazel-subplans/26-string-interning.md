...
Make string ownership in Bazel-compatibility code match Slug's existing
performance model:
...
Slug already has several interning layers:
...
- `app/slug_core/src/target/name.rs::TargetName`
- `app/slug_node/src/attrs/spec.rs::AttributeSpec`
- `app/slug_node/src/rule.rs::Rule` string vectors
- `app/slug_bzlmod/src/types.rs`
- `app/slug_bzlmod/src/resolution.rs`
- `app/slug_bzlmod/src/extensions.rs`
- `app/slug_bzlmod/src/extension_execution_dice.rs`
- `app/slug_bzlmod/src/repository_invocations.rs`
- `app/slug_interpreter_for_build/src/module_ctx/*`
- `app/slug_interpreter_for_build/src/repository_rule.rs`
