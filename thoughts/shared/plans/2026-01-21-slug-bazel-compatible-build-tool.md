...
| Execution boundary | Direct local / Buck executors | REAPI for remote and local executor backends | Make NativeLink-local `rules_cc` REAPI proof routine and audit explicit hybrid fallback |
...
|----------|------|---------|---------------|
| 1 | [64-plan62-implementation-review-remediation.md](./slug-bazel-subplans/64-plan62-implementation-review-remediation.md) | Live review of Plan 62/63 found residual implementation gaps hidden by status drift: materialization locking, atomic publish, download/auth behavior, lockfile lifecycle, digest honesty, same-daemon external-tree replay coverage, and bzlmod string/data-structure discipline. | Plan 62 status is reconciled; blocking lock/publish gaps are fixed; Phase 9 and Phase 14 exit criteria are actually met; Plan 63 has semantic same-daemon coverage; validation matrix passes. |
...
| [45-per-args-paramfile-and-cargo-runfiles.md](./slug-bazel-subplans/45-per-args-paramfile-and-cargo-runfiles.md) | Per-Args paramfile materialization for rules_rust cargo build script runfiles. | **Proposed** |
...
| [62-bzlmod-replay-parity-followups.md](./slug-bazel-subplans/62-bzlmod-replay-parity-followups.md)     | Bzlmod replay and Bazel 9 parity follow-ups: external-cell DICE tracking, refresh metadata, multiple-version identity, extension unique names, lockfile shape, guardrail gaps, write/fetch safety, MVS semantics, and lifecycle. | **Partial** (major phases landed; Plan 64 owns residual materialization locking/publish, download/auth, lockfile lifecycle, digest honesty, and replay guardrail gaps) |
| [63-dice-validity-unpoison.md](./slug-bazel-subplans/63-dice-validity-unpoison.md)                     | Un-poison DICE validity overrides for warm-build cacheability. Remove `validity=false` stopgaps from WatchedAbs and Project\* file keys; add `ExternalTreeGenerationKey` dep edge for mutable tree roots. | **Partial** (all phases landed; Plan 64 Phase 64.7 requires same-daemon semantic replay coverage before closure) |
| [64-plan62-implementation-review-remediation.md](./slug-bazel-subplans/64-plan62-implementation-review-remediation.md) | Plan 62 implementation review remediation: status drift repair, materialization lock/publish correctness, download/auth completion, lockfile lifecycle, digest honesty, same-daemon replay guardrails, bzlmod string/data-structure audit, workspace hygiene. | **Partial** (Phases 64.1–64.3 landed; Phases 64.4–64.9 pending) |
...
| 62    | Bzlmod Replay and Bazel 9 Parity Follow-ups | [62-bzlmod-replay-parity-followups.md](./slug-bazel-subplans/62-bzlmod-replay-parity-followups.md) | [~] In Progress: major phases landed, but Plan 64 reopened residual implementation gaps around materialization locking/publish, download/auth, lockfile lifecycle, digest honesty, and same-daemon replay guardrails |
| 63    | DICE Validity Un-poison Warm-Build Fix | [63-dice-validity-unpoison.md](./slug-bazel-subplans/63-dice-validity-unpoison.md) | [~] In Progress: unit surface passes; Plan 64 requires same-daemon semantic replay coverage before treating this as closed |
| 64    | Plan 62 Implementation Review Remediation | [64-plan62-implementation-review-remediation.md](./slug-bazel-subplans/64-plan62-implementation-review-remediation.md) | [~] In Progress: Phases 64.1–64.3 landed (materialization lock moved off async path, symlink-based atomic publish replaces directory-over-directory rename); Phases 64.4–64.9 pending |
...
| 45    | Per-Args paramfile + cargo_build_script runfiles | [45-per-args-paramfile-and-cargo-runfiles.md](./slug-bazel-subplans/45-per-args-paramfile-and-cargo-runfiles.md) | [ ] Proposed. Unsticks `zeromatter//sdk:sdk_contents`; depends on current Plan 44 execroot stopgap, with cleanup after real execroot |
