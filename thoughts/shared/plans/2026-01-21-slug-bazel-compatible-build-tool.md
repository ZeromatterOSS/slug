...
| [62-bzlmod-replay-parity-followups.md](./slug-bazel-subplans/62-bzlmod-replay-parity-followups.md)     | Bzlmod replay and Bazel 9 parity follow-ups: external-cell DICE tracking, refresh metadata, multiple-version identity, extension unique names, lockfile shape, guardrail gaps, write/fetch safety, MVS semantics, and lifecycle. | **Partial** (major phases landed; Plan 64 still owns download/auth, lockfile lifecycle, bzlmod string/data-structure audit, and workspace hygiene) |
...
| [64-plan62-implementation-review-remediation.md](./slug-bazel-subplans/64-plan62-implementation-review-remediation.md) | Plan 62 implementation review remediation: status drift repair, materialization lock/publish correctness, download/auth completion, lockfile lifecycle, digest honesty, same-daemon replay guardrails, bzlmod string/data-structure audit, workspace hygiene. | **Partial** (Phases 64.1–64.3, 64.6, and 64.7 landed; Phases 64.4, 64.5, 64.8, and 64.9 pending) |
...
| 62    | Bzlmod Replay and Bazel 9 Parity Follow-ups | [62-bzlmod-replay-parity-followups.md](./slug-bazel-subplans/62-bzlmod-replay-parity-followups.md) | [~] In Progress: major phases landed; Plan 64 still owns download/auth, lockfile lifecycle, bzlmod string/data-structure audit, and workspace hygiene |
...
| 64    | Plan 62 Implementation Review Remediation | [64-plan62-implementation-review-remediation.md](./slug-bazel-subplans/64-plan62-implementation-review-remediation.md) | [~] In Progress: Phases 64.1–64.3, 64.6, and 64.7 landed; Phases 64.4, 64.5, 64.8, and 64.9 pending |
