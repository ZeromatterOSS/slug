...
Residual risk: No registry policy/IO owner, command transport, discovery key, MVS activation, selected-yanked/RepoSpec aggregation, or semantic lockfile write landed. `WP-5-m1-registry-policy-io-substrate` is the only next packet.
