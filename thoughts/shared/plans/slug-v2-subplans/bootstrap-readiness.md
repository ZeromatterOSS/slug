...
| Named/automatic execution groups | Corrected implementation plus accepted initializer/effect-diagnostic/generated-path checkpoints are preserved unaccepted with R2. The valid batching cutoff found 215 path-progress rounds and 468 demands, all unseen, led by 164 singleton batches | Stages 4/5/6 | Review and run one capped successful-merge path-shard exposure audit, treating changed-shard residents only as potential next-injection exposure, before any narrower injection audit, joint gates or F3 |
