...
| Named/automatic execution groups | Corrected implementation plus accepted initializer/effect-diagnostic/generated-path checkpoints are preserved unaccepted with R2. The shard cutoff found 209 installed merges, 438 changed shards and 1,528 potentially exposed prior residents | Stages 4/5/6 | Review and run one aggregate merge-to-committed-injection handoff audit; even a match proves only that potential exposure reached commit, before any narrower DICE event audit, joint gates or F3 |
