...
prerequisite planner rejects that output kind/support family. WP-7-47 supplies the prerequisite typed logical layout and complete backing constituent
view, verified through a tiny configured binary. Native target resolution, manifest bytes,
virtual support results and confined link/backing-output publication remain required before
ordinary binary Build can execute. This is required for ordinary Build; it does not activate
