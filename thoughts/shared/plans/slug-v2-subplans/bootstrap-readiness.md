...
| Ordinary source/generated/tree input transfer and output materialization | Bounded FileWrite/source Spawn and verified regular-file output trees accepted (WP-7-31/34/35). WP-7-36/37 add owner-preserving prerequisites and verified generated File/Directory consumer execution within one native request. General scheduling, validated local publication and CLI activation remain open | Stages 6/7 | Exact Directory topology/content/digests, declared output ownership/type/mode/symlinks, generated-output consumer/reupload and missing/corrupt data behavior; validated-root-only publication |
