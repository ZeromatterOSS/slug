...
| Named/automatic execution groups | Corrected implementation plus accepted initializer/effect-diagnostic/generated-path checkpoints are preserved unaccepted with R2. The typed dependency-context invalidation-source implementation and frozen preparation pass their exact proof, supervisor, CLI-list and fresh-fixture gates | Stages 4/5/6 | Obtain independent preexecution review before the one authorized same-selector replay; infer no necessity, cost or avoidability before joint gates or F3 |
