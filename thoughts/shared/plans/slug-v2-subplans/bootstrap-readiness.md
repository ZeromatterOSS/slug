...
historical evidence, not proof of this new producer edge. The fresh leaf and
CLI-root generated-input/coverage audit remains open for bootstrap admission.
...
|---|---|---|---|
| Bazel builds the CLI root, its 35-package selected Cargo closure and generated sources | Static BUILD/edge and Bazel-lock synchronization accepted; configured root cquery reaches all 35 local paths; local feature attributes and two first-party generated-input action edges accepted. Remaining configured actions, generated bytes, external feature/action coverage and buildability remain open | Stage 10 | Prove configured root/action reachability, remaining features, generated inputs, pin correspondence and compilation without excluding a production input |
