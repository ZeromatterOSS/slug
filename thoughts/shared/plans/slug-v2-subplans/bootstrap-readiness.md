...
| Named/automatic execution groups | Corrected implementation is preserved unaccepted with R2; 168/168 analysis tests pass after configurable aliases. Authentic F3 now clears groups, computed defaults and configurable aliases and reaches rules_java rule-initializer invocation | Stages 4/5/6 | Design the narrow initializer prerequisite, pass all joint gates, then replay F3 |
