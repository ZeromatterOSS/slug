...
| Named/automatic execution groups | Corrected implementation is preserved unaccepted with R2; 168/168 analysis tests pass after configurable aliases. Authentic F3 clears groups, computed defaults and aliases and selects the retained rules_java initializer | Stages 4/5/6 | Review and implement the bounded package-owned initializer call, pass all joint gates, then replay F3 |
