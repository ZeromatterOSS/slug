...
prerequisite planner rejects that output kind/support family. A bounded Linux implementation
must consume those existing owners through planning, REAPI transfer and selected publication,
with a tiny executable fixture. This is required for ordinary Build; it does not activate
