...
Packet: `WP-4-5-6-host-repository-source-capability-policy-threading-implementation`
Milestone: M7 canonical repository routing prerequisites
Owner: `slug-v2-subplans/04-starlark-loading-and-build-packages.md`
Result: implement the accepted compile-safe policy chain from retained selected provenance to owned source capability.
