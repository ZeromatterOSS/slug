...
Packet: `WP-5-host-root-repository-mapping-publication-implementation`
Milestone: M7 canonical repository routing prerequisites
Owner: `slug-v2-subplans/05-bzlmod-and-repository-graph.md`
Result: implement the accepted complete post-extension root-mapping publication seam.
