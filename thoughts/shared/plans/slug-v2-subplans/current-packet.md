...
Packet: `WP-4-5-6-host-repository-source-capability-publication-implementation`
Milestone: M7 canonical repository routing prerequisites
Owner: `slug-v2-subplans/04-starlark-loading-and-build-packages.md`
Result: implement the accepted private core carrier-to-capability projection.
