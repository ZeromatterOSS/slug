...
Packet: `WP-5-host-root-repository-mapping-publication-r2-cap-design`
Milestone: M7 canonical repository routing prerequisites
Owner: `slug-v2-subplans/05-bzlmod-and-repository-graph.md`
Result: correct only the implementation cap after the frozen ABI hit its stop.
...
This section and everything below is historical context only, grants no file,
action, cap, or schedule authority, and is interpreted only through the active docs-only cap-correction contract above.
...
active docs-only cap-correction contract above is its sole successor authority.
...
cap, or schedule authority, and is interpreted only through the active docs-only cap-correction contract above.
...
active docs-only cap-correction contract above.
...
interpreted solely through the active docs-only cap-correction contract above.
...
cap, or schedule authority, and is interpreted solely through the active docs-only cap-correction contract above.
...
This section is historical context only, grants no file, action, cap, or
schedule authority, and is interpreted solely through the active docs-only cap-correction contract above.
...
action, cap, or schedule authority, and is interpreted through the active docs-only cap-correction contract above.
