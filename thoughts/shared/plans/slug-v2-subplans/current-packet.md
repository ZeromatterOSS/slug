...
Packet: `WP-4-5-6-host-generated-repository-definition-lookup-owner-r2-cap-design`
...
Result: correct only the frozen proof caps before Rust resumes.
...
widening. Rust may resume only after independent acceptance and explicit r2
activation.
