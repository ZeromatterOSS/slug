...
Packet: `WP-10-m8-bazel-buildbuddy-build-cache-prime-execution-stage-probe-transported-live-evidence`
Milestone: M8 Bazel developer graph
Owner: `slug-v2-subplans/10-bazel-build-and-bootstrap.md`
Result: one transported execution-log-only stage result.
...
```sh
python3 tools/v2_oracle/buildbuddy_build_cache_prime_execution_stage_probe.py
```
...
`EXECUTION_READY` routes to an output/prime-semantics discriminator; stream or
spawn rejection gets one narrow source design. Cache/RBE and the 43-test gate
remain open.
