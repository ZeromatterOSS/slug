...
Packet: `WP-4-5-host-repository-source-capability-materialization-request-projection-design`
Milestone: M7 canonical repository routing prerequisites
Owner: `slug-v2-subplans/05-bzlmod-and-repository-graph.md`
Result: freeze the computation-free capability-to-materialization-request projection before consumer migration.
