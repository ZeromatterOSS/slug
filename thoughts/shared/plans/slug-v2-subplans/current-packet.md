...
Packet: `WP-4-5-host-repository-source-capability-materialization-request-projection-implementation`
Milestone: M7 canonical repository routing prerequisites
Owner: `slug-v2-subplans/05-bzlmod-and-repository-graph.md`
Result: implement the accepted computation-free capability-to-materialization-request projection.
...
`app/slug_bzlmod_v2/src/lib.rs` hidden exports, and four completion ledgers
under mandatory 180 production/420 tests/600 total changed Rust lines and
physical ceilings 11,080/380. Preserve the exact hidden disposition/function,
renamed private legacy wrapper, classification/policy/error order, compact-shell
clone boundary, parity proof, compatibility split, and all stops below. No
third Rust file, DICE/Need, consumer, source/materialization, command, or public
stable behavior is authorized.
