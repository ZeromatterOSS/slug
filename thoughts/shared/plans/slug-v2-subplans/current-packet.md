...
Packet: `WP-4-5-host-repository-source-input-certificate-implementation`
Milestone: M7 canonical repository routing prerequisites
Owner: `slug-v2-subplans/05-bzlmod-and-repository-graph.md`
Result: implement the accepted computation-free owned source input.

## Active implementation contract

Independent review accepts design `b9cffe52`. Implement only existing Bzlmod
`source_preparation.rs`, hidden `lib.rs` exports, and four completion ledgers
under mandatory 140 production/320 tests/460 total changed Rust lines and
physical ceilings 11,400/390. Freeze hidden Bzlmod
...
attribute Arc. No other Rust file or behavior is authorized.
...
STOP on a new key/store, path or
...
Require independent acceptance before completion.
