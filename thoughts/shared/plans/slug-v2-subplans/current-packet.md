...
Packet: `WP-4-5-host-repository-source-capability-materialization-request-projection-r2-implementation`
Milestone: M7 canonical repository routing prerequisites
Owner: `slug-v2-subplans/05-bzlmod-and-repository-graph.md`
Result: complete the accepted projection and corrected proof matrix.

## Active r2 implementation contract

Independent review accepts proof correction `6a8353d7` over design `9df81032`.
Resume only the retained existing Bzlmod `source_preparation.rs`, hidden
`lib.rs` exports, and four completion ledgers under mandatory 180 production/
420 tests/600 total changed Rust lines and physical ceilings 11,240/380.
Preserve the accepted production ABI, classifier/error order, compact-shell
clone, renamed legacy wrapper, exact proof below, compatibility split, and all
prior no-third-file/key/store/Need/consumer/source/materialization/command/
public/I/O/JVM stops.
...
r2 implementation contract above.
...
This section and everything below is historical context only, grants no file,
action, cap, or schedule authority, and is interpreted only through the active r2 implementation contract above.
...
active r2 implementation contract above is its sole successor authority.
...
schedule authority, and is interpreted through the active r2 implementation contract above.
...
cap, or schedule authority, and is interpreted only through the active r2 implementation contract above.
...
This section is historical context only, grants no independent file, action,
cap, or schedule authority, and is interpreted through the active r2 implementation contract above.
...
active r2 implementation contract above.
...
This section is historical context only, grants no file, action, cap, or
schedule authority, and is interpreted only through the active r2 implementation contract above.
...
interpreted solely through the active r2 implementation contract above.
...
cap, or schedule authority, and is interpreted solely through the active r2 implementation contract above.
...
This section is historical context only, grants no file, action, cap, or
schedule authority, and is interpreted solely through the active r2 implementation contract above.
...
action, cap, or schedule authority, and is interpreted through the active r2 implementation contract above.
...
authority; it is interpreted solely through the active r2 implementation contract above.
...
or schedule authority, and is interpreted only through the active r2 implementation contract above.
