...
state and the shared Buck2-derived evaluator.
...
Return one bounded implementation packet with exact semantics, retained-state
ownership, evidence, allowlist, lifecycle validation, and hard stops. Do not
