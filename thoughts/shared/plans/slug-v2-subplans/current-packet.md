...
Packet: `WP-4-5-6-host-repository-source-capability-policy-threading-r2-implementation`
Milestone: M7 canonical repository routing prerequisites
Owner: `slug-v2-subplans/04-starlark-loading-and-build-packages.md`
Result: finish the retained implementation under the accepted corrected proof boundary.

## Active implementation contract

Independent review accepts proof correction `5e88f2ad` over design
`c5853ecf`. Resume only the retained four-file implementation in
...
`app/slug_core_v2/src/runtime/root_apparent_repository_route.rs`, plus four
completion ledgers, under the unchanged 320/700/1,020 caps and
3,000/2,450/1,040/1,100 ceilings. Preserve all production semantics, exact
ABI, corrected inherited/pure/real proof split, root-definition fail-closed
boundary, and prior stops. No fifth Rust path or other breadth is authorized.
