...
Packet: `WP-4-5-host-repository-relative-path-owner-implementation`
...
Result: implement the accepted computation-free shared relative-path owner.

## Active implementation contract

Independent review accepts design `4d96d094`. Implement only existing
...
public-stable API, Cargo/lockfile, inference/rewrite, copied graph state, or JVM
change is authorized. Require independent acceptance before completion.
