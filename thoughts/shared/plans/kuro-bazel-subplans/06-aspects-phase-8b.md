...
**Location:** `app/kuro_interpreter_for_build/src/aspect.rs`
...
**New File:** `app/kuro_build_api/src/interpreter/rule_defs/aspect/rule_info.rs`
...
**New File:** `app/kuro_build_api/src/interpreter/rule_defs/aspect/context.rs`
...
**New File:** `app/kuro_build_api/src/interpreter/rule_defs/aspect/target_providers.rs`
...
**New File:** `app/kuro_build_api/src/interpreter/rule_defs/aspect/mod.rs`
...
**Modify:** `app/kuro_build_api/src/interpreter/rule_defs/mod.rs`
- Add `pub mod aspect;`
...
**Modify:** `app/kuro_build_api/src/interpreter/rule_defs/provider/collection.rs`
...
impl<'v> ProviderCollection<'v> {
    ...
    pub fn try_from_aspect_value(value: Value<'v>) -> kuro_error::Result<Self> {
...
**New File:** `app/kuro_analysis/src/analysis/aspect_execution.rs`
...
| File | Purpose |
|------|---------|
| `app/kuro_build_api/src/interpreter/rule_defs/aspect/mod.rs` | Module organization |
| `app/kuro_build_api/src/interpreter/rule_defs/aspect/context.rs` | AspectContext Starlark type |
| `app/kuro_build_api/src/interpreter/rule_defs/aspect/rule_info.rs` | AspectRuleInfo (ctx.rule) |
| `app/kuro_build_api/src/interpreter/rule_defs/aspect/target_providers.rs` | Target provider wrapper |
| `app/kuro_analysis/src/analysis/aspect_execution.rs` | Basic execution function |

### Modified Files

| File | Changes |
|------|---------|
| `app/kuro_interpreter_for_build/src/aspect.rs` | Add missing fields to FrozenStarlarkAspectCallable |
| `app/kuro_build_api/src/interpreter/rule_defs/mod.rs` | Add `pub mod aspect;` |
| `app/kuro_build_api/src/interpreter/rule_defs/provider/collection.rs` | Add `try_from_aspect_value()` |
...
- `app/kuro_build_api/src/interpreter/rule_defs/context.rs` - AnalysisContext pattern to follow
- `app/kuro_analysis/src/analysis/env.rs` - RuleSpec trait and run_analysis pattern
- `app/kuro_build_api/src/interpreter/rule_defs/provider/collection.rs` - Provider collection handling
