...
- `reactor-repo-kuro/bazel-external/rules_rs+override/rs/private/downloader.bzl`
...
6. Add focused tests
   ...
   Validate against the reactor workspace in the distrobox by building twice and
...
- The reactor `rules_rs` build no longer refetches the same sparse registry
